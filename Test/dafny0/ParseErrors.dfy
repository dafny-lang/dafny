...
module Older {
  ...
  least predicate Q(older older older x: X) // error: 'older' is an identifier here
  ...
  twostate lemma L(nameonly older nameonly c: C := "hello"): int // error: 'older' is an identifier here
}
