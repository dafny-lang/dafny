...
compiled function Up(n: int): Stream<int>
{
  ICons(n, Up(n+1))
}

compiled function Up2(n: int): Stream<int>
{
  ICons(n, ICons(n+1, Up2(n+2)))
}

compiled function UpIf(n: int): Stream<int>
{
...
compiled function CUp0(n: int, c: Color): Stream<int>
{
  match c
...
compiled function CUp1(n: int, c: Color): Stream<int>
{
  ICons(n, match c case Red => CUp1(n+1, c) case Blue => CUp1(n+2, c))
}

compiled function CUp2(n: int, c: Color): Stream<int>
{
  if c == Red then
    ICons(n, CUp2(n+1, c))
  else
...
compiled function CUp3(n: int, c: Color): Stream<int>
{
...
compiled function UpLet0(n: int): Stream<int>
{
  var n' := n+1;
  ICons(n'-1, UpLet0(n'))
}

compiled function UpLet1(n: int): Stream<int>
{
...
compiled function Nothing(): Lang
{
  L(false, s => Nothing())
}

compiled function OnlyDs(): Lang<char>
{
