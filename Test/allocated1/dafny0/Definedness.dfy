...
function Postie0(c: Mountain): Mountain
  ...
  ensures Postie0(c) != null && allocated(Postie0(c)) && Postie0(c).x <= Postie0(c).x;
...
function Postie1(c: Mountain): Mountain
  requires c != null && allocated(c);
  ensures Postie1(c) != null && allocated(Postie1(c)) && Postie1(c).x == 5;  // error: postcondition violation (but no well-formedness problem)
{
  c
}

function Postie2(c: Mountain): Mountain
  requires c != null && allocated(c) && c.x == 5; reads c;
...
function Postie3(c: Mountain): Mountain  // all is cool
  requires c != null && allocated(c) && c.x == 5; reads c;
  ensures Postie3(c) != null && allocated(Postie3(c)) && Postie3(c).x < 10;
...
function Postie4(c: Mountain): Mountain
  requires c != null && allocated(c) && c.x <= 5; reads c;
  ensures Postie4(c) != null && allocated(Postie4(c)) && Postie4(c).x < 10;
