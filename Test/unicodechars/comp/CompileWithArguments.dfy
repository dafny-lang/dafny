...
// RUN: %baredafny translate cs --compile-target %args --unicode-char --no-verify "%s" --output:%s.dll
// RUN: dotnet %s.dll "dotnet" "howdy" >> "%t"
// RUN: dotnet %s.dll "dotnet" "hello" >> "%t"
// RUN: dotnet %s.dll "dotnet" "aloha" >> "%t"
// RUN: %baredafny translate js --compile-target %args --unicode-char --no-verify "%s" --output=%s.js
// RUN: node %s.js "javascript" 2 >> "%t"
// RUN: node %s.js "javascript" 1 >> "%t"
// RUN: node %s.js "javascript" "aloha" >> "%t"
// RUN: %baredafny translate java --compile-target %args --unicode-char --no-verify "%s" >> "%t"
...
// RUN: %baredafny translate py --compile-target %args --unicode-char --no-verify "%s" >> "%t"
...
// RUN: %baredafny translate go --compile-target %args --unicode-char --no-verify "%s" >> "%t"
