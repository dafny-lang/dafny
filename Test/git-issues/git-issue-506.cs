// Dafny program git-issue-506.dfy compiled into C#
...
//     /debug /nowarn:0164 /nowarn:0219 /nowarn:1717 /nowarn:0162 /nowarn:0168 /nowarn:0436

using System;
using System.Numerics;
[assembly: DafnyAssembly.DafnySourceAttribute(@"
// Dafny 2.3.0.10506
// Command Line Options: /compile:4 /compileTarget:cs /spillTargetCode:3 git-issues/git-issue-506.dfy
// git-issue-506.dfy
...
method Main()
{
  ...
  assert a[7] == 9;
  assert a[8] == 1;
  expect a[8] == 1, ""expectation violation""
  print index, "" "", a[6], a[7], a[8], ""\n"";
  var o := new F(2);
  var oo := o;
  print o.f, "" "", oo.f, ""\n"";
  ...
  assert o.f == 6;
  assert ooo.f == 7;
  expect ooo.f == 7, ""expectation violation""
  print o.f, "" "", ooo.f, ""\n"";
  var aa := new int[9, 9];
  var j := 4;
  var k := 5;
  ...
  assert aa[4, 5] == 7;
  expect aa[4, 5] == 7, ""expectation violation""
}
")]
...
namespace _module {
  ...
  public partial class F {
    ...
    public void __ctor(BigInteger f)
    {
      (this).f = f;
    }
  }
  ...
  public partial class __default {
    ...
    {
      BigInteger[] _30_a;
      var _nw0 = new BigInteger[(int)(new BigInteger(10))];
      _30_a = _nw0;
      BigInteger _31_index;
      _31_index = new BigInteger(6);
      (_30_a)[(int)((new BigInteger(8)))] = BigInteger.One;
      BigInteger _rhs0 = new BigInteger(3);
      BigInteger _rhs1 = (_31_index) + (BigInteger.One);
      BigInteger[] _lhs0 = _30_a;
      BigInteger _lhs1 = _31_index;
      _lhs0[(int)(_lhs1)] = _rhs0;
      ;
      _31_index = _rhs1;
      ;
      Dafny.Helpers.Print(_31_index);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" "));
      Dafny.Helpers.Print((_30_a)[(int)(new BigInteger(6))]);
      Dafny.Helpers.Print((_30_a)[(int)(new BigInteger(7))]);
      Dafny.Helpers.Print((_30_a)[(int)(new BigInteger(8))]);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      BigInteger _rhs2 = (_31_index) + (BigInteger.One);
      BigInteger _rhs3 = new BigInteger(9);
      BigInteger[] _lhs2 = _30_a;
      BigInteger _lhs3 = _31_index;
      _31_index = _rhs2;
      ;
      _lhs2[(int)(_lhs3)] = _rhs3;
      ;
      if (!(((_30_a)[(int)(new BigInteger(8))]) == (BigInteger.One))) {
      ...
      F _32_o;
      var _nw1 = new F();
      _nw1.__ctor(new BigInteger(2));
      _32_o = _nw1;
      F _33_oo;
      _33_oo = _32_o;
      Dafny.Helpers.Print(_32_o.f);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" "));
      Dafny.Helpers.Print(_33_oo.f);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      F _34_ooo;
      var _nw2 = new F();
      _nw2.__ctor(new BigInteger(4));
      _34_ooo = _nw2;
      BigInteger _rhs4 = new BigInteger(5);
      F _rhs5 = _34_ooo;
      F _lhs4 = _32_o;
      _lhs4.f = _rhs4;
      ;
      ...
      F _35_oooo;
      var _nw3 = new F();
      _nw3.__ctor(new BigInteger(6));
      _35_oooo = _nw3;
      F _rhs6 = _35_oooo;
      BigInteger _rhs7 = new BigInteger(7);
      F _lhs5 = _32_o;
      _32_o = _rhs6;
      ;
      _lhs5.f = _rhs7;
      ;
      if (!((_34_ooo.f) == (new BigInteger(7)))) {
        throw new Dafny.HaltException(Dafny.Sequence<char>.FromString("expectation violation"));
      }
      Dafny.Helpers.Print(_32_o.f);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" "));
      Dafny.Helpers.Print(_34_ooo.f);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      BigInteger[,] _36_aa;
      var _nw4 = new BigInteger[(int)(new BigInteger(9)), (int)(new BigInteger(9))];
      _36_aa = _nw4;
      BigInteger _37_j;
      _37_j = new BigInteger(4);
      BigInteger _38_k;
      _38_k = new BigInteger(5);
      (_36_aa)[(int)((_37_j)), (int)((_38_k))] = new BigInteger(8);
      BigInteger _rhs8 = new BigInteger(2);
      BigInteger _rhs9 = new BigInteger(3);
      BigInteger _rhs10 = new BigInteger(7);
      BigInteger[,] _lhs6 = _36_aa;
      BigInteger _lhs7 = _37_j;
      BigInteger _lhs8 = _38_k;
      _37_j = _rhs8;
      ;
      _38_k = _rhs9;
      ;
      _lhs6[(int)(_lhs7), (int)(_lhs8)] = _rhs10;
      ;
      Dafny.Helpers.Print(_37_j);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" "));
      Dafny.Helpers.Print(_38_k);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" "));
      Dafny.Helpers.Print((_36_aa)[(int)(new BigInteger(4)), (int)(new BigInteger(5))]);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" "));
      Dafny.Helpers.Print((_36_aa)[(int)(new BigInteger(2)), (int)(new BigInteger(3))]);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      if (!(((_36_aa)[(int)(new BigInteger(4)), (int)(new BigInteger(5))]) == (new BigInteger(7)))) {
        throw new Dafny.HaltException(Dafny.Sequence<char>.FromString("expectation violation"));
      }
    }
  }
