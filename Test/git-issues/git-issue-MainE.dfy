...
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /Main:H.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:I.Test "%s" >> "%t"
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /Main:J.Test "%s" >> "%t"
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /Main:K.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:       "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:-      "%s" >> "%t"
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /Main:Tr.Instance "%s" >> "%t"
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /Main:Opaque.Static   "%s" >> "%t"
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /Main:Opaque.Instance "%s" >> "%t"
// RUN: %diff "%s.expect" "%t"
