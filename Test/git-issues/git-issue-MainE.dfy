...
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:A.Test "%s" >> "%t"
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:B.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:C.Test "%s" >> "%t"
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:D.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:E.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:G.Test "%s" >> "%t"
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:H.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:I.Test "%s" >> "%t"
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:J.Test "%s" >> "%t"
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:K.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:       "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:-      "%s" >> "%t"
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:Tr.Instance "%s" >> "%t"
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:Opaque.Static   "%s" >> "%t"
// RUN: %exits-with 4 %dafny /noVerify /compile:4 /Main:Opaque.Instance "%s" >> "%t"
// RUN: %diff "%s.expect" "%t"
