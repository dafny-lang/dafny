...
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /compileTarget:cs /Main:X "%s" >> "%t"
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /compileTarget:js /Main:X "%s" >> "%t"
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /compileTarget:go /Main:X "%s" >> "%t"
// RUN: %exits-with 0 %dafny /noVerify /compile:4 /compileTarget:java /Main:X "%s" >> "%t"
