...
// RUN: %dafny /compileVerbose:1 /compileTarget:js /out:%S/CompileAndThenRun.js "%s" >> "%t"
// RUN: node %S/CompileAndThenRun.js >> "%t"

// RUN: %dafny /compileVerbose:1 /compileTarget:go /out:%S/CompileAndThenRun "%s" >> "%t"
// RUN: %S/CompileAndThenRun >> "%t"

// RUN: %dafny /compileVerbose:1 /compileTarget:java /out:%S/CompileAndThenRun-java "%s" >> "%t"
