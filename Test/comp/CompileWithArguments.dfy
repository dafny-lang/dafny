...
// RUN: %baredafny translate cs %args --compile-verbose=true --no-verify --compile-target "%s" --output:%s.dll
// RUN: dotnet %s.dll "dotnet" "howdy" >> "%t"
// RUN: dotnet %s.dll "dotnet" "hello" >> "%t"
// RUN: dotnet %s.dll "dotnet" "aloha" >> "%t"
// RUN: %baredafny translate js %args --no-verify --compile-target "%s" --output=%s.js
// RUN: node %s.js "javascript" 2 >> "%t"
// RUN: node %s.js "javascript" 1 >> "%t"
// RUN: node %s.js "javascript" "aloha" >> "%t"
// RUN: %baredafny translate cpp %args --no-verify --compile-target "%s" --output=%s.exe
// RUN: %s.exe "cpp" 2 >> "%t"
// RUN: %s.exe "cpp" 1 >> "%t"
// RUN: %s.exe "cpp" "aloha" >> "%t"
// RUN: %baredafny translate java %args --no-verify --compile-target "%s" >> "%t"
...
// RUN: %baredafny translate py %args --no-verify --compile-target "%s" >> "%t"
...
// RUN: %baredafny translate go %args --no-verify --compile-target "%s" >> "%t"
