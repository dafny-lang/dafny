...
// RUN: %baredafny translate cs --verify-scope=Everything --use-basename-for-filename --cores:2 --verification-time-limit:300 --output=%S/consumer/usesTimesTwo --library=%S/Inputs/producer/timesTwo.dfy %s
