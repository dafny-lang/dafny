...
method {:synthesize "mock"} mockUnsafe() 
  returns (e:Even) 
...
method {:synthesize "mock"} mockSimple() returns (e:Even) ensures fresh(e)
...
method {:synthesize "mock"} MockValidEven() returns (e:Even) 
  ensures fresh(e) 
  ensures e.IsValid() == true
method {:synthesize "mock"} MockInValidEven() returns (e:Even) 
  ensures fresh(e) 
...
method {:synthesize "mock"} MockSum() returns (e:Even) 
  ensures fresh(e) 
  ensures e.Sum(2, 2) == 3
...
method {:synthesize "mock"} MockSumForall() returns (e:Even) 
  ensures fresh(e) 
...
method {:synthesize "mock"} MockSumAsMultiplication() returns (e:Even) 
  ensures fresh(e) 
...
method {:synthesize "mock"} MockSumWithArgumentMatcher() returns (e:Even) 
  ensures fresh(e) 
...
method {:synthesize "mock"} MockField() returns (e:Even) 
  ensures fresh(e) 
  ensures e.value == 7;
...
method {:synthesize "mock"} ParametrizedMock(a: int) returns (e:Even) 
  ensures fresh(e) 
  ensures e.value == a;
...
method {:synthesize "mock"} SelfReferentialMock() returns (e:Even) 
  ensures fresh(e)
  ensures e.Next() == e
...
method {:synthesize "mock"} CrossReferentialMock() returns (e1:Even, e2:Even) 
...
method {:synthesize "mock"} MockStringMap(k:string, v:string) 
  returns (m:StringMap)
