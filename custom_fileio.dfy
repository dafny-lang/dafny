// Custom FileIO module that doesn't depend on modules using ORDINAL
...
module FileIOInternalExterns {
  method INTERNAL_ReadBytesFromFile(path: string)
    returns (isError: bool, bytesRead: seq<bv8>, errorMsg: string)
    decreases *
  {
    // This is a stub that will be replaced by the Rust implementation
