...
pub mod _module {
    ...
    impl _default {
        ...
        pub fn Main(_noArgsParameter: &Sequence<Sequence<DafnyChar>>) -> () {
            ...
            let mut _out0: Rc<Outcome<Sequence<DafnyChar>>> = crate::Std::FileIO::_default::WriteUTF8ToFile(&testPath, &testContent);
            ...
            let mut _out1: Rc<Result<Sequence<DafnyChar>, Sequence<DafnyChar>>> = crate::Std::FileIO::_default::ReadUTF8FromFile(&testPath);
            ...
            pub fn WriteUTF8ToFile(path: &Sequence<DafnyChar>, content: &Sequence<DafnyChar>) -> Rc<Outcome<Sequence<DafnyChar>>> {
                ...
                for i in integer_range(int!(0), _hi0.clone()) {
                    if !(int!(255) < int!(content.get(&i).0)) {
                        ...
                        bytes = bytes.concat(&seq![truncate!(int!(63), u8)]);
                    }
                }
                let mut isError: bool;
                let mut errorMsg: Sequence<DafnyChar>;
