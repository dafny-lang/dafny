...
Is constructing a `set`, which must be finite, Dafny must prove that the set is indeed finite.
...
TODO - Why not? functions are transparent. Wouldn't Dafny unroll at least once? - #dafny 1/13/2022
