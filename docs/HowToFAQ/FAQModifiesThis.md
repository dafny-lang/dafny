...
More on framing (`modifies` and `reads` clauses) can be found in the [reference manual section on Framing specifications](https://dafny.org/dafny/DafnyRef/DafnyRef#sec-frame-expression).
