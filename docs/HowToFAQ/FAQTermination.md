...
Well, first of all, be careful about thinking things like "I know this to be logically consostent". Verifiers exist to check our human tendency to hand-wave over problatic parts.

That said, you can (chat by) doing something like this:
...
That may cause some quantificatino triggering problems and may need an axiom like
```
