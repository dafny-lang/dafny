...
In addition, sometimes one ensures clause serves as a lemma for the next one. Without the earlier clause, Dafny can have trouble proving the second one, even though it is valid.
