...
## 26.1. Type Parameter Completion {#sec-type-parameter-completion}

[http://leino.science/papers/krml270.html](http://leino.science/papers/krml270.html)

TO BE WRITTEN

## 26.2. Type Inference {#sec-type-inference}

TO BE WRITTEN

## 26.3. Ghost Inference
...
#### 26.4.1.1. Well-founded Functions
...
#### 26.4.1.2. Example with Well-founded Functions {#sec-fib-example}
...
### 26.4.2. Working with Extreme Predicates
...
#### 26.4.2.1. Example with Least Solution {#sec-example-least-solution}
...
#### 26.4.2.2. Example with Greatest Solution {#sec-example-greatest-solution}
...
### 26.5.1. Well-founded Functions in Dafny
...
### 26.5.3. Extreme Predicates in Dafny {#sec-friendliness}
...
### 26.5.4. Proofs about Extreme Predicates
...
### 26.5.5. Nicer Proofs of Extreme Predicates
...
## 26.6. Variable Initialization and Definite Assignment {#sec-definite-assignment}

TO BE WRITTEN -- rules for default initialization; resulting rules for constructors; definite assignment rules

## 26.7. Well-founded Orders {#sec-well-founded-orders}
...
## 26.8. Module Refinement {#sec-module-refinement}
