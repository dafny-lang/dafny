...
## 5.2. Declaring nested modules standalone
...
## 5.5. Export Sets and Access Control
```grammar
"export" [ ExportId ] [ "..." ]
  {
...
### 5.5.1. Provided and revealed names
...
## 5.7. Module Ordering and Dependencies
...
### 5.8.2. Module Id Context Name Resolution
...
### 5.8.3. Expression Context Name Resolution
...
### 5.8.4. Type Context Name Resolution
