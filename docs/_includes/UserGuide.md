...
## 27.7. The Dafny Server

TO BE WRITTEN

## 27.8. Using Dafny From the Command Line
...
by the tool. The most commonly used options are described in [Section 27.11](#sec-command-line-options).
...
## 27.10. Compilation {#sec-compilation}
...
## 27.11. Dafny Command Line Options {#sec-command-line-options}
...
### 27.11.1. Help and version information
...
### 27.11.4. Controlling aspects of the tool being run
...
### 27.11.5. Controlling verification

* `-verifyAllModules` - verify modules that come from include directives (default is to not verify included modules)
TO BE WRITTEN

### 27.11.6. Controlling boogie

TO BE WRITTEN

### 27.11.7. Controlling the prover

TO BE WRITTEN

### 27.11.8. Controlling compilation
...
### 27.11.9. Options intended for debugging
...
## 27.12. Full list of -command-line options <!-- PDFOMIT -->
