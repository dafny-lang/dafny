...
{\*\expandedcolortbl;;}
\margl1440\margr1440\vieww32460\viewh17940\viewkind0
...
Maintenance of the reference manual.\
   ...
   * Various touchup tasks are listed in the github issues list with the \'91documentation\'92 tag\
\
## FAQs\
\
...
These were abstracted from the Slack channels \'91dafny\'92 and \'91yucca\'92, from their beginning through July 2022.\
...
\
The folder \'91docs/dev\'92 contains material relevant to developers and not to users. This includes information like release instructions and measuring test coverage.\
\
## The Dafny Library\
\
...
## Other material\
\
- Rustan Leino authors a number of \'91Dafny Power User\'92 notes and other dafny technical references. These are typically hosted on his own professional web site at {\field{\*\fldinst{HYPERLINK "https://leino.science/dafny-power-user/"}}{\fldrslt https://leino.science/dafny-power-user/}}. \
