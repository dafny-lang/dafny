...
```dafny <!-- %check-verify Expressions.1.expect -->
...
```dafny <!-- %check-verify-warn Expressions.2.expect -->
class A {
...
```dafny <!-- %check-verify-warn Expressions.3.expect -->
class A {
  var z1: array<nat>
  var z2: array<nat>
...
```dafny <!-- %check-verify Expressions.4.expect -->
