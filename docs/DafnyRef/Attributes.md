...
### 24.1.12. nativeType {#sec-nativetype}
...
of an opaque function. See [Section 24.1.13](#sec-opaque).

<!--
Describe this where refinement is described, as appropriate.

### 24.1.15. prependAssertToken
