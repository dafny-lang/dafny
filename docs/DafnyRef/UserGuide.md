...
- The translation results
   ...
   - `--include-runtime` --- include the Dafny runtime as source or a library for the target language in the generated artifacts
...
* `--include-runtime` - include the runtime library for the target language in    the generated artifacts. The legacy option `-useRuntimeLib` had the 
  opposite sense: when enabled, then the compiled assembly referred to
