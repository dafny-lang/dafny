...
pub mod FileIO {
    ...
    impl _default {
        ...
        pub fn ReadUTF8FromFile(path: &Sequence<DafnyChar>) -> Rc<Result<Sequence<DafnyChar>, Sequence<DafnyChar>>> {
            ...
            let _x = crate::FileIOInternalExterns::_default::INTERNAL_ReadBytesFromFile(path);
            _out0 = _x.0;
            _out1 = _x.1;
            _out2 = _x.2;
            isError = _out0;
        ...
        pub fn WriteUTF8ToFile(path: &Sequence<DafnyChar>, content: &Sequence<DafnyChar>) -> Rc<Outcome<Sequence<DafnyChar>>> {
            ...
            let _x = crate::FileIOInternalExterns::_default::INTERNAL_WriteBytesToFile(path, &bytes);
            _out0 = _x.0;
            _out1 = _x.1;
            isError = _out0;
...
pub mod FileIOInternalExterns {
    ...
    impl _default {
        /// custom_fileio.dfy(12,3)
        pub fn INTERNAL_ReadBytesFromFile(path: &Sequence<DafnyChar>) -> (bool, Sequence<u8>, Sequence<DafnyChar>) {
            let mut isError: bool = <bool as Default>::default();
            let mut bytesRead: Sequence<u8>;
            let mut errorMsg: Sequence<DafnyChar>;
            let mut _rhs0: bool = true;
            let mut _rhs1: Sequence<u8> = seq![] as Sequence<u8>;
            let mut _rhs2: Sequence<DafnyChar> = string_of("Not implemented");
            isError = _rhs0;
            bytesRead = _rhs1.clone();
            errorMsg = _rhs2.clone();
            return (
                    isError,
                    bytesRead.clone(),
                    errorMsg.clone()
        ...
        /// custom_fileio.dfy(20,3)
        pub fn INTERNAL_WriteBytesToFile(path: &Sequence<DafnyChar>, bytes: &Sequence<u8>) -> (bool, Sequence<DafnyChar>) {
            let mut isError: bool = <bool as Default>::default();
            let mut errorMsg: Sequence<DafnyChar>;
            let mut _rhs0: bool = true;
            let mut _rhs1: Sequence<DafnyChar> = string_of("Not implemented");
            isError = _rhs0;
            errorMsg = _rhs1.clone();
            return (
                    isError,
                    errorMsg.clone()
                );
