...
z3-mac:
	...
	wget https://github.com/dafny-lang/solver-builds/releases/download/snapshot-2023-02-17/z3-4.12.1-x64-macos-11-bin.zip
	unzip z3-4.12.1-macos-11-bin.zip
	rm z3-4.12.1-macos-11-bin.zip
	wget https://github.com/dafny-lang/solver-builds/releases/download/snapshot-2023-02-17/z3-4.8.5-x64-macos-11-bin.zip
...
z3-ubuntu:
	mkdir -p ${DIR}Binaries/z3/bin
	wget https://github.com/dafny-lang/solver-builds/releases/download/snapshot-2023-02-17/z3-4.12.1-x64-ubuntu-20.04-bin.zip
	unzip z3-4.12.1-ubuntu-20.04-bin.zip
	rm z3-4.12.1-ubuntu-20.04-bin.zip
	wget https://github.com/dafny-lang/solver-builds/releases/download/snapshot-2023-02-17/z3-4.8.5-x64-ubuntu-20.04-bin.zip
