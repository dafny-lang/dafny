...
method m1() {
  assert fib(20) == 0;//Next2:  assert fib(20) == 0;
}
method m2() {
  assert fib(20) == 0;//Next1:  assert fib(20) == 0;
}
...
",
  ...
  public async Task EnsuresPriorityDependsOnEditingWhileEditingSameMethod() {
    await TestPriorities(@"
method m1() {
  assert fib(20) == 55;//Next7:  assert  fib(20) == 55;//Next8:  assert fib(20) == 55;
}
method m2() {
  assert fib(20) == 55;//Next5:  assert  fib(20) == 55;
}
method m3() {
  assert fib(20) == 55;//Next2:  assert  fib(20) == 55;//Next9:  assert fib(20) == 55;
}
method m4() {
  assert fib(20) == 55;//Next3:  assert  fib(20) == 55;//Next4:  assert fib(20) == 55;
}
method m5() {
  assert fib(20) == 55;//Next1:  assert  fib(20) == 55;//Next6:  assert fib(20) == 55;//Next10:  assert  fib(20) == 55;
}
function fib(n: nat): nat {
  if (n <= 1) then n else fib(n - 1) + fib(n - 2)
}
", "m1 m2 m3 m4 m5 fib\n" +
  ...
  public async Task EnsuresPriorityWorksEvenIfRemovingMethods() {
    await TestPriorities(@"
method m1() { assert fib(20) == 55; }
method m2() { assert fib(20) == 55; }
method m3() {
  assert fib(20) == 55;//Next1:  assert  fib(20) == 55;
} 
method m4() {
  assert fib(20) == 55;//Next2:  assert  fib(20) == 55;
}
function fib(n: nat): nat {
  if (n <= 1) then n else fib(n - 1) + fib(n - 2)
}
method m5() { assert fib(20) == 55; } //Remove3:
",
    "m1 m2 m3 m4 fib m5\n" +
    "m3 m1 m2 m4 fib m5\n" +
    "m4 m3 m1 m2 fib m5\n" +
...
method m1() { assert fib(20) == 55; }
method m2() {
  assert fib(20) == 55;//Next3:  typo//Next5:  assert fib(20) == 55;
}
method m3() {
  assert fib(20) == 55;//Next1:  assert  fib(20) == 55;
} 
...
method m5() { assert fib(20) == 55; } //Remove4:
",
    "m1 m2 m3 m4 fib m5\n" +
    "m3 m1 m2 m4 fib m5\n" +
    "m4 m3 m1 m2 fib m5\n" +
