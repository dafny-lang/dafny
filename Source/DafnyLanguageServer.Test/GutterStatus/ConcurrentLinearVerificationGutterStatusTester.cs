...
public class ConcurrentLinearVerificationGutterStatusTester : LinearVerificationGutterStatusTester {
 ...
 .  |  |  |  |  I  I  |  | :predicate F(i: int) {
 .  |  |  |  |  I  I  |  | :  false // Should not be highlighted in gutter.
 .  |  |  |  |  I  I  |  | :}
    |  |  |  |  I  I  |  | :
 .  .  S [S][ ][I][S][S][ ]:method H()
 .  .  S [=][=][-][~][~][O]:  ensures F(1)
 .  .  S [=][=][-][~][~][=]:{//Replace: { assert false;
 .  .  S [S][ ][I][S][S][ ]:}", false, $"EnsuresManyDocumentsCanBeVerifiedAtOnce{i}.dfy", true, true, verificationStatusGutterReceivers[i]));
    }
