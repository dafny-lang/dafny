  ...
  requires i > 0
{
  return Call(2/i);
      ...
      Assert.Equal("this expression could not be proved", relatedInformation[0].Message);
    }
...
class Test {
        ...
        modifies this
    {
      ...
      Assert.Equal("this expression could not be proved", relatedInformation[1].Message);
