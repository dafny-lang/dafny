...
method Main() {
  Foo(30);
    ...
    Assert.Contains("this sub-expression could not be proved", relatedInformation[1].Message);
    Assert.Contains("this sub-expression could not be proved", relatedInformation[2].Message);
  }
