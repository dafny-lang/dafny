...
namespace Microsoft.Dafny.LanguageServer.Language.Symbols {
  public class SymbolTableFactory : ISymbolTableFactory {
    ...
    public SymbolTable CreateFrom(Program program, CancellationToken cancellationToken) {
      var visited = program.Visit(a => true, b => { });

      var usages = visited.OfType<IHasUsages>().Where(v => !AutoGeneratedToken.Is(v.NameToken))
        .SelectMany(r => r.GetResolvedDeclarations().Where(d => d != null).Select(declaration =>
