...
namespace Microsoft.Dafny.LanguageServer.Language.Symbols {
  public interface ISymbolResolver {
    ...
    /// </summary>
    /// <param name="documentIdentifier">The document whose symbols should be resolved.</param>
    ...
    CompilationUnit ResolveSymbols(TextDocumentIdentifier documentIdentifier, Program program, out bool canDoVerification, CancellationToken cancellationToken);
  }
}
