...
abstract class ProjectManager : IProjectManager {
  ...
  protected abstract DocumentTextBuffer GetDocument(TextDocumentIdentifier documentIdentifier);
  ...
  public void UpdateDocument(DidChangeTextDocumentParams documentChange) {
    ...
    var textBuffer = GetDocument(documentChange.TextDocument);
    
    var oldVer = textBuffer.Version;
    ...
    var migratedUpdates = Compilation.DocumentUpdates.Select(document =>
      document.ToIdeState(migratedPublishedState));
