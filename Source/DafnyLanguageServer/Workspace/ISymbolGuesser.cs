...
namespace Microsoft.Dafny.LanguageServer.Workspace {
  ...
  public interface ISymbolGuesser {
    ...
    bool TryGetSymbolBefore(ResolvedCompilation document, Position position, CancellationToken cancellationToken, [NotNullWhen(true)] out ISymbol? symbol);
    ...
    /// <exception cref="System.OperationCanceledException">Thrown when the cancellation was requested before completion.</exception>
    /// <exception cref="System.ObjectDisposedException">Thrown if the cancellation token was disposed before the completion.</exception>
    bool TryGetTypeBefore(ResolvedCompilation document, Position position, CancellationToken cancellationToken, [NotNullWhen(true)] out ISymbol? typeSymbol);
  }
}
