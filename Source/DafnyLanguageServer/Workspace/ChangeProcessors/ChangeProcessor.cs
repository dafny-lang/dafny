...
public class ChangeProcessor {
  ...
  private IEnumerable<Diagnostic> MigrateDiagnostic(TextDocumentContentChangeEvent change, Diagnostic diagnostic) {
    ...
    yield return diagnostic with {
      Message = diagnostic.Message.StartsWith(Relocator.OutdatedPrefix) ? diagnostic.Message : Relocator.OutdatedPrefix + diagnostic.Message,
  ...
  public VerificationTree RelocateVerificationTree(VerificationTree originalVerificationTree, int lines) {
