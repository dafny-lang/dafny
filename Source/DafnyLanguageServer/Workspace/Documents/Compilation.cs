...
namespace Microsoft.Dafny.LanguageServer.Workspace {
  ...
  public class Compilation {
    ...
    public IdeState InitialIdeState(DafnyOptions options) {
      return ToIdeState(new IdeState(this, new EmptyNode(),
        ImmutableDictionary<Uri, IReadOnlyList<Diagnostic>>.Empty,
        SymbolTable.Empty(), SignatureAndCompletionTable.Empty(options, Project), new Dictionary<ImplementationId, IdeImplementationView>(),
