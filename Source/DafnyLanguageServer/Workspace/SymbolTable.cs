...
public class SymbolTable {
  ...
  private SymbolTable() {
    ...
    Declarations = ImmutableDictionary<IOrigin, IHasNavigationToken>.Empty;
  }
  ...
  private SymbolTable(IReadOnlyList<Reference> references, IReadOnlyList<IHasNavigationToken> hasNavigationTokens) {
    ...
    Declarations = hasNavigationTokens.ToImmutableDictionary(h => h.NavigationToken, h => h);
  ...
  public ImmutableDictionary<IOrigin, IHasNavigationToken> Declarations { get; }
