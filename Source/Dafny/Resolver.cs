...
#region CheckDividedConstructorInit
    ...
    private Statement DesugarAssignOrReturnStmt(AssignOrReturnStmt s, ICodeContext codeContext, out LocalVariable tempLocal) {
    ...
    private void ResolveAssignOrReturnStmt(AssignOrReturnStmt s, ICodeContext codeContext) {
      ...
      s.ResolvedStmt = DesugarAssignOrReturnStmt(s, codeContext, out tempLocal);
