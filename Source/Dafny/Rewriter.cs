                ...
                if (s.BoundVars.Count == 1) {
                  ...
                  if (lhs is MemberSelectExpr) {
                    ...
                    if (!FreeVariablesUtil.ContainsFreeVariable(ll.Seq, false, i)) {
                      Fi = ll.E0;
                      lhsBuilder = e => { var l = new SeqSelectExpr(ll.tok, true, ll.Seq, e, null, ll.CloseParens); l.Type = ll.Type; return l; };
                    } else if (!FreeVariablesUtil.ContainsFreeVariable(ll.E0, false, i)) {
                      Fi = ll.Seq;
                      lhsBuilder = e => { var l = new SeqSelectExpr(ll.tok, true, e, ll.E0, null, ll.CloseParens); l.Type = ll.Type; return l; };
                    }
                  }
                }
