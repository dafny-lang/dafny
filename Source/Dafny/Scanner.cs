...
//      if (ch == EOL) { line++; col = 0; }
  ...
  public void CheckLiteral() {
		switch (t.val) {
			...
			case "where": t.kind = 103; break;
			case "return": t.kind = 104; break;
			case "if": t.kind = 105; break;
			case "while": t.kind = 106; break;
			case "match": t.kind = 107; break;
			case "assert": t.kind = 108; break;
			case "by": t.kind = 109; break;
			case "print": t.kind = 110; break;
			case "forall": t.kind = 111; break;
			case "parallel": t.kind = 112; break;
			case "modify": t.kind = 113; break;
			case "exists": t.kind = 132; break;
			case "in": t.kind = 134; break;
			case "false": t.kind = 141; break;
			case "true": t.kind = 142; break;
			case "null": t.kind = 143; break;
			case "this": t.kind = 144; break;
			case "fresh": t.kind = 145; break;
			case "allocated": t.kind = 146; break;
			case "unchanged": t.kind = 147; break;
			case "old": t.kind = 148; break;
			default: break;
		}
  }
