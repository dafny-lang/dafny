...
//      if (ch == EOL) { line++; col = 0; }
  ...
  public void CheckLiteral() {
		switch (t.val) {
			...
			case "assume": t.kind = 35; break;
			case "assert": t.kind = 36; break;
			...
			case "least": t.kind = 49; break;
			case "greatest": t.kind = 50; break;
			case "inductive": t.kind = 51; break;
			case "twostate": t.kind = 52; break;
			case "copredicate": t.kind = 53; break;
			case "lemma": t.kind = 54; break;
			case "static": t.kind = 55; break;
			case "import": t.kind = 56; break;
			case "export": t.kind = 57; break;
			case "class": t.kind = 58; break;
			case "trait": t.kind = 59; break;
			case "datatype": t.kind = 60; break;
			case "codatatype": t.kind = 61; break;
			case "var": t.kind = 62; break;
			case "const": t.kind = 63; break;
			case "newtype": t.kind = 64; break;
			case "type": t.kind = 65; break;
			case "iterator": t.kind = 66; break;
			case "method": t.kind = 67; break;
			case "colemma": t.kind = 68; break;
			case "constructor": t.kind = 69; break;
			case "modifies": t.kind = 70; break;
			case "reads": t.kind = 71; break;
			case "requires": t.kind = 72; break;
			case "ensures": t.kind = 73; break;
			case "ghost": t.kind = 74; break;
			case "new": t.kind = 75; break;
			case "nameonly": t.kind = 76; break;
			case "older": t.kind = 77; break;
			case "witness": t.kind = 78; break;
			case "reveal": t.kind = 96; break;
			case "expect": t.kind = 97; break;
			case "include": t.kind = 102; break;
			case "abstract": t.kind = 103; break;
			case "module": t.kind = 104; break;
			case "refines": t.kind = 105; break;
			case "opened": t.kind = 106; break;
			case "provides": t.kind = 107; break;
			case "reveals": t.kind = 108; break;
			case "extends": t.kind = 109; break;
			case "yields": t.kind = 110; break;
			case "returns": t.kind = 111; break;
			case "yield": t.kind = 114; break;
			case "label": t.kind = 115; break;
			case "continue": t.kind = 116; break;
			case "break": t.kind = 117; break;
			case "return": t.kind = 118; break;
			case "if": t.kind = 120; break;
			case "while": t.kind = 121; break;
			case "for": t.kind = 122; break;
			case "match": t.kind = 123; break;
			...
			case "false": t.kind = 155; break;
			case "true": t.kind = 156; break;
			case "null": t.kind = 157; break;
			default: break;
		}
  }
      ...
      case 0: {
        ...
        t.kind = recKind; break;
			...
			case 27:
				...
				else if (ch == 92) {AddCh(); goto case 70;}
				else {goto case 0;}
			case 28:
			...
			case 60:
				...
				else if (ch == '_') {AddCh(); goto case 72;}
			...
			case 62:
				...
				else if (ch == 'v') {AddCh(); goto case 74;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 63:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch == '?' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 75;}
				else if (ch == 39) {AddCh(); goto case 76;}
			...
			case 68:
				recEnd = pos; recKind = 1;
				if (ch == 39 || ch >= '0' && ch <= '9' || ch == '?' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 68;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 69:
			...
			case 73:
				...
				else if (ch == 'r') {AddCh(); goto case 77;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 74:
				recEnd = pos; recKind = 1;
				if (ch == 39 || ch == '?' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 11;}
				else if (ch >= '1' && ch <= '9') {AddCh(); goto case 78;}
				else if (ch == '0') {AddCh(); goto case 79;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 75:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch == '?' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 80;}
				else if (ch == 39) {AddCh(); goto case 81;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 76:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch == '?' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 80;}
			...
			case 78:
				...
				if (ch == 39 || ch == '?' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 68;}
			...
			case 113:
				...
				else if (ch == '=') {AddCh(); goto case 119;}
				else {t.kind = 88; break;}
			case 114:
				recEnd = pos; recKind = 86;
				if (ch == '=') {AddCh(); goto case 120;}
