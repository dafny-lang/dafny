...
// RUN: %exits-with 3 %run --no-verify /Main:A.Test "%s" >> "%t"
// RUN: %exits-with 3 %run --no-verify /Main:B.Test "%s" >> "%t"
// RUN: %run --no-verify /Main:C.Test "%s" >> "%t"
// RUN: %exits-with 3 %run --no-verify /Main:D.Test "%s" >> "%t"
// RUN: %run --no-verify /Main:E.Test "%s" >> "%t"
// RUN: %run --no-verify /Main:G.Test "%s" >> "%t"
// RUN: %exits-with 3 %run --no-verify /Main:H.Test "%s" >> "%t"
// RUN: %run --no-verify /Main:I.Test "%s" >> "%t"
