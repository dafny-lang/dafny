...
// RUN: %verify "%s" > "%t"
// RUN: %exits-with 3 %dafny /noVerify /compile:4 --target cs "%s" > "%t".abyss
// RUN: %exits-with 3 %dafny /noVerify /compile:4 --target java "%s" > "%t".abyss
// RUN: %dafny /noVerify /compile:4 --target js "%s" > "%t".abyss
// RUN: %exits-with 3 %dafny /noVerify /compile:4 --target go "%s" > "%t".abyss
// RUN: %exits-with 3 %dafny /noVerify /compile:4 --target cpp "%s" > "%t".abyss
// RUN: %diff "%s.expect" "%t"
