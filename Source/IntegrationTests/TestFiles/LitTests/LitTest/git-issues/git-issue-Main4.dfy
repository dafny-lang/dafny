...
// RUN: %verify "%s" > "%t"
// RUN: %dafny /noVerify /compile:4 --target cs /Main:A.AA.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 --target js /Main:A.AA.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 --target go /Main:A.AA.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 --target java /Main:A.AA.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 --target cs /Main:B.C.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 --target js /Main:B.C.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 --target go /Main:B.C.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 --target java /Main:B.C.Test "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 --target cs /Main:B.Test "%s" >> "%t"
