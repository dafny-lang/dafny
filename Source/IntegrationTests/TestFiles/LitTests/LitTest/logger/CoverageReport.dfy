...
// RUN: %baredafny verify --use-basename-for-filename --show-snippets false --allow-axioms --verify-included-files --no-timestamp-for-coverage-report --verification-coverage-report "%t/coverage_verification" %s
