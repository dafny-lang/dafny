...
// RUN: %dafny /noVerify /compile:4 /Main:Cl.Static   --target cs "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Cl.Instance --target cs "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Tr.Static   --target cs "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Dt.Static   --target cs "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Dt.Instance --target cs "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Co.Static   --target cs "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Co.Instance --target cs "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Nt.Static   --target cs "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Nt.Instance --target cs "%s" >> "%t"

// RUN: %dafny /noVerify /compile:4 /Main:Cl.Static   --target js "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Cl.Instance --target js "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Tr.Static   --target js "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Dt.Static   --target js "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Dt.Instance --target js "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Co.Static   --target js "%s" >> "%t"
// RUN: %dafny /noVerify /compile:4 /Main:Co.Instance --target js "%s" >> "%t"
