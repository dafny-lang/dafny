...
axiom (forall a: Set, b: Set :: 
  { Set#Difference(Set#Union(a, b), b) } 
  Set#Disjoint(a, b)
     ==> Set#Difference(Set#Union(a, b), b) == a);

axiom (forall a: Set, b: Box :: 
  { Set#Difference(Set#UnionOne(a, b), Set#UnionOne(Set#Empty(), b)) } 
  !Set#IsMember(a, b)
     ==> Set#Difference(Set#UnionOne(a, b), Set#UnionOne(Set#Empty(), b)) == a);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ReferrersLocal (correctness)"} Impl$$_module.__default.ReferrersLocal(depth: int) returns ($_reverifyPost: bool)
{
  ...
  var newtype$check#1: ref;
    ...
    assume true;
    alias_t#0 := t#0;
    $ReferrersHeap := updateReferrers($ReferrersHeap, t#0, Set#UnionOne(readReferrers($ReferrersHeap, alias_t#0),
      $Box(#_System._tuple#2._#Make2($Box(locals), $Box(local_field(_module.__default.ReferrersLocal.alias__t, depth))))
    ));
  ...
  after_0:
    ...
    assume true;
    $ReferrersHeap := updateReferrers($ReferrersHeap, t#0, Set#Difference(readReferrers($ReferrersHeap, t#0),
      Set#UnionOne(Set#Empty(): Set, $Box(#_System._tuple#2._#Make2($Box(locals), $Box(local_field(_module.__default.ReferrersLocal.t, depth)))))
    ));
    t#0 := null;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CallReferrersMethodCall (correctness)"} Impl$$_module.__default.CallReferrersMethodCall(depth: int) returns ($_reverifyPost: bool)
{
  ...
  var t2##0: ref;
    ...
    t#0 := $nw;
    $ReferrersHeap := updateReferrers($ReferrersHeap, t#0, Set#UnionOne(Set#Empty(),
      $Box(#_System._tuple#2._#Make2($Box(locals), $Box(local_field(_module.__default.CallReferrersMethodCall.t, depth))))
    ));
    defass#t#0 := true;
...
const unique _module.__default.GhostReferrersLocals.t: FieldFamily uses {
  axiom
    (forall depth: int ::
...
const unique _module.__default.GhostReferrersLocals.alias__tracked: FieldFamily uses {
  axiom
    (forall depth: int ::
...
const unique _module.__default.GhostReferrersLocals.alias__untracked: FieldFamily uses {
  axiom
    (forall depth: int ::
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "GhostReferrersLocals (correctness)"} Impl$$_module.__default.GhostReferrersLocals(depth: int) returns ($_reverifyPost: bool)
{
  ...
  var alias_tracked#0: ref
    ...
    t#0 := $nw;
    $ReferrersHeap := updateReferrers($ReferrersHeap, t#0, Set#UnionOne(Set#Empty(),
      $Box(#_System._tuple#2._#Make2($Box(locals), $Box(local_field(_module.__default.GhostReferrersLocals.t, depth))))
    ));
    defass#t#0 := true;
    ...
    assume true;
    assert {:id "id29"} Set#Equal(readReferrers($ReferrersHeap, t#0), 
      Set#UnionOne(Set#Empty(): Set, 
        $Box(#_System._tuple#2._#Make2($Box(locals), $Box(local_field(_module.__default.GhostReferrersLocals.t, depth))))));
    ...
    assume true;
    assert {:id "id33"} Set#Equal(readReferrers($ReferrersHeap, t#0), 
      Set#UnionOne(Set#Empty(): Set, 
        $Box(#_System._tuple#2._#Make2($Box(locals), $Box(local_field(_module.__default.GhostReferrersLocals.t, depth))))));
    ...
    assume true;
    alias_tracked#0 := t#0;
    $ReferrersHeap := updateReferrers($ReferrersHeap, t#0, Set#UnionOne(readReferrers($ReferrersHeap, alias_tracked#0),
      $Box(#_System._tuple#2._#Make2($Box(locals), $Box(local_field(_module.__default.GhostReferrersLocals.alias__tracked, depth))))
    ));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ObjectFields (correctness)"} Impl$$_module.__default.ObjectFields(depth: int) returns ($_reverifyPost: bool)
{
  ...
  var $oldRhs#0: ref;
    ...
    if ($oldRhs#0 != null) {
      $ReferrersHeap := updateReferrers($ReferrersHeap, $rhs#0, Set#Difference(readReferrers($ReferrersHeap, $oldRhs#0), Set#UnionOne(Set#Empty(), $Box(#_System._tuple#2._#Make2($Box(t#0), $Box(_module.ChainingObject.x))))
      ));
    }
    if ($rhs#0 != null) {
    ...
    if ($oldRhs#0 != null) {
      $ReferrersHeap := updateReferrers($ReferrersHeap, $rhs#0, Set#Difference(readReferrers($ReferrersHeap, $oldRhs#0), Set#UnionOne(Set#Empty(), $Box(#_System._tuple#2._#Make2($Box(t#0), $Box(_module.ChainingObject.y))))
      ));
    }
    if ($rhs#1 != null) {
