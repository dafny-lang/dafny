...
// CHECK:Verification part 1/2 of Foo, on line 11, verified successfully \(time: .*, resource count: .*\)
// CHECK:Verification part 2/2 of Foo, on line 12, verified successfully \(time: .*, resource count: .*\)
