...
// Test error cases for exponential notation and trailing dot literals

method MalformedExponentialNotation() {
  // Incomplete exponential notation - missing exponent
  var a := 1.23e;      // Error: incomplete
  var b := 5.e;        // Error: incomplete  
  
  // Missing digits after decimal in exponential notation
...
method InvalidCombinations() {
  ...
  // Invalid characters in exponential notation
