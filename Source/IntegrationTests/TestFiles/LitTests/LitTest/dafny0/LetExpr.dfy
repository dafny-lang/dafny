// RUN: %exits-with 4 %verify --allow-deprecation --relax-definite-assignment --succeed-on-warnings --print "%t.print.dfy" "%s" > "%t"
// RUN: %resolve --succeed-on-warnings --allow-deprecation "%t.print.dfy" >> "%t"
// RUN: %diff "%s.expect" "%t"
