...
module M1 refines M0 {
  ...
  class S<T> { }  // yes, when refining an opaque type, allowed to rename type parameter (U -> T)
  ...
  type TP2<Y0, E1>  // yes, when refining an opaque type, allowed to rename type parameter (Y1 -> E1)
}
