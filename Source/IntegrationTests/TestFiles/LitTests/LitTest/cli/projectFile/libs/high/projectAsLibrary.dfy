...
// RUN: %verify --library "%S/../mid/dfyconfig.toml" --library %S/../low/wrappersLib.dfy --unsafe-dependencies --allow-warnings --function-syntax 3 %s >> "%t"
// RUN: ! %verify --library "%S/../mid/dfyconfig.toml" --library %S/../low/wrappersLib.dfy --allow-warnings --function-syntax 3 %s >> "%t"
// RUN: %diff "%s.expect" "%t"
