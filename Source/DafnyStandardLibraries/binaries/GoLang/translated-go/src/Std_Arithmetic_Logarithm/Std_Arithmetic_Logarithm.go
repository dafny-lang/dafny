// Package Std_Arithmetic_Logarithm
// Dafny module Std_Arithmetic_Logarithm compiled into Go
...
func (*Default__) String() string {
  return "Std_Arithmetic_Logarithm.Default__"
}
...
func (_static *CompanionStruct_Default___) Log(base _dafny.Int, pow _dafny.Int) _dafny.Int {
  var _123___accumulator _dafny.Int = _dafny.Zero
  _ = _123___accumulator
  ...
  if ((pow).Cmp(base) < 0) {
    ...
    var _in40 _dafny.Int = base
    _ = _in40
    var _in41 _dafny.Int = (pow).DivBy(base)
    _ = _in41
    base = _in40
    pow = _in41
    goto TAIL_CALL_START
