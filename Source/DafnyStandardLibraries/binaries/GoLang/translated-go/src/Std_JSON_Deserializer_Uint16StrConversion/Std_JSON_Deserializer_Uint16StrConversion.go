...
func (_static *CompanionStruct_Default___) OfDigits(digits _dafny.Sequence) _dafny.Sequence {
  var _456___accumulator _dafny.Sequence = _dafny.SeqOf()
  _ = _456___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if (_dafny.Companion_Sequence_.Equal(digits, _dafny.SeqOf())) {
    return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(), _456___accumulator)
  } else {
    _456___accumulator = _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf((Companion_Default___.Chars()).Select(((digits).Select(0).(_dafny.Int)).Uint32()).(uint16)), _456___accumulator)
    var _in80 _dafny.Sequence = (digits).Drop(1)
    _ = _in80
    digits = _in80
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) OfNumberStr(str _dafny.Sequence, minus uint16) bool {
  return !(!_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) || (((((str).Select(0).(uint16)) == (minus)) || (_dafny.Companion_Sequence_.Contains(Companion_Default___.Chars(), (str).Select(0).(uint16)))) && (_dafny.Quantifier(((str).Drop(1)).UniqueElements(), true, func (_forall_var_7 uint16) bool {
    var _457_c uint16
    _457_c = interface{}(_forall_var_7).(uint16)
    return !(_dafny.Companion_Sequence_.Contains((str).Drop(1), _457_c)) || (_dafny.Companion_Sequence_.Contains(Companion_Default___.Chars(), _457_c))
  })))
}
func (_static *CompanionStruct_Default___) ToNumberStr(str _dafny.Sequence, minus uint16) bool {
  return !(!_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) || (((((str).Select(0).(uint16)) == (minus)) || ((Companion_Default___.CharToDigit()).Contains((str).Select(0).(uint16)))) && (_dafny.Quantifier(((str).Drop(1)).UniqueElements(), true, func (_forall_var_8 uint16) bool {
    var _458_c uint16
    _458_c = interface{}(_forall_var_8).(uint16)
    return !(_dafny.Companion_Sequence_.Contains((str).Drop(1), _458_c)) || ((Companion_Default___.CharToDigit()).Contains(_458_c))
  })))
}
...
func (_static *CompanionStruct_Default___) ToNat(str _dafny.Sequence) _dafny.Int {
  if (_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) {
    ...
    return ((Companion_Default___.ToNat((str).Take(((_dafny.IntOfUint32((str).Cardinality())).Minus(_dafny.One)).Uint32()))).Times(Companion_Default___.Base())).Plus((Companion_Default___.CharToDigit()).Get((str).Select(((_dafny.IntOfUint32((str).Cardinality())).Minus(_dafny.One)).Uint32()).(uint16)).(_dafny.Int))
  }
}
...
func (_static *CompanionStruct_Default___) ToNatLeft(xs _dafny.Sequence) _dafny.Int {
  var _459___accumulator _dafny.Int = _dafny.Zero
  _ = _459___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    return (_dafny.Zero).Plus(_459___accumulator)
  } else {
    _459___accumulator = ((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Times(Std_Arithmetic_Power.Companion_Default___.Pow(Companion_Default___.BASE(), (_dafny.IntOfUint32((xs).Cardinality())).Minus(_dafny.One)))).Plus(_459___accumulator)
    var _in81 _dafny.Sequence = Std_Collections_Seq.Companion_Default___.DropLast(xs)
    _ = _in81
    xs = _in81
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) FromNat(n _dafny.Int) _dafny.Sequence {
  var _460___accumulator _dafny.Sequence = _dafny.SeqOf()
  _ = _460___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if ((n).Sign() == 0) {
    return _dafny.Companion_Sequence_.Concatenate(_460___accumulator, _dafny.SeqOf())
  } else {
    _460___accumulator = _dafny.Companion_Sequence_.Concatenate(_460___accumulator, _dafny.SeqOf((n).Modulo(Companion_Default___.BASE())))
    var _in82 _dafny.Int = (n).DivBy(Companion_Default___.BASE())
    _ = _in82
    n = _in82
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) SeqExtend(xs _dafny.Sequence, n _dafny.Int) _dafny.Sequence {
  ...
  if ((_dafny.IntOfUint32((xs).Cardinality())).Cmp(n) >= 0) {
    ...
    var _in83 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(xs, _dafny.SeqOf(_dafny.Zero))
    _ = _in83
    var _in84 _dafny.Int = n
    _ = _in84
    xs = _in83
    n = _in84
    goto TAIL_CALL_START
...
func (_static *CompanionStruct_Default___) SeqExtendMultiple(xs _dafny.Sequence, n _dafny.Int) _dafny.Sequence {
  var _461_newLen _dafny.Int = ((_dafny.IntOfUint32((xs).Cardinality())).Plus(n)).Minus((_dafny.IntOfUint32((xs).Cardinality())).Modulo(n))
  _ = _461_newLen
  return Companion_Default___.SeqExtend(xs, _461_newLen)
}
...
func (_static *CompanionStruct_Default___) SeqZero(len_ _dafny.Int) _dafny.Sequence {
  var _462_xs _dafny.Sequence = Companion_Default___.FromNatWithLen(_dafny.Zero, len_)
  _ = _462_xs
  return _462_xs
}
func (_static *CompanionStruct_Default___) SeqAdd(xs _dafny.Sequence, ys _dafny.Sequence) _dafny.Tuple {
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    ...
    _ = _let_tmp_rhs13
    var _463_zs_k _dafny.Sequence = (*(_let_tmp_rhs13).IndexInt(0)).(_dafny.Sequence)
    _ = _463_zs_k
    var _464_cin _dafny.Int = (*(_let_tmp_rhs13).IndexInt(1)).(_dafny.Int)
    _ = _464_cin
    var _465_sum _dafny.Int = ((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Plus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Plus(_464_cin)
    _ = _465_sum
    var _let_tmp_rhs14 _dafny.Tuple = (func () _dafny.Tuple { if (_465_sum).Cmp(Companion_Default___.BASE()) < 0 { return _dafny.TupleOf(_465_sum, _dafny.Zero) }; return _dafny.TupleOf((_465_sum).Minus(Companion_Default___.BASE()), _dafny.One) })() 
    _ = _let_tmp_rhs14
    var _466_sum__out _dafny.Int = (*(_let_tmp_rhs14).IndexInt(0)).(_dafny.Int)
    _ = _466_sum__out
    var _467_cout _dafny.Int = (*(_let_tmp_rhs14).IndexInt(1)).(_dafny.Int)
    _ = _467_cout
    return _dafny.TupleOf(_dafny.Companion_Sequence_.Concatenate(_463_zs_k, _dafny.SeqOf(_466_sum__out)), _467_cout)
  }
}
func (_static *CompanionStruct_Default___) SeqSub(xs _dafny.Sequence, ys _dafny.Sequence) _dafny.Tuple {
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    ...
    _ = _let_tmp_rhs15
    var _468_zs _dafny.Sequence = (*(_let_tmp_rhs15).IndexInt(0)).(_dafny.Sequence)
    _ = _468_zs
    var _469_cin _dafny.Int = (*(_let_tmp_rhs15).IndexInt(1)).(_dafny.Int)
    _ = _469_cin
    var _let_tmp_rhs16 _dafny.Tuple = (func () _dafny.Tuple { if (Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Cmp((Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int)).Plus(_469_cin)) >= 0 { return _dafny.TupleOf(((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Minus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Minus(_469_cin), _dafny.Zero) }; return _dafny.TupleOf((((Companion_Default___.BASE()).Plus(Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int))).Minus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Minus(_469_cin), _dafny.One) })() 
    _ = _let_tmp_rhs16
    var _470_diff__out _dafny.Int = (*(_let_tmp_rhs16).IndexInt(0)).(_dafny.Int)
    _ = _470_diff__out
    var _471_cout _dafny.Int = (*(_let_tmp_rhs16).IndexInt(1)).(_dafny.Int)
    _ = _471_cout
    return _dafny.TupleOf(_dafny.Companion_Sequence_.Concatenate(_468_zs, _dafny.SeqOf(_470_diff__out)), _471_cout)
  }
}
