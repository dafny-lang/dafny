// Package Std_Arithmetic_Power
// Dafny module Std_Arithmetic_Power compiled into Go
...
func (*Default__) String() string {
  return "Std_Arithmetic_Power.Default__"
}
...
func (_static *CompanionStruct_Default___) Pow(b _dafny.Int, e _dafny.Int) _dafny.Int {
  var _122___accumulator _dafny.Int = _dafny.One
  _ = _122___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if ((e).Sign() == 0) {
    return (_dafny.One).Times(_122___accumulator)
  } else {
    _122___accumulator = (_122___accumulator).Times(b)
    var _in38 _dafny.Int = b
    _ = _in38
    var _in39 _dafny.Int = (e).Minus(_dafny.One)
    _ = _in39
    b = _in38
    e = _in39
    goto TAIL_CALL_START
