...
func (_this CursorError) ToString(pr func (interface{}) _dafny.Sequence) _dafny.Sequence {
  {
    ...
    if (_source14.Is_EOF()) {
      ...
      var _354___mcc_h0 uint8 = _source14.Get_().(CursorError_ExpectingByte).Expected
      _ = _354___mcc_h0
      var _355___mcc_h1 int16 = _source14.Get_().(CursorError_ExpectingByte).B
      _ = _355___mcc_h1
      var _356_b int16 = _355___mcc_h1
      _ = _356_b
      var _357_b0 uint8 = _354___mcc_h0
      _ = _357_b0
      var _358_c _dafny.Sequence = (func () _dafny.Sequence { if (_356_b) > (int16(0)) { return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("'"), _dafny.SeqOf(_dafny.CodePoint((_356_b)))), _dafny.UnicodeSeqOfUtf8Bytes("'")) }; return _dafny.UnicodeSeqOfUtf8Bytes("EOF") })() 
      _ = _358_c
      return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("Expecting '"), _dafny.SeqOf(_dafny.CodePoint((_357_b0)))), _dafny.UnicodeSeqOfUtf8Bytes("', read ")), _358_c)
    } else if (_source14.Is_ExpectingAnyByte()) {
      var _359___mcc_h2 _dafny.Sequence = _source14.Get_().(CursorError_ExpectingAnyByte).Expected__sq
      _ = _359___mcc_h2
      var _360___mcc_h3 int16 = _source14.Get_().(CursorError_ExpectingAnyByte).B
      _ = _360___mcc_h3
      var _361_b int16 = _360___mcc_h3
      _ = _361_b
      var _362_bs0 _dafny.Sequence = _359___mcc_h2
      _ = _362_bs0
      var _363_c _dafny.Sequence = (func () _dafny.Sequence { if (_361_b) > (int16(0)) { return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("'"), _dafny.SeqOf(_dafny.CodePoint((_361_b)))), _dafny.UnicodeSeqOfUtf8Bytes("'")) }; return _dafny.UnicodeSeqOfUtf8Bytes("EOF") })() 
      _ = _363_c
      var _364_c0s _dafny.Sequence = _dafny.SeqCreate((_dafny.IntOfUint32((_362_bs0).Cardinality())).Uint32(), func (coer27 func (_dafny.Int) _dafny.CodePoint) func (_dafny.Int) interface{} {
        return func (arg29 _dafny.Int) interface{} {
          return coer27(arg29)
        }
      }((func (_365_bs0 _dafny.Sequence) func (_dafny.Int) _dafny.CodePoint {
        return func (_366_idx _dafny.Int) _dafny.CodePoint {
          return _dafny.CodePoint(((_365_bs0).Select((_366_idx).Uint32()).(uint8)))
        }
      })(_362_bs0)))
      _ = _364_c0s
      return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("Expecting one of '"), _364_c0s), _dafny.UnicodeSeqOfUtf8Bytes("', read ")), _363_c)
    } else {
      var _367___mcc_h4 interface{} = _source14.Get_().(CursorError_OtherError).Err
      _ = _367___mcc_h4
      var _368_err interface{} = _367___mcc_h4
      _ = _368_err
      return (pr)(_368_err)
    }
  }
...
func (_this Cursor__) Suffix() Cursor__ {
  {
    var _369_dt__update__tmp_h0 Cursor__ = _this
    _ = _369_dt__update__tmp_h0
    var _370_dt__update_hbeg_h0 uint32 = (_this).Dtor_point()
    _ = _370_dt__update_hbeg_h0
    return Companion_Cursor___.Create_Cursor_((_369_dt__update__tmp_h0).Dtor_s(), _370_dt__update_hbeg_h0, (_369_dt__update__tmp_h0).Dtor_point(), (_369_dt__update__tmp_h0).Dtor_end())
  }
}
...
func (_this Cursor__) Skip(n uint32) Cursor__ {
  {
    var _371_dt__update__tmp_h0 Cursor__ = _this
    _ = _371_dt__update__tmp_h0
    var _372_dt__update_hpoint_h0 uint32 = ((_this).Dtor_point()) + (n)
    _ = _372_dt__update_hpoint_h0
    return Companion_Cursor___.Create_Cursor_((_371_dt__update__tmp_h0).Dtor_s(), (_371_dt__update__tmp_h0).Dtor_beg(), _372_dt__update_hpoint_h0, (_371_dt__update__tmp_h0).Dtor_end())
  }
}
func (_this Cursor__) Unskip(n uint32) Cursor__ {
  {
    var _373_dt__update__tmp_h0 Cursor__ = _this
    _ = _373_dt__update__tmp_h0
    var _374_dt__update_hpoint_h0 uint32 = ((_this).Dtor_point()) - (func () uint32 { return  (n) })()
    _ = _374_dt__update_hpoint_h0
    return Companion_Cursor___.Create_Cursor_((_373_dt__update__tmp_h0).Dtor_s(), (_373_dt__update__tmp_h0).Dtor_beg(), _374_dt__update_hpoint_h0, (_373_dt__update__tmp_h0).Dtor_end())
  }
}
...
func (_this Cursor__) AssertByte(b uint8) Std_Wrappers.Result {
  {
    var _375_nxt int16 = (_this).Peek()
    _ = _375_nxt
    if ((_375_nxt) == (int16(b))) {
      return Std_Wrappers.Companion_Result_.Create_Success_((_this).Skip(uint32(1)))
    } else {
      return Std_Wrappers.Companion_Result_.Create_Failure_(Companion_CursorError_.Create_ExpectingByte_(b, _375_nxt))
    }
  }
}
func (_this Cursor__) AssertBytes(bs _dafny.Sequence, offset uint32) Std_Wrappers.Result {
  {
    ...
    if ((offset) == (uint32((bs).Cardinality()))) {
      ...
      var _376_valueOrError0 Std_Wrappers.Result = (_this).AssertByte(((bs).Select(uint32(offset)).(uint8)))
      _ = _376_valueOrError0
      if ((_376_valueOrError0).IsFailure()) {
        return (_376_valueOrError0).PropagateFailure()
      } else {
        var _377_ps Cursor__ = (_376_valueOrError0).Extract().(Cursor__)
        _ = _377_ps
        var _in69 Cursor__ = _377_ps
        _ = _in69
        var _in70 _dafny.Sequence = bs
        _ = _in70
        var _in71 uint32 = (offset) + (uint32(1))
        _ = _in71
        _this = _in69
...
func (_this Cursor__) SkipWhile(p func (uint8) bool) Cursor__ {
  {
    ...
    _ = ps
    var _378_point_k uint32
    _ = _378_point_k
    _378_point_k = (_this).Dtor_point()
    var _379_end uint32
    _ = _379_end
    _379_end = (_this).Dtor_end()
    for ((_378_point_k) < (_379_end)) && ((p)(((_this).Dtor_s()).Select(uint32(_378_point_k)).(uint8))) {
      _378_point_k = (_378_point_k) + (uint32(1))
    }
    ps = Companion_Cursor___.Create_Cursor_((_this).Dtor_s(), (_this).Dtor_beg(), _378_point_k, (_this).Dtor_end())
    return ps
    return ps
  }
}
func (_this Cursor__) SkipWhileLexer(step func (interface{}, int16) Std_JSON_Utils_Lexers_Core.LexerResult, st interface{}) Std_Wrappers.Result {
  {
    ...
    for true {
      ...
      var _384_minusone int16
      _ = _384_minusone
      _384_minusone = int16(-1)
      var _385_c int16
      _ = _385_c
      _385_c = (func () int16 { if _383_eof { return _384_minusone }; return int16(((_this).Dtor_s()).Select(uint32(_380_point_k)).(uint8)) })() 
      var _source15 Std_JSON_Utils_Lexers_Core.LexerResult = (step)(_382_st_k, _385_c)
      _ = _source15
      if (_source15.Is_Accept()) {
        pr = Std_Wrappers.Companion_Result_.Create_Success_(Companion_Cursor___.Create_Cursor_((_this).Dtor_s(), (_this).Dtor_beg(), _380_point_k, (_this).Dtor_end()))
        return pr
      } else if (_source15.Is_Reject()) {
        var _386___mcc_h0 interface{} = _source15.Get_().(Std_JSON_Utils_Lexers_Core.LexerResult_Reject).Err
        _ = _386___mcc_h0
        var _387_err interface{} = _386___mcc_h0
        _ = _387_err
        pr = Std_Wrappers.Companion_Result_.Create_Failure_(Companion_CursorError_.Create_OtherError_(_387_err))
        return pr
      } else {
        var _388___mcc_h1 interface{} = _source15.Get_().(Std_JSON_Utils_Lexers_Core.LexerResult_Partial).St
        _ = _388___mcc_h1
        var _389_st_k_k interface{} = _388___mcc_h1
        _ = _389_st_k_k
        if (_383_eof) {
          ...
          _380_point_k = (_380_point_k) + (uint32(1))
        }
      }
    }
    return pr
