...
func (_this *DynamicArray) Ensure(reserved _dafny.Int, defaultValue interface{}) {
  {
    var _109_newCapacity _dafny.Int
    _ = _109_newCapacity
    _109_newCapacity = _this.Capacity
    for (reserved).Cmp((_109_newCapacity).Minus(_this.Size)) > 0 {
      _109_newCapacity = (_this).DefaultNewCapacity(_109_newCapacity)
    }
    if ((_109_newCapacity).Cmp(_this.Capacity) > 0) {
...
func (_this *DynamicArray) Realloc(defaultValue interface{}, newCapacity _dafny.Int) {
  {
    var _110_oldData _dafny.Array
    _ = _110_oldData
    var _111_oldCapacity _dafny.Int
    _ = _111_oldCapacity
    ...
    if (_len0_3.Cmp(_dafny.Zero) == 0) {
      ...
      var _init3 func (_dafny.Int) interface{} = (func (_112_defaultValue interface{}) func (_dafny.Int) interface{} {
        return func (_113___v0 _dafny.Int) interface{} {
...
func (_this *DynamicArray) CopyFrom(newData _dafny.Array, count _dafny.Int) {
  {
    for _iter8 := _dafny.Iterate(_dafny.IntegerRange(_dafny.Zero, count));; {
      ...
      if !_ok8 { break }
      var _114_index _dafny.Int
      _114_index = interface{}(_guard_loop_0).(_dafny.Int)
      if ((true) && (((_114_index).Sign() != -1) && ((_114_index).Cmp(count) < 0))) {
        var _arr2 _dafny.Array = _this.Data
        _ = _arr2
        (_arr2).ArraySet1(((newData)).ArrayGet1((_114_index).Int()), ((_114_index)).Int())
      }
    }
  }
}
