...
func (_static *CompanionStruct_Default___) OfDigits(digits _dafny.Sequence) _dafny.Sequence {
  var _124___accumulator _dafny.Sequence = _dafny.SeqOf()
  _ = _124___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if (_dafny.Companion_Sequence_.Equal(digits, _dafny.SeqOf())) {
    return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(), _124___accumulator)
  } else {
    _124___accumulator = _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf((Companion_Default___.Chars()).Select(((digits).Select(0).(_dafny.Int)).Uint32()).(_dafny.CodePoint)), _124___accumulator)
    var _in42 _dafny.Sequence = (digits).Drop(1)
    _ = _in42
    digits = _in42
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) OfNumberStr(str _dafny.Sequence, minus _dafny.CodePoint) bool {
  return !(!_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) || (((((str).Select(0).(_dafny.CodePoint)) == (minus)) || (_dafny.Companion_Sequence_.Contains(Companion_Default___.Chars(), (str).Select(0).(_dafny.CodePoint)))) && (_dafny.Quantifier(((str).Drop(1)).UniqueElements(), true, func (_forall_var_1 _dafny.CodePoint) bool {
    var _125_c _dafny.CodePoint
    _125_c = interface{}(_forall_var_1).(_dafny.CodePoint)
    return !(_dafny.Companion_Sequence_.Contains((str).Drop(1), _125_c)) || (_dafny.Companion_Sequence_.Contains(Companion_Default___.Chars(), _125_c))
  })))
}
func (_static *CompanionStruct_Default___) ToNumberStr(str _dafny.Sequence, minus _dafny.CodePoint) bool {
  return !(!_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) || (((((str).Select(0).(_dafny.CodePoint)) == (minus)) || ((Companion_Default___.CharToDigit()).Contains((str).Select(0).(_dafny.CodePoint)))) && (_dafny.Quantifier(((str).Drop(1)).UniqueElements(), true, func (_forall_var_2 _dafny.CodePoint) bool {
    var _126_c _dafny.CodePoint
    _126_c = interface{}(_forall_var_2).(_dafny.CodePoint)
    return !(_dafny.Companion_Sequence_.Contains((str).Drop(1), _126_c)) || ((Companion_Default___.CharToDigit()).Contains(_126_c))
  })))
}
...
func (_static *CompanionStruct_Default___) ToNatLeft(xs _dafny.Sequence) _dafny.Int {
  var _127___accumulator _dafny.Int = _dafny.Zero
  _ = _127___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    return (_dafny.Zero).Plus(_127___accumulator)
  } else {
    _127___accumulator = ((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Times(Std_Arithmetic_Power.Companion_Default___.Pow(Companion_Default___.BASE(), (_dafny.IntOfUint32((xs).Cardinality())).Minus(_dafny.One)))).Plus(_127___accumulator)
    var _in43 _dafny.Sequence = Std_Collections_Seq.Companion_Default___.DropLast(xs)
    _ = _in43
    xs = _in43
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) FromNat(n _dafny.Int) _dafny.Sequence {
  var _128___accumulator _dafny.Sequence = _dafny.SeqOf()
  _ = _128___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if ((n).Sign() == 0) {
    return _dafny.Companion_Sequence_.Concatenate(_128___accumulator, _dafny.SeqOf())
  } else {
    _128___accumulator = _dafny.Companion_Sequence_.Concatenate(_128___accumulator, _dafny.SeqOf((n).Modulo(Companion_Default___.BASE())))
    var _in44 _dafny.Int = (n).DivBy(Companion_Default___.BASE())
    _ = _in44
    n = _in44
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) SeqExtend(xs _dafny.Sequence, n _dafny.Int) _dafny.Sequence {
  ...
  if ((_dafny.IntOfUint32((xs).Cardinality())).Cmp(n) >= 0) {
    ...
    var _in45 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(xs, _dafny.SeqOf(_dafny.Zero))
    _ = _in45
    var _in46 _dafny.Int = n
    _ = _in46
    xs = _in45
    n = _in46
    goto TAIL_CALL_START
...
func (_static *CompanionStruct_Default___) SeqExtendMultiple(xs _dafny.Sequence, n _dafny.Int) _dafny.Sequence {
  var _129_newLen _dafny.Int = ((_dafny.IntOfUint32((xs).Cardinality())).Plus(n)).Minus((_dafny.IntOfUint32((xs).Cardinality())).Modulo(n))
  _ = _129_newLen
  return Companion_Default___.SeqExtend(xs, _129_newLen)
}
...
func (_static *CompanionStruct_Default___) SeqZero(len_ _dafny.Int) _dafny.Sequence {
  var _130_xs _dafny.Sequence = Companion_Default___.FromNatWithLen(_dafny.Zero, len_)
  _ = _130_xs
  return _130_xs
}
func (_static *CompanionStruct_Default___) SeqAdd(xs _dafny.Sequence, ys _dafny.Sequence) _dafny.Tuple {
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    ...
    _ = _let_tmp_rhs1
    var _131_zs_k _dafny.Sequence = (*(_let_tmp_rhs1).IndexInt(0)).(_dafny.Sequence)
    _ = _131_zs_k
    var _132_cin _dafny.Int = (*(_let_tmp_rhs1).IndexInt(1)).(_dafny.Int)
    _ = _132_cin
    var _133_sum _dafny.Int = ((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Plus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Plus(_132_cin)
    _ = _133_sum
    var _let_tmp_rhs2 _dafny.Tuple = (func () _dafny.Tuple { if (_133_sum).Cmp(Companion_Default___.BASE()) < 0 { return _dafny.TupleOf(_133_sum, _dafny.Zero) }; return _dafny.TupleOf((_133_sum).Minus(Companion_Default___.BASE()), _dafny.One) })() 
    _ = _let_tmp_rhs2
    var _134_sum__out _dafny.Int = (*(_let_tmp_rhs2).IndexInt(0)).(_dafny.Int)
    _ = _134_sum__out
    var _135_cout _dafny.Int = (*(_let_tmp_rhs2).IndexInt(1)).(_dafny.Int)
    _ = _135_cout
    return _dafny.TupleOf(_dafny.Companion_Sequence_.Concatenate(_131_zs_k, _dafny.SeqOf(_134_sum__out)), _135_cout)
  }
}
func (_static *CompanionStruct_Default___) SeqSub(xs _dafny.Sequence, ys _dafny.Sequence) _dafny.Tuple {
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    ...
    _ = _let_tmp_rhs3
    var _136_zs _dafny.Sequence = (*(_let_tmp_rhs3).IndexInt(0)).(_dafny.Sequence)
    _ = _136_zs
    var _137_cin _dafny.Int = (*(_let_tmp_rhs3).IndexInt(1)).(_dafny.Int)
    _ = _137_cin
    var _let_tmp_rhs4 _dafny.Tuple = (func () _dafny.Tuple { if (Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Cmp((Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int)).Plus(_137_cin)) >= 0 { return _dafny.TupleOf(((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Minus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Minus(_137_cin), _dafny.Zero) }; return _dafny.TupleOf((((Companion_Default___.BASE()).Plus(Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int))).Minus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Minus(_137_cin), _dafny.One) })() 
    _ = _let_tmp_rhs4
    var _138_diff__out _dafny.Int = (*(_let_tmp_rhs4).IndexInt(0)).(_dafny.Int)
    _ = _138_diff__out
    var _139_cout _dafny.Int = (*(_let_tmp_rhs4).IndexInt(1)).(_dafny.Int)
    _ = _139_cout
    return _dafny.TupleOf(_dafny.Companion_Sequence_.Concatenate(_136_zs, _dafny.SeqOf(_138_diff__out)), _139_cout)
  }
}
