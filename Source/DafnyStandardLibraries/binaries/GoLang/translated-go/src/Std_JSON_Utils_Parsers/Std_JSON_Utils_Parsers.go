...
func (_static *CompanionStruct_Default___) ParserWitness() func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  return func (_390___v9 Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) SubParserWitness() func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  return func (_391_cs Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
    return Std_Wrappers.Companion_Result_.Create_Failure_(Std_JSON_Utils_Cursors.Companion_CursorError_.Create_EOF_())
  }
}
...
func (_this *CompanionStruct_Parser_) Witness() func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  return func (coer28 func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result) func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  return func (arg30 Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
    return coer28(arg30)
  }
...
func (_this *CompanionStruct_SubParser_) Witness() func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  return func (coer29 func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result) func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  return func (arg31 Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
    return coer29(arg31)
  }
