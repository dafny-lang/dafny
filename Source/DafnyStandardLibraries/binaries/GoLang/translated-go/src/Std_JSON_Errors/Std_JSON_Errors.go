...
func (_this DeserializationError) ToString() _dafny.Sequence {
  {
    ...
    if (_source10.Is_UnterminatedSequence()) {
      ...
      var _284___mcc_h0 _dafny.Sequence = _source10.Get_().(DeserializationError_UnsupportedEscape).Str
      _ = _284___mcc_h0
      var _285_str _dafny.Sequence = _284___mcc_h0
      _ = _285_str
      return _dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("Unsupported escape sequence: "), _285_str)
      ...
      var _286___mcc_h1 uint8 = _source10.Get_().(DeserializationError_ExpectingByte).Expected
      _ = _286___mcc_h1
      var _287___mcc_h2 int16 = _source10.Get_().(DeserializationError_ExpectingByte).B
      _ = _287___mcc_h2
      var _288_b int16 = _287___mcc_h2
      _ = _288_b
      var _289_b0 uint8 = _286___mcc_h1
      _ = _289_b0
      var _290_c _dafny.Sequence = (func () _dafny.Sequence { if (_288_b) > (int16(0)) { return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("'"), _dafny.SeqOf(_dafny.CodePoint((_288_b)))), _dafny.UnicodeSeqOfUtf8Bytes("'")) }; return _dafny.UnicodeSeqOfUtf8Bytes("EOF") })() 
      _ = _290_c
      return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("Expecting '"), _dafny.SeqOf(_dafny.CodePoint((_289_b0)))), _dafny.UnicodeSeqOfUtf8Bytes("', read ")), _290_c)
    } else if (_source10.Is_ExpectingAnyByte()) {
      var _291___mcc_h3 _dafny.Sequence = _source10.Get_().(DeserializationError_ExpectingAnyByte).Expected__sq
      _ = _291___mcc_h3
      var _292___mcc_h4 int16 = _source10.Get_().(DeserializationError_ExpectingAnyByte).B
      _ = _292___mcc_h4
      var _293_b int16 = _292___mcc_h4
      _ = _293_b
      var _294_bs0 _dafny.Sequence = _291___mcc_h3
      _ = _294_bs0
      var _295_c _dafny.Sequence = (func () _dafny.Sequence { if (_293_b) > (int16(0)) { return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("'"), _dafny.SeqOf(_dafny.CodePoint((_293_b)))), _dafny.UnicodeSeqOfUtf8Bytes("'")) }; return _dafny.UnicodeSeqOfUtf8Bytes("EOF") })() 
      _ = _295_c
      var _296_c0s _dafny.Sequence = _dafny.SeqCreate((_dafny.IntOfUint32((_294_bs0).Cardinality())).Uint32(), func (coer22 func (_dafny.Int) _dafny.CodePoint) func (_dafny.Int) interface{} {
        return func (arg24 _dafny.Int) interface{} {
          return coer22(arg24)
        }
      }((func (_297_bs0 _dafny.Sequence) func (_dafny.Int) _dafny.CodePoint {
        return func (_298_idx _dafny.Int) _dafny.CodePoint {
          return _dafny.CodePoint(((_297_bs0).Select((_298_idx).Uint32()).(uint8)))
        }
      })(_294_bs0)))
      _ = _296_c0s
      return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("Expecting one of '"), _296_c0s), _dafny.UnicodeSeqOfUtf8Bytes("', read ")), _295_c)
    } else {
...
func (_this SerializationError) ToString() _dafny.Sequence {
  {
    ...
    if (_source11.Is_OutOfMemory()) {
      ...
      var _299___mcc_h0 _dafny.Int = _source11.Get_().(SerializationError_IntTooLarge).I
      _ = _299___mcc_h0
      var _300_i _dafny.Int = _299___mcc_h0
      _ = _300_i
      return _dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("Integer too large: "), Std_Strings.Companion_Default___.OfInt(_300_i))
    } else if (_source11.Is_StringTooLong()) {
      var _301___mcc_h1 _dafny.Sequence = _source11.Get_().(SerializationError_StringTooLong).S
      _ = _301___mcc_h1
      var _302_s _dafny.Sequence = _301___mcc_h1
      _ = _302_s
      return _dafny.Companion_Sequence_.Concatenate(_dafny.UnicodeSeqOfUtf8Bytes("String too long: "), _302_s)
    } else {
      return _dafny.UnicodeSeqOfUtf8Bytes("Invalid Unicode sequence")
    }
  }
