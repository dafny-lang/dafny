...
func (_static *CompanionStruct_Default___) DivPos(x _dafny.Int, d _dafny.Int) _dafny.Int {
  var _121___accumulator _dafny.Int = _dafny.Zero
  _ = _121___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if ((x).Sign() == -1) {
    _121___accumulator = (_121___accumulator).Plus(_dafny.IntOfInt64(-1))
    var _in34 _dafny.Int = (x).Plus(d)
    _ = _in34
    var _in35 _dafny.Int = d
    _ = _in35
    x = _in34
    d = _in35
    goto TAIL_CALL_START
    ...
    var _in36 _dafny.Int = (x).Minus(d)
    _ = _in36
    var _in37 _dafny.Int = d
    _ = _in37
    x = _in36
    d = _in37
    goto TAIL_CALL_START
