...
func (_static *CompanionStruct_Default___) Merge(lv View__, rv View__) View__ {
  var _342_dt__update__tmp_h0 View__ = lv
  _ = _342_dt__update__tmp_h0
  var _343_dt__update_hend_h0 uint32 = (rv).Dtor_end()
  _ = _343_dt__update_hend_h0
  return Companion_View___.Create_View_((_342_dt__update__tmp_h0).Dtor_s(), (_342_dt__update__tmp_h0).Dtor_beg(), _343_dt__update_hend_h0)
}
...
func (_static CompanionStruct_View___) OfString(s _dafny.Sequence) _dafny.Sequence {
  return _dafny.SeqCreate((_dafny.IntOfUint32((s).Cardinality())).Uint32(), func (coer26 func (_dafny.Int) uint8) func (_dafny.Int) interface{} {
    return func (arg28 _dafny.Int) interface{} {
      return coer26(arg28)
    }
  }((func (_344_s _dafny.Sequence) func (_dafny.Int) uint8 {
    return func (_345_i _dafny.Int) uint8 {
      return uint8((_344_s).Select((_345_i).Uint32()).(_dafny.CodePoint))
    }
  })(s)))
}
...
func (_this View__) CopyTo(dest _dafny.Array, start uint32) {
  {
    ...
    _ = _hi0
    for _346_idx := uint32(0); _346_idx < _hi0; _346_idx++ {
      var _index6 uint32 = (start) + (_346_idx)
      _ = _index6
      ((dest)).ArraySet1Byte(((_this).Dtor_s()).Select(uint32(((_this).Dtor_beg()) + (_346_idx))).(uint8), int(_index6))
    }
  }
}
