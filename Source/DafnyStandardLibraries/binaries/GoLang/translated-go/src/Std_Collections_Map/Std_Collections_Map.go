...
func (_static *CompanionStruct_Default___) ToImap(m _dafny.Map) _dafny.Map {
  return func () _dafny.Map {
    ...
    for _iter2 := _dafny.Iterate((m).Keys().Elements());; {
      ...
      if !_ok2 { break }
      var _99_x interface{}
      _99_x = interface{}(_compr_1).(interface{})
      if ((m).Contains(_99_x)) {
        _coll1.Add(_99_x,(m).Get(_99_x).(interface{}))
      }
    }
    return _coll1.ToMap()
  }()
...
func (_static *CompanionStruct_Default___) Remove(m _dafny.Map, x interface{}) _dafny.Map {
  var _100_m_k _dafny.Map = func () _dafny.Map {
    var _coll2 = _dafny.NewMapBuilder()
    _ = _coll2
    for _iter3 := _dafny.Iterate((m).Keys().Elements());; {
      _compr_2, _ok3 := _iter3()
      if !_ok3 { break }
      var _101_x_k interface{}
      _101_x_k = interface{}(_compr_2).(interface{})
      if (((m).Contains(_101_x_k)) && (!_dafny.AreEqual(_101_x_k, x))) {
        _coll2.Add(_101_x_k,(m).Get(_101_x_k).(interface{}))
      }
    }
    return _coll2.ToMap()
  }()
...
func (_static *CompanionStruct_Default___) Restrict(m _dafny.Map, xs _dafny.Set) _dafny.Map {
  return func () _dafny.Map {
    ...
    for _iter4 := _dafny.Iterate((xs).Elements());; {
      ...
      if !_ok4 { break }
      var _102_x interface{}
      _102_x = interface{}(_compr_3).(interface{})
      if (((xs).Contains(_102_x)) && ((m).Contains(_102_x))) {
        _coll3.Add(_102_x,(m).Get(_102_x).(interface{}))
      }
    }
    return _coll3.ToMap()
  }()
