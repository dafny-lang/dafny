...
func (_static *CompanionStruct_Default___) Colon(cs Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  var _656_valueOrError0 Std_Wrappers.Result = (cs).AssertChar(_dafny.CodePoint(':'))
  _ = _656_valueOrError0
  if ((_656_valueOrError0).IsFailure()) {
    return (_656_valueOrError0).PropagateFailure()
  } else {
    var _657_cs Std_JSON_Utils_Cursors.Cursor__ = (_656_valueOrError0).Extract().(Std_JSON_Utils_Cursors.Cursor__)
    _ = _657_cs
    return Std_Wrappers.Companion_Result_.Create_Success_((_657_cs).Split())
  }
}
func (_static *CompanionStruct_Default___) KeyValueFromParts(k Std_JSON_Utils_Cursors.Split, colon Std_JSON_Utils_Cursors.Split, v Std_JSON_Utils_Cursors.Split) Std_JSON_Utils_Cursors.Split {
  var _658_sp Std_JSON_Utils_Cursors.Split = Std_JSON_Utils_Cursors.Companion_Split_.Create_SP_(Std_JSON_Grammar.Companion_JKeyValue_.Create_KeyValue_((k).Dtor_t().(Std_JSON_Grammar.Jstring), (colon).Dtor_t().(Std_JSON_Grammar.Structural), (v).Dtor_t().(Std_JSON_Grammar.Value)), (v).Dtor_cs())
  _ = _658_sp
  return _658_sp
}
...
func (_static *CompanionStruct_Default___) Element(cs Std_JSON_Utils_Cursors.Cursor__, json func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result) Std_Wrappers.Result {
  var _659_valueOrError0 Std_Wrappers.Result = Std_JSON_ZeroCopy_Deserializer_Strings.Companion_Default___.String(cs)
  _ = _659_valueOrError0
  if ((_659_valueOrError0).IsFailure()) {
    return (_659_valueOrError0).PropagateFailure()
  } else {
    var _660_k Std_JSON_Utils_Cursors.Split = (_659_valueOrError0).Extract().(Std_JSON_Utils_Cursors.Split)
    _ = _660_k
    var _661_p func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result = Companion_Default___.Colon
    _ = _661_p
    var _662_valueOrError1 Std_Wrappers.Result = Std_JSON_ZeroCopy_Deserializer_Core.Companion_Default___.Structural((_660_k).Dtor_cs(), func (coer42 func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result) func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
      return func (arg44 Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
        return coer42(arg44)
      }
    }(_661_p))
    _ = _662_valueOrError1
    if ((_662_valueOrError1).IsFailure()) {
      return (_662_valueOrError1).PropagateFailure()
    } else {
      var _663_colon Std_JSON_Utils_Cursors.Split = (_662_valueOrError1).Extract().(Std_JSON_Utils_Cursors.Split)
      _ = _663_colon
      var _664_valueOrError2 Std_Wrappers.Result = ((json))((_663_colon).Dtor_cs())
      _ = _664_valueOrError2
      if ((_664_valueOrError2).IsFailure()) {
        return (_664_valueOrError2).PropagateFailure()
      } else {
        var _665_v Std_JSON_Utils_Cursors.Split = (_664_valueOrError2).Extract().(Std_JSON_Utils_Cursors.Split)
        _ = _665_v
        var _666_kv Std_JSON_Utils_Cursors.Split = Companion_Default___.KeyValueFromParts(_660_k, _663_colon, _665_v)
        _ = _666_kv
        return Std_Wrappers.Companion_Result_.Create_Success_(_666_kv)
      }
    }
  }
}
