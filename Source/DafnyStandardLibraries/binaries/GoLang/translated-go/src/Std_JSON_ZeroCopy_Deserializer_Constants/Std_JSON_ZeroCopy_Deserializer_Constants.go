// Package Std_JSON_ZeroCopy_Deserializer_Constants
// Dafny module Std_JSON_ZeroCopy_Deserializer_Constants compiled into Go
...
func (*Default__) String() string {
  return "Std_JSON_ZeroCopy_Deserializer_Constants.Default__"
}
...
func (_static *CompanionStruct_Default___) Constant(cs Std_JSON_Utils_Cursors.Cursor__, expected _dafny.Sequence) Std_Wrappers.Result {
  var _723_valueOrError0 Std_Wrappers.Result = (cs).AssertBytes(expected, uint32(0))
  _ = _723_valueOrError0
  if ((_723_valueOrError0).IsFailure()) {
    return (_723_valueOrError0).PropagateFailure()
  } else {
    var _724_cs Std_JSON_Utils_Cursors.Cursor__ = (_723_valueOrError0).Extract().(Std_JSON_Utils_Cursors.Cursor__)
    _ = _724_cs
    return Std_Wrappers.Companion_Result_.Create_Success_((_724_cs).Split())
  }
}
