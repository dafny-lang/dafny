...
func (_this Chain) Length() _dafny.Int {
  {
    var _347___accumulator _dafny.Int = _dafny.Zero
    _ = _347___accumulator
    goto TAIL_CALL_START
    TAIL_CALL_START:
    if ((_this).Is_Empty()) {
      return (_dafny.Zero).Plus(_347___accumulator)
    } else {
      _347___accumulator = (_dafny.IntOfUint32(((_this).Dtor_v()).Length())).Plus(_347___accumulator)
      var _in63 Chain = (_this).Dtor_previous()
      _ = _in63
      _this = _in63
...
func (_this Chain) Count() _dafny.Int {
  {
    var _348___accumulator _dafny.Int = _dafny.Zero
    _ = _348___accumulator
    goto TAIL_CALL_START
    TAIL_CALL_START:
    if ((_this).Is_Empty()) {
...
func (_this Chain) Bytes() _dafny.Sequence {
  {
    var _349___accumulator _dafny.Sequence = _dafny.SeqOf()
    _ = _349___accumulator
    goto TAIL_CALL_START
    TAIL_CALL_START:
    if ((_this).Is_Empty()) {
      return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(), _349___accumulator)
    } else {
      _349___accumulator = _dafny.Companion_Sequence_.Concatenate(((_this).Dtor_v()).Bytes(), _349___accumulator)
...
func (_this Chain) CopyTo(dest _dafny.Array, end uint32) {
  {
    ...
    if ((_this).Is_Chain()) {
      var _350_end uint32
      _ = _350_end
      _350_end = (end) - (func () uint32 { return  (((_this).Dtor_v()).Length()) })()
      ((_this).Dtor_v()).CopyTo(dest, _350_end)
      var _in66 Chain = (_this).Dtor_previous()
      _ = _in66
      var _in67 _dafny.Array = dest
      _ = _in67
      var _in68 uint32 = _350_end
      _ = _in68
      _this = _in66
...
func (_this Writer__) ToArray() _dafny.Array {
  {
    ...
    if (_len0_4.Cmp(_dafny.Zero) == 0) {
      ...
      var _init4 func (_dafny.Int) uint8 = func (_351_i _dafny.Int) uint8 {
        return uint8(0)
      }
      _ = _init4
