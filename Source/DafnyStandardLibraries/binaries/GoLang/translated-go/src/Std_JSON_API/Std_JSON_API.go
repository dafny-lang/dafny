...
func (_static *CompanionStruct_Default___) Serialize(js Std_JSON_Values.JSON) Std_Wrappers.Result {
  var _774_valueOrError0 Std_Wrappers.Result = Std_JSON_Serializer.Companion_Default___.JSON(js)
  _ = _774_valueOrError0
  if ((_774_valueOrError0).IsFailure()) {
    return (_774_valueOrError0).PropagateFailure()
  } else {
    var _775_js Std_JSON_Grammar.Structural = (_774_valueOrError0).Extract().(Std_JSON_Grammar.Structural)
    _ = _775_js
    return Std_JSON_ZeroCopy_API.Companion_Default___.Serialize(_775_js)
  }
}
func (_static *CompanionStruct_Default___) SerializeAlloc(js Std_JSON_Values.JSON) Std_Wrappers.Result {
  ...
  _ = bs
  var _776_js Std_JSON_Grammar.Structural
  _ = _776_js
  var _777_valueOrError0 Std_Wrappers.Result = Std_Wrappers.Companion_Result_.Default(Std_JSON_Grammar.Companion_Structural_.Default(Std_JSON_Grammar.Companion_Value_.Default()))
  _ = _777_valueOrError0
  _777_valueOrError0 = Std_JSON_Serializer.Companion_Default___.JSON(js)
  if ((_777_valueOrError0).IsFailure()) {
    bs = (_777_valueOrError0).PropagateFailure()
    return bs
  }
  _776_js = (_777_valueOrError0).Extract().(Std_JSON_Grammar.Structural)
  var _out11 Std_Wrappers.Result
  _ = _out11
  _out11 = Std_JSON_ZeroCopy_API.Companion_Default___.SerializeAlloc(_776_js)
  bs = _out11
  return bs
}
func (_static *CompanionStruct_Default___) SerializeInto(js Std_JSON_Values.JSON, bs _dafny.Array) Std_Wrappers.Result {
  ...
  _ = len_
  var _778_js Std_JSON_Grammar.Structural
  _ = _778_js
  var _779_valueOrError0 Std_Wrappers.Result = Std_Wrappers.Companion_Result_.Default(Std_JSON_Grammar.Companion_Structural_.Default(Std_JSON_Grammar.Companion_Value_.Default()))
  _ = _779_valueOrError0
  _779_valueOrError0 = Std_JSON_Serializer.Companion_Default___.JSON(js)
  if ((_779_valueOrError0).IsFailure()) {
    len_ = (_779_valueOrError0).PropagateFailure()
    return len_
  }
  _778_js = (_779_valueOrError0).Extract().(Std_JSON_Grammar.Structural)
  var _out12 Std_Wrappers.Result
  _ = _out12
  _out12 = Std_JSON_ZeroCopy_API.Companion_Default___.SerializeInto(_778_js, bs)
  len_ = _out12
  return len_
}
func (_static *CompanionStruct_Default___) Deserialize(bs _dafny.Sequence) Std_Wrappers.Result {
  var _780_valueOrError0 Std_Wrappers.Result = Std_JSON_ZeroCopy_API.Companion_Default___.Deserialize(bs)
  _ = _780_valueOrError0
  if ((_780_valueOrError0).IsFailure()) {
    return (_780_valueOrError0).PropagateFailure()
  } else {
    var _781_js Std_JSON_Grammar.Structural = (_780_valueOrError0).Extract().(Std_JSON_Grammar.Structural)
    _ = _781_js
    return Std_JSON_Deserializer.Companion_Default___.JSON(_781_js)
  }
}
