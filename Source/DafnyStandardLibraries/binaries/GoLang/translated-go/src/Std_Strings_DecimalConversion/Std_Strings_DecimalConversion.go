...
func (_static *CompanionStruct_Default___) OfDigits(digits _dafny.Sequence) _dafny.Sequence {
  var _140___accumulator _dafny.Sequence = _dafny.SeqOf()
  _ = _140___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if (_dafny.Companion_Sequence_.Equal(digits, _dafny.SeqOf())) {
    return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(), _140___accumulator)
  } else {
    _140___accumulator = _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf((Companion_Default___.Chars()).Select(((digits).Select(0).(_dafny.Int)).Uint32()).(_dafny.CodePoint)), _140___accumulator)
    var _in47 _dafny.Sequence = (digits).Drop(1)
    _ = _in47
    digits = _in47
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) OfNumberStr(str _dafny.Sequence, minus _dafny.CodePoint) bool {
  return !(!_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) || (((((str).Select(0).(_dafny.CodePoint)) == (minus)) || (_dafny.Companion_Sequence_.Contains(Companion_Default___.Chars(), (str).Select(0).(_dafny.CodePoint)))) && (_dafny.Quantifier(((str).Drop(1)).UniqueElements(), true, func (_forall_var_3 _dafny.CodePoint) bool {
    var _141_c _dafny.CodePoint
    _141_c = interface{}(_forall_var_3).(_dafny.CodePoint)
    return !(_dafny.Companion_Sequence_.Contains((str).Drop(1), _141_c)) || (_dafny.Companion_Sequence_.Contains(Companion_Default___.Chars(), _141_c))
  })))
}
func (_static *CompanionStruct_Default___) ToNumberStr(str _dafny.Sequence, minus _dafny.CodePoint) bool {
  return !(!_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) || (((((str).Select(0).(_dafny.CodePoint)) == (minus)) || ((Companion_Default___.CharToDigit()).Contains((str).Select(0).(_dafny.CodePoint)))) && (_dafny.Quantifier(((str).Drop(1)).UniqueElements(), true, func (_forall_var_4 _dafny.CodePoint) bool {
    var _142_c _dafny.CodePoint
    _142_c = interface{}(_forall_var_4).(_dafny.CodePoint)
    return !(_dafny.Companion_Sequence_.Contains((str).Drop(1), _142_c)) || ((Companion_Default___.CharToDigit()).Contains(_142_c))
  })))
}
...
func (_static *CompanionStruct_Default___) ToNat(str _dafny.Sequence) _dafny.Int {
  if (_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOf())) {
    ...
    return ((Companion_Default___.ToNat((str).Take(((_dafny.IntOfUint32((str).Cardinality())).Minus(_dafny.One)).Uint32()))).Times(Companion_Default___.Base())).Plus((Companion_Default___.CharToDigit()).Get((str).Select(((_dafny.IntOfUint32((str).Cardinality())).Minus(_dafny.One)).Uint32()).(_dafny.CodePoint)).(_dafny.Int))
  }
}
...
func (_static *CompanionStruct_Default___) ToNatLeft(xs _dafny.Sequence) _dafny.Int {
  var _143___accumulator _dafny.Int = _dafny.Zero
  _ = _143___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    return (_dafny.Zero).Plus(_143___accumulator)
  } else {
    _143___accumulator = ((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Times(Std_Arithmetic_Power.Companion_Default___.Pow(Companion_Default___.BASE(), (_dafny.IntOfUint32((xs).Cardinality())).Minus(_dafny.One)))).Plus(_143___accumulator)
    var _in48 _dafny.Sequence = Std_Collections_Seq.Companion_Default___.DropLast(xs)
    _ = _in48
    xs = _in48
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) FromNat(n _dafny.Int) _dafny.Sequence {
  var _144___accumulator _dafny.Sequence = _dafny.SeqOf()
  _ = _144___accumulator
  goto TAIL_CALL_START
  TAIL_CALL_START:
  if ((n).Sign() == 0) {
    return _dafny.Companion_Sequence_.Concatenate(_144___accumulator, _dafny.SeqOf())
  } else {
    _144___accumulator = _dafny.Companion_Sequence_.Concatenate(_144___accumulator, _dafny.SeqOf((n).Modulo(Companion_Default___.BASE())))
    var _in49 _dafny.Int = (n).DivBy(Companion_Default___.BASE())
    _ = _in49
    n = _in49
    goto TAIL_CALL_START
  }
...
func (_static *CompanionStruct_Default___) SeqExtend(xs _dafny.Sequence, n _dafny.Int) _dafny.Sequence {
  ...
  if ((_dafny.IntOfUint32((xs).Cardinality())).Cmp(n) >= 0) {
    ...
    var _in50 _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(xs, _dafny.SeqOf(_dafny.Zero))
    _ = _in50
    var _in51 _dafny.Int = n
    _ = _in51
    xs = _in50
    n = _in51
    goto TAIL_CALL_START
...
func (_static *CompanionStruct_Default___) SeqExtendMultiple(xs _dafny.Sequence, n _dafny.Int) _dafny.Sequence {
  var _145_newLen _dafny.Int = ((_dafny.IntOfUint32((xs).Cardinality())).Plus(n)).Minus((_dafny.IntOfUint32((xs).Cardinality())).Modulo(n))
  _ = _145_newLen
  return Companion_Default___.SeqExtend(xs, _145_newLen)
}
...
func (_static *CompanionStruct_Default___) SeqZero(len_ _dafny.Int) _dafny.Sequence {
  var _146_xs _dafny.Sequence = Companion_Default___.FromNatWithLen(_dafny.Zero, len_)
  _ = _146_xs
  return _146_xs
}
func (_static *CompanionStruct_Default___) SeqAdd(xs _dafny.Sequence, ys _dafny.Sequence) _dafny.Tuple {
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    ...
    _ = _let_tmp_rhs5
    var _147_zs_k _dafny.Sequence = (*(_let_tmp_rhs5).IndexInt(0)).(_dafny.Sequence)
    _ = _147_zs_k
    var _148_cin _dafny.Int = (*(_let_tmp_rhs5).IndexInt(1)).(_dafny.Int)
    _ = _148_cin
    var _149_sum _dafny.Int = ((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Plus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Plus(_148_cin)
    _ = _149_sum
    var _let_tmp_rhs6 _dafny.Tuple = (func () _dafny.Tuple { if (_149_sum).Cmp(Companion_Default___.BASE()) < 0 { return _dafny.TupleOf(_149_sum, _dafny.Zero) }; return _dafny.TupleOf((_149_sum).Minus(Companion_Default___.BASE()), _dafny.One) })() 
    _ = _let_tmp_rhs6
    var _150_sum__out _dafny.Int = (*(_let_tmp_rhs6).IndexInt(0)).(_dafny.Int)
    _ = _150_sum__out
    var _151_cout _dafny.Int = (*(_let_tmp_rhs6).IndexInt(1)).(_dafny.Int)
    _ = _151_cout
    return _dafny.TupleOf(_dafny.Companion_Sequence_.Concatenate(_147_zs_k, _dafny.SeqOf(_150_sum__out)), _151_cout)
  }
}
func (_static *CompanionStruct_Default___) SeqSub(xs _dafny.Sequence, ys _dafny.Sequence) _dafny.Tuple {
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    ...
    _ = _let_tmp_rhs7
    var _152_zs _dafny.Sequence = (*(_let_tmp_rhs7).IndexInt(0)).(_dafny.Sequence)
    _ = _152_zs
    var _153_cin _dafny.Int = (*(_let_tmp_rhs7).IndexInt(1)).(_dafny.Int)
    _ = _153_cin
    var _let_tmp_rhs8 _dafny.Tuple = (func () _dafny.Tuple { if (Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Cmp((Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int)).Plus(_153_cin)) >= 0 { return _dafny.TupleOf(((Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int)).Minus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Minus(_153_cin), _dafny.Zero) }; return _dafny.TupleOf((((Companion_Default___.BASE()).Plus(Std_Collections_Seq.Companion_Default___.Last(xs).(_dafny.Int))).Minus(Std_Collections_Seq.Companion_Default___.Last(ys).(_dafny.Int))).Minus(_153_cin), _dafny.One) })() 
    _ = _let_tmp_rhs8
    var _154_diff__out _dafny.Int = (*(_let_tmp_rhs8).IndexInt(0)).(_dafny.Int)
    _ = _154_diff__out
    var _155_cout _dafny.Int = (*(_let_tmp_rhs8).IndexInt(1)).(_dafny.Int)
    _ = _155_cout
    return _dafny.TupleOf(_dafny.Companion_Sequence_.Concatenate(_152_zs, _dafny.SeqOf(_154_diff__out)), _155_cout)
  }
}
