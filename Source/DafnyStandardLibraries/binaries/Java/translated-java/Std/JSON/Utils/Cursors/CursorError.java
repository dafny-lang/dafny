...
public abstract class CursorError<R> {
  ...
  public dafny.DafnySequence<? extends dafny.CodePoint> ToString(dafny.TypeDescriptor<R> _td_R, java.util.function.Function<R, dafny.DafnySequence<? extends dafny.CodePoint>> pr)
  {
    ...
    if (_source14.is_EOF()) {
      ...
      byte _369___mcc_h0 = ((Std.JSON.Utils.Cursors.CursorError_ExpectingByte<R>)_source14)._expected;
      short _370___mcc_h1 = ((Std.JSON.Utils.Cursors.CursorError_ExpectingByte<R>)_source14)._b;
      short _371_b = _370___mcc_h1;
      byte _372_b0 = _369___mcc_h0;
      dafny.DafnySequence<? extends dafny.CodePoint> _373_c = ((java.lang.Integer.signum((_371_b)) == 1) ? (dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.asUnicodeString("'"), dafny.DafnySequence.<dafny.CodePoint> of(dafny.TypeDescriptor.UNICODE_CHAR, dafny.CodePoint.valueOf((int)dafny.Helpers.toInt(_371_b)))), dafny.DafnySequence.asUnicodeString("'"))) : (dafny.DafnySequence.asUnicodeString("EOF")));
      return dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.asUnicodeString("Expecting '"), dafny.DafnySequence.<dafny.CodePoint> of(dafny.TypeDescriptor.UNICODE_CHAR, dafny.CodePoint.valueOf((int)java.lang.Byte.toUnsignedInt(_372_b0)))), dafny.DafnySequence.asUnicodeString("', read ")), _373_c);
    } else if (_source14.is_ExpectingAnyByte()) {
      dafny.DafnySequence<? extends java.lang.Byte> _374___mcc_h2 = ((Std.JSON.Utils.Cursors.CursorError_ExpectingAnyByte<R>)_source14)._expected__sq;
      short _375___mcc_h3 = ((Std.JSON.Utils.Cursors.CursorError_ExpectingAnyByte<R>)_source14)._b;
      short _376_b = _375___mcc_h3;
      dafny.DafnySequence<? extends java.lang.Byte> _377_bs0 = _374___mcc_h2;
      ...
      dafny.DafnySequence<? extends dafny.CodePoint> _379_c0s = dafny.DafnySequence.Create(dafny.TypeDescriptor.UNICODE_CHAR, java.math.BigInteger.valueOf((_377_bs0).length()), ((java.util.function.Function<dafny.DafnySequence<? extends java.lang.Byte>, java.util.function.Function<java.math.BigInteger, dafny.CodePoint>>)(_380_bs0) -> ((java.util.function.Function<java.math.BigInteger, dafny.CodePoint>)(_381_idx_boxed0) -> {
        java.math.BigInteger _381_idx = ((java.math.BigInteger)(java.lang.Object)(_381_idx_boxed0));
        return dafny.CodePoint.valueOf((int)java.lang.Byte.toUnsignedInt(((byte)(java.lang.Object)((_380_bs0).select(dafny.Helpers.toInt((_381_idx)))))));
      })).apply(_377_bs0));
      return dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.asUnicodeString("Expecting one of '"), _379_c0s), dafny.DafnySequence.asUnicodeString("', read ")), _378_c);
    } else {
      R _382___mcc_h4 = ((Std.JSON.Utils.Cursors.CursorError_OtherError<R>)_source14)._err;
      R _383_err = _382___mcc_h4;
      return ((dafny.DafnySequence<? extends dafny.CodePoint>)(java.lang.Object)((pr).apply(_383_err)));
    }
  }
}
