...
public class __default {
  ...
  public static Std.JSON.Utils.Lexers.Core.LexerResult<StringLexerState, dafny.DafnySequence<? extends dafny.CodePoint>> String(StringLexerState st, short byte_)
  {
    ...
    if (_source13.is_Start()) {
      ...
      boolean _367___mcc_h0 = ((Std.JSON.Utils.Lexers.Strings.StringLexerState_Body)_source13)._escaped;
      boolean _368_escaped = _367___mcc_h0;
      if ((byte_) == (((short) ('\\')))) {
        return Std.JSON.Utils.Lexers.Core.LexerResult.<StringLexerState, dafny.DafnySequence<? extends dafny.CodePoint>>create_Partial(StringLexerState._typeDescriptor(), dafny.DafnySequence.<dafny.CodePoint>_typeDescriptor(dafny.TypeDescriptor.UNICODE_CHAR), Std.JSON.Utils.Lexers.Strings.StringLexerState.create_Body(!(_368_escaped)));
      } else if (((byte_) == (((short) ('\"')))) && (!(_368_escaped))) {
