...
public class SubParser__<T, R> {
  ...
  public static <T, R> java.util.function.Function<Std.JSON.Utils.Cursors.Cursor__, Std.Wrappers.Result<Std.JSON.Utils.Cursors.Split<T>, Std.JSON.Utils.Cursors.CursorError<R>>> Default(dafny.TypeDescriptor<T> _td_T, dafny.TypeDescriptor<R> _td_R) {
    return ((java.util.function.Function<Std.JSON.Utils.Cursors.Cursor__, Std.Wrappers.Result<Std.JSON.Utils.Cursors.Split<T>, Std.JSON.Utils.Cursors.CursorError<R>>>) null);
  }
