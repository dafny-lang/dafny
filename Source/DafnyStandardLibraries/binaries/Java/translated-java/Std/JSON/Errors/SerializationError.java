...
public abstract class SerializationError {
  ...
  public dafny.DafnySequence<? extends dafny.CodePoint> ToString() {
    ...
    if (_source11.is_OutOfMemory()) {
      ...
      java.math.BigInteger _314___mcc_h0 = ((Std.JSON.Errors.SerializationError_IntTooLarge)_source11)._i;
      java.math.BigInteger _315_i = _314___mcc_h0;
      return dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.asUnicodeString("Integer too large: "), Std.Strings.__default.OfInt(_315_i));
    } else if (_source11.is_StringTooLong()) {
      dafny.DafnySequence<? extends dafny.CodePoint> _316___mcc_h1 = ((Std.JSON.Errors.SerializationError_StringTooLong)_source11)._s;
      dafny.DafnySequence<? extends dafny.CodePoint> _317_s = _316___mcc_h1;
      return dafny.DafnySequence.<dafny.CodePoint>concatenate(dafny.DafnySequence.asUnicodeString("String too long: "), _317_s);
    } else {
