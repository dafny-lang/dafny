...
public class __default {
  ...
  {
    dafny.DafnySequence<? extends java.lang.Byte> _553___accumulator = dafny.DafnySequence.<java.lang.Byte> empty(Std.BoundedInts.uint8._typeDescriptor());
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((ts).length())).signum() == 0) {
        return dafny.DafnySequence.<java.lang.Byte>concatenate(_553___accumulator, dafny.DafnySequence.<java.lang.Byte> empty(Std.BoundedInts.uint8._typeDescriptor()));
      } else {
        _553___accumulator = dafny.DafnySequence.<java.lang.Byte>concatenate(_553___accumulator, ((dafny.DafnySequence<? extends java.lang.Byte>)(java.lang.Object)((fT).apply(((__T)(java.lang.Object)((ts).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))))));
  ...
  public static dafny.DafnySequence<? extends java.lang.Byte> Object(Std.JSON.Grammar.Bracketed<Std.JSON.Utils.Views.Core.View__, Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__, Std.JSON.Utils.Views.Core.View__> obj) {
    return __default.<Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__>Bracketed(Std.JSON.Grammar.jKeyValue._typeDescriptor(), Std.JSON.Grammar.jcomma._typeDescriptor(), obj, ((java.util.function.Function<Std.JSON.Grammar.Bracketed<Std.JSON.Utils.Views.Core.View__, Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__, Std.JSON.Utils.Views.Core.View__>, java.util.function.Function<Std.JSON.Grammar.Suffixed<Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__>, dafny.DafnySequence<? extends java.lang.Byte>>>)(_554_obj) -> ((java.util.function.Function<Std.JSON.Grammar.Suffixed<Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__>, dafny.DafnySequence<? extends java.lang.Byte>>)(_555_d_boxed0) -> {
      Std.JSON.Grammar.Suffixed<Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__> _555_d = ((Std.JSON.Grammar.Suffixed<Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__>)(java.lang.Object)(_555_d_boxed0));
      return __default.Member(_555_d);
    })).apply(obj));
  }
  public static dafny.DafnySequence<? extends java.lang.Byte> Array(Std.JSON.Grammar.Bracketed<Std.JSON.Utils.Views.Core.View__, Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__, Std.JSON.Utils.Views.Core.View__> arr) {
    return __default.<Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__>Bracketed(Std.JSON.Grammar.Value._typeDescriptor(), Std.JSON.Grammar.jcomma._typeDescriptor(), arr, ((java.util.function.Function<Std.JSON.Grammar.Bracketed<Std.JSON.Utils.Views.Core.View__, Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__, Std.JSON.Utils.Views.Core.View__>, java.util.function.Function<Std.JSON.Grammar.Suffixed<Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__>, dafny.DafnySequence<? extends java.lang.Byte>>>)(_556_arr) -> ((java.util.function.Function<Std.JSON.Grammar.Suffixed<Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__>, dafny.DafnySequence<? extends java.lang.Byte>>)(_557_d_boxed0) -> {
      Std.JSON.Grammar.Suffixed<Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__> _557_d = ((Std.JSON.Grammar.Suffixed<Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__>)(java.lang.Object)(_557_d_boxed0));
      return __default.Item(_557_d);
    })).apply(arr));
  }
  public static dafny.DafnySequence<? extends java.lang.Byte> Value(Std.JSON.Grammar.Value self) {
    ...
    if (_source22.is_Null()) {
      Std.JSON.Utils.Views.Core.View__ _558___mcc_h0 = ((Std.JSON.Grammar.Value_Null)_source22)._n;
      Std.JSON.Utils.Views.Core.View__ _559_n = _558___mcc_h0;
      return __default.View(_559_n);
    } else if (_source22.is_Bool()) {
      Std.JSON.Utils.Views.Core.View__ _560___mcc_h1 = ((Std.JSON.Grammar.Value_Bool)_source22)._b;
      Std.JSON.Utils.Views.Core.View__ _561_b = _560___mcc_h1;
      return __default.View(_561_b);
    } else if (_source22.is_String()) {
      Std.JSON.Grammar.jstring _562___mcc_h2 = ((Std.JSON.Grammar.Value_String)_source22)._str;
      Std.JSON.Grammar.jstring _563_str = _562___mcc_h2;
      return __default.String(_563_str);
    } else if (_source22.is_Number()) {
      Std.JSON.Grammar.jnumber _564___mcc_h3 = ((Std.JSON.Grammar.Value_Number)_source22)._num;
      Std.JSON.Grammar.jnumber _565_num = _564___mcc_h3;
      return __default.Number(_565_num);
    } else if (_source22.is_Object()) {
      Std.JSON.Grammar.Bracketed<Std.JSON.Utils.Views.Core.View__, Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__, Std.JSON.Utils.Views.Core.View__> _566___mcc_h4 = ((Std.JSON.Grammar.Value_Object)_source22)._obj;
      Std.JSON.Grammar.Bracketed<Std.JSON.Utils.Views.Core.View__, Std.JSON.Grammar.jKeyValue, Std.JSON.Utils.Views.Core.View__, Std.JSON.Utils.Views.Core.View__> _567_obj = _566___mcc_h4;
      return __default.Object(_567_obj);
    } else {
      Std.JSON.Grammar.Bracketed<Std.JSON.Utils.Views.Core.View__, Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__, Std.JSON.Utils.Views.Core.View__> _568___mcc_h5 = ((Std.JSON.Grammar.Value_Array)_source22)._arr;
      Std.JSON.Grammar.Bracketed<Std.JSON.Utils.Views.Core.View__, Std.JSON.Grammar.Value, Std.JSON.Utils.Views.Core.View__, Std.JSON.Utils.Views.Core.View__> _569_arr = _568___mcc_h5;
      return __default.Array(_569_arr);
    }
  }
