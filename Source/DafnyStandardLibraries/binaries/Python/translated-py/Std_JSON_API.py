...
class default__:
    ...
    @staticmethod
    def Serialize(js):
        d_765_valueOrError0_ = Std_JSON_Serializer.default__.JSON(js)
        if (d_765_valueOrError0_).IsFailure():
            return (d_765_valueOrError0_).PropagateFailure()
        elif True:
            d_766_js_ = (d_765_valueOrError0_).Extract()
            return Std_JSON_ZeroCopy_API.default__.Serialize(d_766_js_)

    @staticmethod
    def SerializeAlloc(js):
        bs: Std_Wrappers.Result = Std_Wrappers.Result.default(_dafny.defaults.pointer)()
        d_767_js_: Std_JSON_Grammar.Structural
        d_768_valueOrError0_: Std_Wrappers.Result = Std_Wrappers.Result.default(Std_JSON_Grammar.Structural.default(Std_JSON_Grammar.Value.default()))()
        d_768_valueOrError0_ = Std_JSON_Serializer.default__.JSON(js)
        if (d_768_valueOrError0_).IsFailure():
            bs = (d_768_valueOrError0_).PropagateFailure()
            return bs
        d_767_js_ = (d_768_valueOrError0_).Extract()
        out11_: Std_Wrappers.Result
        out11_ = Std_JSON_ZeroCopy_API.default__.SerializeAlloc(d_767_js_)
        bs = out11_
        return bs
    ...
    def SerializeInto(js, bs):
        ...
        d_769_js_: Std_JSON_Grammar.Structural
        d_770_valueOrError0_: Std_Wrappers.Result = Std_Wrappers.Result.default(Std_JSON_Grammar.Structural.default(Std_JSON_Grammar.Value.default()))()
        d_770_valueOrError0_ = Std_JSON_Serializer.default__.JSON(js)
        if (d_770_valueOrError0_).IsFailure():
            len = (d_770_valueOrError0_).PropagateFailure()
            return len
        d_769_js_ = (d_770_valueOrError0_).Extract()
        out12_: Std_Wrappers.Result
        out12_ = Std_JSON_ZeroCopy_API.default__.SerializeInto(d_769_js_, bs)
        len = out12_
        return len

    @staticmethod
    def Deserialize(bs):
        d_771_valueOrError0_ = Std_JSON_ZeroCopy_API.default__.Deserialize(bs)
        if (d_771_valueOrError0_).IsFailure():
            return (d_771_valueOrError0_).PropagateFailure()
        elif True:
            d_772_js_ = (d_771_valueOrError0_).Extract()
            return Std_JSON_Deserializer.default__.JSON(d_772_js_)
