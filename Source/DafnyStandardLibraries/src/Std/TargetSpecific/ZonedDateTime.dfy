...
module Std.ZonedDateTime {
    ...
    function {:extern "ZonedDateTimeImpl", "NowZoned"} {:axiom} NowZonedImpl(): seq<int32>
    ...
    function {:extern "DateTimeImpl", "FromEpochTimeMilliseconds"} {:axiom} FromEpochTimeMillisecondsFunc(epochMillis: int, offsetMinutes: int): seq<int32>
