...
module Std.JSON.ZeroCopy.Deserializer {
  module Core {
    ...
    opaque function Structural<T>(cs: FreshCursor, parser: Parser<T>)
  ...
  abstract module Sequences {
    ...
    @IsolateAssertions
    opaque function Bracketed(cs: FreshCursor, json: ValueParser)
      : (pr: ParseResult<TBracketed>)
  ...
  module API {
    ...
    @IsolateAssertions
    @ResourceLimit("10e6")
    opaque function JSON(cs: Cursors.FreshCursor) : (pr: DeserializationResult<Cursors.Split<JSON>>)
  ...
  module Values {
    ...
    @IsolateAssertions
    opaque function Value(cs: FreshCursor) : (pr: ParseResult<Value>)
  ...
  module Strings {
    ...
    @ResourceLimit("10e6")
    opaque function String(cs: FreshCursor): (pr: ParseResult<jstring>)
  ...
  module Numbers {
    ...
    @IsolateAssertions
    @ResourceLimit("100e6")
    opaque function Exp(cs: FreshCursor) : (pr: ParseResult<Maybe<jexp>>)
  ...
  module Arrays refines Sequences {
    ...
    @IsolateAssertions
    opaque function Array(cs: FreshCursor, json: ValueParser)
  ...
  module ObjectParams refines SequenceParams {
    ...
    @IsolateAssertions
    opaque function Element(cs: FreshCursor, json: ValueParser)
      : (pr: ParseResult<TElement>)
    {
  ...
  module Objects refines Sequences {
    ...
    @IsolateAssertions
    @ResourceLimit("10e6")
    opaque function Object(cs: FreshCursor, json: ValueParser)
