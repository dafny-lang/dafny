...
namespace Dafny{
  ...
  using System.Linq;
    ...
    public class MultiSet<T>
        // Implemented using BigInteger as multiplicity to account for edge cases where near-infinite multiplicities are 
        // necessary
    {
#if DAFNY_USE_SYSTEM_COLLECTIONS_IMMUTABLE
 ...
 new MultiSet<T>(ImmutableDictionary<T, int>.Empty.ToBuilder(), BigInteger.Zero);
#else
      ...
      var r = ImmutableDictionary<T, BigInteger>.Empty.ToBuilder();
            ...
            return new MultiSet<T>(r,
                other.occurrencesOfNull < occurrencesOfNull ? other.occurrencesOfNull : occurrencesOfNull);
        }
      ...
      var r = ImmutableDictionary<T, BigInteger>.Empty.ToBuilder();
            ...
            return new MultiSet<T>(r,
                other.occurrencesOfNull < occurrencesOfNull
                    ? occurrencesOfNull - other.occurrencesOfNull
                    : BigInteger.Zero);
        }
        ...
        public BigInteger BigIntegerCount{
 ...
 new Map<U, V>(ImmutableDictionary<U, V>.Empty.ToBuilder(), false, default(V));
    ...
    public class Sequence<T>{
        ...
        public static Sequence<T> Empty{
            get{ return new Sequence<T>(new T[0]); }
        }
...
namespace @_System{
    public class Tuple2<T0, T1>{
        ...
        public static Tuple2<T0, T1> _DafnyDefaultValue(){
            return Default;
        }
