...
namespace Dafny {
  ...
  public partial class Helpers {
    ...
    /// It is the responsibility of library code to convert the tuple value into the equivalent Result value.
    /// </summary>
    public static void INTERNAL_ReadBytesFromFile(ISequence<char> path, out bool isError, out ISequence<byte> bytesRead, out ISequence<char> errorMsg) {
      isError = true;
