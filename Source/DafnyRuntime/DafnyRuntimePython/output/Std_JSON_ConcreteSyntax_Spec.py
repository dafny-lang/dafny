...
class default__:
    ...
    def ConcatBytes(ts, fT):
        d_532___accumulator_ = _dafny.SeqWithoutIsStrInference([])
        while True:
            with _dafny.label():
                if (len(ts)) == (0):
                    return (d_532___accumulator_) + (_dafny.SeqWithoutIsStrInference([]))
                elif True:
                    d_532___accumulator_ = (d_532___accumulator_) + (fT((ts)[0]))
                    in95_ = _dafny.SeqWithoutIsStrInference((ts)[1::])
                    in96_ = fT
                    ts = in95_
                    fT = in96_
    ...
    @staticmethod
    def Object(obj):
        def lambda36_(d_533_obj_):
            def lambda37_(d_534_d_):
                return default__.Member(d_534_d_)
    ...
    @staticmethod
    def Array(arr):
        def lambda38_(d_535_arr_):
            def lambda39_(d_536_d_):
                return default__.Item(d_536_d_)
    ...
    def Value(self):
        ...
        if source22_.is_Null:
            d_537___mcc_h0_ = source22_.n
            d_538_n_ = d_537___mcc_h0_
            return default__.View(d_538_n_)
        elif source22_.is_Bool:
            d_539___mcc_h1_ = source22_.b
            d_540_b_ = d_539___mcc_h1_
            return default__.View(d_540_b_)
        elif source22_.is_String:
            d_541___mcc_h2_ = source22_.str
            d_542_str_ = d_541___mcc_h2_
            return default__.String(d_542_str_)
        elif source22_.is_Number:
            d_543___mcc_h3_ = source22_.num
            d_544_num_ = d_543___mcc_h3_
            return default__.Number(d_544_num_)
        elif source22_.is_Object:
            d_545___mcc_h4_ = source22_.obj
            d_546_obj_ = d_545___mcc_h4_
            return default__.Object(d_546_obj_)
        elif True:
            d_547___mcc_h5_ = source22_.arr
            d_548_arr_ = d_547___mcc_h5_
            return default__.Array(d_548_arr_)
