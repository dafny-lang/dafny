...
class default__:
    ...
    def LiftCursorError(err):
        ...
        if source24_.is_EOF:
            ...
            d_758___mcc_h0_ = source24_.expected
            d_759___mcc_h1_ = source24_.b
            d_760_b_ = d_759___mcc_h1_
            d_761_expected_ = d_758___mcc_h0_
            return Std_JSON_Errors.DeserializationError_ExpectingByte(d_761_expected_, d_760_b_)
        elif source24_.is_ExpectingAnyByte:
            d_762___mcc_h2_ = source24_.expected__sq
            d_763___mcc_h3_ = source24_.b
            d_764_b_ = d_763___mcc_h3_
            d_765_expected__sq_ = d_762___mcc_h2_
            return Std_JSON_Errors.DeserializationError_ExpectingAnyByte(d_765_expected__sq_, d_764_b_)
        elif True:
            d_766___mcc_h4_ = source24_.err
            d_767_err_ = d_766___mcc_h4_
            return d_767_err_
    ...
    @staticmethod
    def Text(v):
        d_768_valueOrError0_ = default__.JSON(Std_JSON_Utils_Cursors.Cursor__.OfView(v))
        if (d_768_valueOrError0_).IsFailure():
            return (d_768_valueOrError0_).PropagateFailure()
        elif True:
            let_tmp_rhs39_ = (d_768_valueOrError0_).Extract()
            d_769_text_ = let_tmp_rhs39_.t
            d_770_cs_ = let_tmp_rhs39_.cs
            d_771_valueOrError1_ = Std_Wrappers.default__.Need((d_770_cs_).EOF_q, Std_JSON_Errors.DeserializationError_ExpectingEOF())
            if (d_771_valueOrError1_).IsFailure():
                return (d_771_valueOrError1_).PropagateFailure()
            elif True:
                return Std_Wrappers.Result_Success(d_769_text_)

    @staticmethod
    def OfBytes(bs):
        d_772_valueOrError0_ = Std_Wrappers.default__.Need((len(bs)) < (Std_BoundedInts.default__.TWO__TO__THE__32), Std_JSON_Errors.DeserializationError_IntOverflow())
        if (d_772_valueOrError0_).IsFailure():
            return (d_772_valueOrError0_).PropagateFailure()
        elif True:
