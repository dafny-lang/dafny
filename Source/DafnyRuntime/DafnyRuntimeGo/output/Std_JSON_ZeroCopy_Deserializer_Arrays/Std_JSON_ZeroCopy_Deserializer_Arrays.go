...
func (_static *CompanionStruct_Default___) Array(cs Std_JSON_Utils_Cursors.Cursor__, json func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result) Std_Wrappers.Result {
  var _703_valueOrError0 Std_Wrappers.Result = Companion_Default___.Bracketed(cs, json)
  _ = _703_valueOrError0
  if ((_703_valueOrError0).IsFailure()) {
    return (_703_valueOrError0).PropagateFailure()
  } else {
    var _704_sp Std_JSON_Utils_Cursors.Split = (_703_valueOrError0).Extract().(Std_JSON_Utils_Cursors.Split)
    _ = _704_sp
    return Std_Wrappers.Companion_Result_.Create_Success_(_704_sp)
  }
}
func (_static *CompanionStruct_Default___) Open(cs Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  var _705_valueOrError0 Std_Wrappers.Result = (cs).AssertByte(Std_JSON_ZeroCopy_Deserializer_ArrayParams.Companion_Default___.OPEN())
  _ = _705_valueOrError0
  if ((_705_valueOrError0).IsFailure()) {
    return (_705_valueOrError0).PropagateFailure()
  } else {
    var _706_cs Std_JSON_Utils_Cursors.Cursor__ = (_705_valueOrError0).Extract().(Std_JSON_Utils_Cursors.Cursor__)
    _ = _706_cs
    return Std_Wrappers.Companion_Result_.Create_Success_((_706_cs).Split())
  }
}
func (_static *CompanionStruct_Default___) Close(cs Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
  var _707_valueOrError0 Std_Wrappers.Result = (cs).AssertByte(Std_JSON_ZeroCopy_Deserializer_ArrayParams.Companion_Default___.CLOSE())
  _ = _707_valueOrError0
  if ((_707_valueOrError0).IsFailure()) {
    return (_707_valueOrError0).PropagateFailure()
  } else {
    var _708_cs Std_JSON_Utils_Cursors.Cursor__ = (_707_valueOrError0).Extract().(Std_JSON_Utils_Cursors.Cursor__)
    _ = _708_cs
    return Std_Wrappers.Companion_Result_.Create_Success_((_708_cs).Split())
  }
}
func (_static *CompanionStruct_Default___) BracketedFromParts(open Std_JSON_Utils_Cursors.Split, elems Std_JSON_Utils_Cursors.Split, close_ Std_JSON_Utils_Cursors.Split) Std_JSON_Utils_Cursors.Split {
  var _709_sp Std_JSON_Utils_Cursors.Split = Std_JSON_Utils_Cursors.Companion_Split_.Create_SP_(Std_JSON_Grammar.Companion_Bracketed_.Create_Bracketed_((open).Dtor_t().(Std_JSON_Grammar.Structural), (elems).Dtor_t().(_dafny.Sequence), (close_).Dtor_t().(Std_JSON_Grammar.Structural)), (close_).Dtor_cs())
  _ = _709_sp
  return _709_sp
}
func (_static *CompanionStruct_Default___) AppendWithSuffix(elems Std_JSON_Utils_Cursors.Split, elem Std_JSON_Utils_Cursors.Split, sep Std_JSON_Utils_Cursors.Split) Std_JSON_Utils_Cursors.Split {
  var _710_suffixed Std_JSON_Grammar.Suffixed = Std_JSON_Grammar.Companion_Suffixed_.Create_Suffixed_((elem).Dtor_t().(Std_JSON_Grammar.Value), Std_JSON_Grammar.Companion_Maybe_.Create_NonEmpty_((sep).Dtor_t().(Std_JSON_Grammar.Structural)))
  _ = _710_suffixed
  var _711_elems_k Std_JSON_Utils_Cursors.Split = Std_JSON_Utils_Cursors.Companion_Split_.Create_SP_(_dafny.Companion_Sequence_.Concatenate((elems).Dtor_t().(_dafny.Sequence), _dafny.SeqOf(_710_suffixed)), (sep).Dtor_cs())
  _ = _711_elems_k
  return _711_elems_k
}
func (_static *CompanionStruct_Default___) AppendLast(elems Std_JSON_Utils_Cursors.Split, elem Std_JSON_Utils_Cursors.Split, sep Std_JSON_Utils_Cursors.Split) Std_JSON_Utils_Cursors.Split {
  var _712_suffixed Std_JSON_Grammar.Suffixed = Std_JSON_Grammar.Companion_Suffixed_.Create_Suffixed_((elem).Dtor_t().(Std_JSON_Grammar.Value), Std_JSON_Grammar.Companion_Maybe_.Create_Empty_())
  _ = _712_suffixed
  var _713_elems_k Std_JSON_Utils_Cursors.Split = Std_JSON_Utils_Cursors.Companion_Split_.Create_SP_(_dafny.Companion_Sequence_.Concatenate((elems).Dtor_t().(_dafny.Sequence), _dafny.SeqOf(_712_suffixed)), (elem).Dtor_cs())
  _ = _713_elems_k
  return _713_elems_k
}
func (_static *CompanionStruct_Default___) Elements(json func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result, open Std_JSON_Utils_Cursors.Split, elems Std_JSON_Utils_Cursors.Split) Std_Wrappers.Result {
  ...
  TAIL_CALL_START:
  var _714_valueOrError0 Std_Wrappers.Result = Std_JSON_ZeroCopy_Deserializer_ArrayParams.Companion_Default___.Element((elems).Dtor_cs(), json)
  _ = _714_valueOrError0
  if ((_714_valueOrError0).IsFailure()) {
    return (_714_valueOrError0).PropagateFailure()
  } else {
    var _715_elem Std_JSON_Utils_Cursors.Split = (_714_valueOrError0).Extract().(Std_JSON_Utils_Cursors.Split)
    _ = _715_elem
    if (((_715_elem).Dtor_cs()).EOF_q()) {
      ...
      var _716_sep Std_JSON_Utils_Cursors.Split = Std_JSON_ZeroCopy_Deserializer_Core.Companion_Default___.TryStructural((_715_elem).Dtor_cs())
      _ = _716_sep
      var _717_s0 int16 = (((_716_sep).Dtor_t().(Std_JSON_Grammar.Structural)).Dtor_t().(Std_JSON_Utils_Views_Core.View__)).Peek()
      _ = _717_s0
      if (((_717_s0) == (int16(Companion_Default___.SEPARATOR()))) && (((((_716_sep).Dtor_t().(Std_JSON_Grammar.Structural)).Dtor_t().(Std_JSON_Utils_Views_Core.View__)).Length()) == (uint32(1)))) {
        var _718_sep Std_JSON_Utils_Cursors.Split = _716_sep
        _ = _718_sep
        var _719_elems Std_JSON_Utils_Cursors.Split = Companion_Default___.AppendWithSuffix(elems, _715_elem, _718_sep)
        _ = _719_elems
        var _in100 func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result = json
        _ = _in100
        var _in101 Std_JSON_Utils_Cursors.Split = open
        _ = _in101
        var _in102 Std_JSON_Utils_Cursors.Split = _719_elems
        _ = _in102
        json = _in100
        open = _in101
        elems = _in102
        goto TAIL_CALL_START
      } else if (((_717_s0) == (int16(Std_JSON_ZeroCopy_Deserializer_ArrayParams.Companion_Default___.CLOSE()))) && (((((_716_sep).Dtor_t().(Std_JSON_Grammar.Structural)).Dtor_t().(Std_JSON_Utils_Views_Core.View__)).Length()) == (uint32(1)))) {
        var _720_sep Std_JSON_Utils_Cursors.Split = _716_sep
        _ = _720_sep
        var _721_elems_k Std_JSON_Utils_Cursors.Split = Companion_Default___.AppendLast(elems, _715_elem, _720_sep)
        _ = _721_elems_k
        var _722_bracketed Std_JSON_Utils_Cursors.Split = Companion_Default___.BracketedFromParts(open, _721_elems_k, _720_sep)
        _ = _722_bracketed
        return Std_Wrappers.Companion_Result_.Create_Success_(_722_bracketed)
      } else {
        var _723_separator uint8 = Companion_Default___.SEPARATOR()
        _ = _723_separator
        var _724_pr Std_Wrappers.Result = Std_Wrappers.Companion_Result_.Create_Failure_(Std_JSON_Utils_Cursors.Companion_CursorError_.Create_ExpectingAnyByte_(_dafny.SeqOf(Std_JSON_ZeroCopy_Deserializer_ArrayParams.Companion_Default___.CLOSE(), _723_separator), _717_s0))
        _ = _724_pr
        return _724_pr
      }
    }
...
func (_static *CompanionStruct_Default___) Bracketed(cs Std_JSON_Utils_Cursors.Cursor__, json func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result) Std_Wrappers.Result {
  var _725_valueOrError0 Std_Wrappers.Result = Std_JSON_ZeroCopy_Deserializer_Core.Companion_Default___.Structural(cs, func (coer47 func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result) func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
    return func (arg49 Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
      return coer47(arg49)
    }
  }(Companion_Default___.Open))
  _ = _725_valueOrError0
  if ((_725_valueOrError0).IsFailure()) {
    return (_725_valueOrError0).PropagateFailure()
  } else {
    var _726_open Std_JSON_Utils_Cursors.Split = (_725_valueOrError0).Extract().(Std_JSON_Utils_Cursors.Split)
    _ = _726_open
    var _727_elems Std_JSON_Utils_Cursors.Split = Std_JSON_Utils_Cursors.Companion_Split_.Create_SP_(_dafny.SeqOf(), (_726_open).Dtor_cs())
    _ = _727_elems
    if ((((_726_open).Dtor_cs()).Peek()) == (int16(Std_JSON_ZeroCopy_Deserializer_ArrayParams.Companion_Default___.CLOSE()))) {
      var _728_p func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result = Companion_Default___.Close
      _ = _728_p
      var _729_valueOrError1 Std_Wrappers.Result = Std_JSON_ZeroCopy_Deserializer_Core.Companion_Default___.Structural((_726_open).Dtor_cs(), func (coer48 func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result) func (Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
        return func (arg50 Std_JSON_Utils_Cursors.Cursor__) Std_Wrappers.Result {
          return coer48(arg50)
        }
      }(_728_p))
      _ = _729_valueOrError1
      if ((_729_valueOrError1).IsFailure()) {
        return (_729_valueOrError1).PropagateFailure()
      } else {
        var _730_close Std_JSON_Utils_Cursors.Split = (_729_valueOrError1).Extract().(Std_JSON_Utils_Cursors.Split)
        _ = _730_close
        return Std_Wrappers.Companion_Result_.Create_Success_(Companion_Default___.BracketedFromParts(_726_open, _727_elems, _730_close))
      }
    } else {
      return Companion_Default___.Elements(json, _726_open, _727_elems)
    }
  }
}
