// Package Std_JSON_ZeroCopy_API
// Dafny module Std_JSON_ZeroCopy_API compiled into Go
...
func (*Default__) String() string {
  return "Std_JSON_ZeroCopy_API.Default__"
}
...
func (_static *CompanionStruct_Default___) Serialize(js Std_JSON_Grammar.Structural) Std_Wrappers.Result {
  return Std_Wrappers.Companion_Result_.Create_Success_((Std_JSON_ZeroCopy_Serializer.Companion_Default___.Text(js)).Bytes())
}
func (_static *CompanionStruct_Default___) SerializeAlloc(js Std_JSON_Grammar.Structural) Std_Wrappers.Result {
  var bs Std_Wrappers.Result = Std_Wrappers.Companion_Result_.Default(_dafny.NewArrayWithValue(nil, _dafny.IntOf(0)))
  _ = bs
  var _out9 Std_Wrappers.Result
  _ = _out9
  _out9 = Std_JSON_ZeroCopy_Serializer.Companion_Default___.Serialize(js)
  bs = _out9
  return bs
}
func (_static *CompanionStruct_Default___) SerializeInto(js Std_JSON_Grammar.Structural, bs _dafny.Array) Std_Wrappers.Result {
  var len_ Std_Wrappers.Result = Std_Wrappers.Companion_Result_.Default(uint32(0))
  _ = len_
  var _out10 Std_Wrappers.Result
  _ = _out10
  _out10 = Std_JSON_ZeroCopy_Serializer.Companion_Default___.SerializeTo(js, bs)
  len_ = _out10
  return len_
}
func (_static *CompanionStruct_Default___) Deserialize(bs _dafny.Sequence) Std_Wrappers.Result {
  return Std_JSON_ZeroCopy_Deserializer_API.Companion_Default___.OfBytes(bs)
}
