...
func (_static *CompanionStruct_Default___) ElementSpec(t Std_JSON_Grammar.Value) _dafny.Sequence {
  return Std_JSON_ConcreteSyntax_Spec.Companion_Default___.Value(t)
}
