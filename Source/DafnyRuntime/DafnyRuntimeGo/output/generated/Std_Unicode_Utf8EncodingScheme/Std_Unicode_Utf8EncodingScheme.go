// Package Std_Unicode_Utf8EncodingScheme
// Dafny module Std_Unicode_Utf8EncodingScheme compiled into Go
...
func (*Default__) String() string {
  return "Std_Unicode_Utf8EncodingScheme.Default__"
}
...
func (_static *CompanionStruct_Default___) Serialize(s _dafny.Sequence) _dafny.Sequence {
  return Std_Collections_Seq.Companion_Default___.Map(func (coer22 func (uint8) uint8) func (interface{}) interface{} {
    return func (arg24 interface{}) interface{} {
      return coer22(arg24.(uint8))
    }
  }(func (_290_c uint8) uint8 {
    return uint8(_290_c)
  }), s)
}
func (_static *CompanionStruct_Default___) Deserialize(b _dafny.Sequence) _dafny.Sequence {
  return Std_Collections_Seq.Companion_Default___.Map(func (coer23 func (uint8) uint8) func (interface{}) interface{} {
    return func (arg25 interface{}) interface{} {
      return coer23(arg25.(uint8))
    }
  }(func (_291_b uint8) uint8 {
    return uint8(_291_b)
  }), b)
}
