...
public class Vector<T> implements Validatable {
  ...
  public T Last() {
    return (this.storage).Select((this.size).subtract((java.math.BigInteger.ONE)));
  }
  ...
  public void Reallocate(java.math.BigInteger newCapacity)
  {
    ...
    _2_values = _out2;
    (_1_newStorage).UpdateSubarray(java.math.BigInteger.ZERO, _2_values);
  ...
  public T RemoveLast()
  {
    ...
    T t = null;
    if(true) {
      t = (this.storage).Select((this.size).subtract((java.math.BigInteger.ONE)));
