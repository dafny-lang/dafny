...
public final class Array9<T> {
  ...
  public Array9(dafny.TypeDescriptor<T> elmtType, int dim0, int dim1, int dim2, int dim3, int dim4, int dim5, int dim6, int dim7, int dim8, Object[][][][][][][][] elmts) {
  ...
  private static final dafny.TypeDescriptor<Array9<?>> TYPE = (dafny.TypeDescriptor<Array9<?>>) (dafny.TypeDescriptor<?>) dafny.TypeDescriptor.reference(Array9.class);
  @SuppressWarnings({"unchecked", "deprecation"})
  public static <T> dafny.TypeDescriptor<Array9<T>> _typeDescriptor() {
    return (dafny.TypeDescriptor<Array9<T>>) (dafny.TypeDescriptor<?>) TYPE;
  }
}
