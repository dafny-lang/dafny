...
public class jopen {
  ...
  public static Std.JSON.Utils.Views.Core.View__ Witness = Std.JSON.Utils.Views.Core.View__.OfBytes(dafny.DafnySequence.<java.lang.Byte> of(Std.JSON.ZeroCopy.Deserializer.ArrayParams.__default.OPEN()));
