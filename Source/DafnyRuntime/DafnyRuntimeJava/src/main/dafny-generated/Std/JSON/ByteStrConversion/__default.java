...
public class __default {
  ...
  public static dafny.DafnySequence<? extends java.lang.Byte> OfDigits(dafny.DafnySequence<? extends java.math.BigInteger> digits) {
    dafny.DafnySequence<? extends java.lang.Byte> _412___accumulator = dafny.DafnySequence.<java.lang.Byte> empty(Std.BoundedInts.uint8._typeDescriptor());
    TAIL_CALL_START: while (true) {
      if ((digits).equals(dafny.DafnySequence.<java.math.BigInteger> empty(dafny.TypeDescriptor.BIG_INTEGER))) {
        return dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte> empty(Std.BoundedInts.uint8._typeDescriptor()), _412___accumulator);
      } else {
        _412___accumulator = dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte> of(((byte)(java.lang.Object)((__default.chars()).select(dafny.Helpers.toInt((((java.math.BigInteger)(java.lang.Object)((digits).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))))))))), _412___accumulator);
  ...
  {
    return !(!(str).equals(dafny.DafnySequence.<java.lang.Byte> empty(Std.BoundedInts.uint8._typeDescriptor()))) || ((((((byte)(java.lang.Object)((str).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))) == (minus)) || ((__default.charToDigit()).<java.lang.Byte>contains(((byte)(java.lang.Object)((str).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))))) && (((java.util.function.Function<dafny.DafnySequence<? extends java.lang.Byte>, Boolean>)(_415_str) -> dafny.Helpers.Quantifier(((_415_str).drop(java.math.BigInteger.ONE)).UniqueElements(), true, ((_forall_var_6_boxed0) -> {
      byte _forall_var_6 = ((byte)(java.lang.Object)(_forall_var_6_boxed0));
      if (true) {
        byte _416_c = (byte)_forall_var_6;
        return !(((_415_str).drop(java.math.BigInteger.ONE)).contains(_416_c)) || ((__default.charToDigit()).<java.lang.Byte>contains(_416_c));
      } else {
        return true;
      }
    }))).apply(str)));
