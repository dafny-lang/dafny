...
public class jopt {
  ...
  private static final dafny.TypeDescriptor<Std.JSON.Utils.Views.Core.View__> _TYPE = dafny.TypeDescriptor.<Std.JSON.Utils.Views.Core.View__>referenceWithInitializer(Std.JSON.Utils.Views.Core.View__.class, () -> jopt.defaultValue());
