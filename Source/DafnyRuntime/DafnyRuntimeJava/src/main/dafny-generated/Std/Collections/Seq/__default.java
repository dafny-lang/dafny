...
public class __default {
  ...
  public static <__T> Std.Wrappers.Option<java.math.BigInteger> IndexOfOption(dafny.TypeDescriptor<__T> _td___T, dafny.DafnySequence<? extends __T> xs, __T v)
  {
    if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
      ...
      Std.Wrappers.Option<java.math.BigInteger> _75_o_k = __default.<__T>IndexOfOption(_td___T, (xs).drop(java.math.BigInteger.ONE), v);
      if ((_75_o_k).is_Some()) {
        return Std.Wrappers.Option.<java.math.BigInteger>create_Some(dafny.TypeDescriptor.BIG_INTEGER, ((_75_o_k).dtor_value()).add(java.math.BigInteger.ONE));
      } else {
        return Std.Wrappers.Option.<java.math.BigInteger>create_None(dafny.TypeDescriptor.BIG_INTEGER);
      }
    }
  ...
  public static <__T> dafny.DafnySequence<? extends __T> RemoveValue(dafny.TypeDescriptor<__T> _td___T, dafny.DafnySequence<? extends __T> xs, __T v)
  {
    if (!(xs).contains(v)) {
      ...
      java.math.BigInteger _76_i = __default.<__T>IndexOf(_td___T, xs, v);
      return dafny.DafnySequence.<__T>concatenate((xs).take(_76_i), (xs).drop((_76_i).add(java.math.BigInteger.ONE)));
    }
  }
  ...
  {
    dafny.DafnySequence<? extends __T> _77___accumulator = dafny.DafnySequence.<__T> empty(_td___T);
    TAIL_CALL_START: while (true) {
      if ((xs).equals(dafny.DafnySequence.<__T> empty(_td___T))) {
        return dafny.DafnySequence.<__T>concatenate(_77___accumulator, dafny.DafnySequence.<__T> empty(_td___T));
      } else {
        _77___accumulator = dafny.DafnySequence.<__T>concatenate(_77___accumulator, dafny.DafnySequence.<__T> of(_td___T, ((__T)(java.lang.Object)((xs).select(dafny.Helpers.toInt(((java.math.BigInteger.valueOf((xs).length())).subtract(java.math.BigInteger.ONE))))))));
  ...
  {
    dafny.DafnySequence<? extends __T> _78___accumulator = dafny.DafnySequence.<__T> empty(_td___T);
    TAIL_CALL_START: while (true) {
      if ((length).signum() == 0) {
        return dafny.DafnySequence.<__T>concatenate(_78___accumulator, dafny.DafnySequence.<__T> empty(_td___T));
      } else {
        _78___accumulator = dafny.DafnySequence.<__T>concatenate(_78___accumulator, dafny.DafnySequence.<__T> of(_td___T, v));
        __T _in7 = v;
  ...
  public static <__A, __B> dafny.Tuple2<dafny.DafnySequence<? extends __A>, dafny.DafnySequence<? extends __B>> Unzip(dafny.TypeDescriptor<__A> _td___A, dafny.TypeDescriptor<__B> _td___B, dafny.DafnySequence<? extends dafny.Tuple2<__A, __B>> xs)
  {
    if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
      ...
      dafny.DafnySequence<? extends __A> _79_a = ((dafny.DafnySequence<? extends __A>)(java.lang.Object)(((dafny.Tuple2<dafny.DafnySequence<? extends __A>, dafny.DafnySequence<? extends __B>>)_let_tmp_rhs0).dtor__0()));
      dafny.DafnySequence<? extends __B> _80_b = ((dafny.DafnySequence<? extends __B>)(java.lang.Object)(((dafny.Tuple2<dafny.DafnySequence<? extends __A>, dafny.DafnySequence<? extends __B>>)_let_tmp_rhs0).dtor__1()));
      return dafny.Tuple2.<dafny.DafnySequence<? extends __A>, dafny.DafnySequence<? extends __B>>create(dafny.DafnySequence.<__A>concatenate(_79_a, dafny.DafnySequence.<__A> of(_td___A, (__default.<dafny.Tuple2<__A, __B>>Last(dafny.Tuple2.<__A, __B>_typeDescriptor(_td___A, _td___B), xs)).dtor__0())), dafny.DafnySequence.<__B>concatenate(_80_b, dafny.DafnySequence.<__B> of(_td___B, (__default.<dafny.Tuple2<__A, __B>>Last(dafny.Tuple2.<__A, __B>_typeDescriptor(_td___A, _td___B), xs)).dtor__1())));
    }
  }
  ...
  {
    dafny.DafnySequence<? extends dafny.Tuple2<__A, __B>> _81___accumulator = dafny.DafnySequence.<dafny.Tuple2<__A, __B>> empty(dafny.Tuple2.<__A, __B>_typeDescriptor(_td___A, _td___B));
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
        return dafny.DafnySequence.<dafny.Tuple2<__A, __B>>concatenate(dafny.DafnySequence.<dafny.Tuple2<__A, __B>> empty(dafny.Tuple2.<__A, __B>_typeDescriptor(_td___A, _td___B)), _81___accumulator);
      } else {
        _81___accumulator = dafny.DafnySequence.<dafny.Tuple2<__A, __B>>concatenate(dafny.DafnySequence.<dafny.Tuple2<__A, __B>> of(dafny.Tuple2.<__A, __B>_typeDescriptor(_td___A, _td___B), dafny.Tuple2.<__A, __B>create(__default.<__A>Last(_td___A, xs), __default.<__B>Last(_td___B, ys))), _81___accumulator);
  ...
  public static <__T> dafny.DafnySequence<? extends __T> Flatten(dafny.TypeDescriptor<__T> _td___T, dafny.DafnySequence<? extends dafny.DafnySequence<? extends __T>> xs)
  {
    ...
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
        ...
        _82___accumulator = dafny.DafnySequence.<__T>concatenate(_82___accumulator, ((dafny.DafnySequence<? extends __T>)(java.lang.Object)((xs).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))));
  ...
  {
    dafny.DafnySequence<? extends __T> _83___accumulator = dafny.DafnySequence.<__T> empty(_td___T);
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
        return dafny.DafnySequence.<__T>concatenate(dafny.DafnySequence.<__T> empty(_td___T), _83___accumulator);
      } else {
        _83___accumulator = dafny.DafnySequence.<__T>concatenate(__default.<dafny.DafnySequence<? extends __T>>Last(dafny.DafnySequence.<__T>_typeDescriptor(_td___T), xs), _83___accumulator);
  ...
  {
    dafny.DafnySequence<? extends __R> _84___accumulator = dafny.DafnySequence.<__R> empty(_td___R);
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
        return dafny.DafnySequence.<__R>concatenate(_84___accumulator, dafny.DafnySequence.<__R> empty(_td___R));
      } else {
        _84___accumulator = dafny.DafnySequence.<__R>concatenate(_84___accumulator, dafny.DafnySequence.<__R> of(_td___R, ((__R)(java.lang.Object)((f).apply(((__T)(java.lang.Object)((xs).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))))))));
        java.util.function.Function<__T, __R> _in13 = f;
        dafny.DafnySequence<? extends __T> _in14 = (xs).drop(java.math.BigInteger.ONE);
        f = _in13;
        xs = _in14;
        continue TAIL_CALL_START;
      }
  ...
  public static <__T, __R, __E> Std.Wrappers.Result<dafny.DafnySequence<? extends __R>, __E> MapWithResult(dafny.TypeDescriptor<__T> _td___T, dafny.TypeDescriptor<__R> _td___R, dafny.TypeDescriptor<__E> _td___E, java.util.function.Function<__T, Std.Wrappers.Result<__R, __E>> f, dafny.DafnySequence<? extends __T> xs)
  {
    if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
      ...
      Std.Wrappers.Result<__R, __E> _85_valueOrError0 = ((Std.Wrappers.Result<__R, __E>)(java.lang.Object)((f).apply(((__T)(java.lang.Object)((xs).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))))));
      if ((_85_valueOrError0).IsFailure(_td___R, _td___E)) {
        return (_85_valueOrError0).<dafny.DafnySequence<? extends __R>>PropagateFailure(_td___R, _td___E, dafny.DafnySequence.<__R>_typeDescriptor(_td___R));
      } else {
        __R _86_head = (_85_valueOrError0).Extract(_td___R, _td___E);
        Std.Wrappers.Result<dafny.DafnySequence<? extends __R>, __E> _87_valueOrError1 = __default.<__T, __R, __E>MapWithResult(_td___T, _td___R, _td___E, f, (xs).drop(java.math.BigInteger.ONE));
        if ((_87_valueOrError1).IsFailure(dafny.DafnySequence.<__R>_typeDescriptor(_td___R), _td___E)) {
          return (_87_valueOrError1).<dafny.DafnySequence<? extends __R>>PropagateFailure(dafny.DafnySequence.<__R>_typeDescriptor(_td___R), _td___E, dafny.DafnySequence.<__R>_typeDescriptor(_td___R));
        } else {
          dafny.DafnySequence<? extends __R> _88_tail = (_87_valueOrError1).Extract(dafny.DafnySequence.<__R>_typeDescriptor(_td___R), _td___E);
          return Std.Wrappers.Result.<dafny.DafnySequence<? extends __R>, __E>create_Success(dafny.DafnySequence.<__R>_typeDescriptor(_td___R), _td___E, dafny.DafnySequence.<__R>concatenate(dafny.DafnySequence.<__R> of(_td___R, _86_head), _88_tail));
        }
      }
    }
  }
  ...
  {
    dafny.DafnySequence<? extends __T> _89___accumulator = dafny.DafnySequence.<__T> empty(_td___T);
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
        return dafny.DafnySequence.<__T>concatenate(_89___accumulator, dafny.DafnySequence.<__T> empty(_td___T));
      } else {
        _89___accumulator = dafny.DafnySequence.<__T>concatenate(_89___accumulator, ((((boolean)(java.lang.Object)((f).apply(((__T)(java.lang.Object)((xs).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))))))) ? (dafny.DafnySequence.<__T> of(_td___T, ((__T)(java.lang.Object)((xs).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))))) : (dafny.DafnySequence.<__T> empty(_td___T))));
        java.util.function.Function<__T, Boolean> _in15 = f;
        dafny.DafnySequence<? extends __T> _in16 = (xs).drop(java.math.BigInteger.ONE);
        f = _in15;
        xs = _in16;
        continue TAIL_CALL_START;
      }
  ...
  public static <__A, __T> __A FoldLeft(dafny.TypeDescriptor<__A> _td___A, dafny.TypeDescriptor<__T> _td___T, dafny.Function2<__A, __T, __A> f, __A init, dafny.DafnySequence<? extends __T> xs)
  {
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((xs).length())).signum() == 0) {
        ...
        dafny.Function2<__A, __T, __A> _in17 = f;
        __A _in18 = ((__A)(java.lang.Object)((f).apply(init, ((__T)(java.lang.Object)((xs).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))))));
        dafny.DafnySequence<? extends __T> _in19 = (xs).drop(java.math.BigInteger.ONE);
        f = _in17;
        init = _in18;
        xs = _in19;
        continue TAIL_CALL_START;
  ...
  public static <__T> dafny.DafnySequence<? extends __T> SetToSeq(dafny.TypeDescriptor<__T> _td___T, dafny.DafnySet<? extends __T> s)
  {
    ...
    if(true) {
      ...
      dafny.DafnySet<? extends __T> _90_left;
      _90_left = s;
      while (!(_90_left).equals(dafny.DafnySet.<__T> empty())) {
        @SuppressWarnings({"unchecked", "deprecation"})
        __T _91_x;
        goto__ASSIGN_SUCH_THAT_0: {
          for (__T _assign_such_that_0_boxed0 : (_90_left).Elements()) {
            __T _assign_such_that_0 = ((__T)(java.lang.Object)(_assign_such_that_0_boxed0));
            if (true) {
              _91_x = (__T)_assign_such_that_0;
              if ((_90_left).<__T>contains(_91_x)) {
                break goto__ASSIGN_SUCH_THAT_0;
              }
            }
          }
          throw new IllegalArgumentException("assign-such-that search produced no value (line 7122)");
        }
        _90_left = dafny.DafnySet.<__T>difference(_90_left, dafny.DafnySet.<__T> of(_91_x));
        xs = dafny.DafnySequence.<__T>concatenate(xs, dafny.DafnySequence.<__T> of(_td___T, _91_x));
      }
    }
    return xs;
  }
  ...
  public static <__T> dafny.DafnySequence<? extends __T> MergeSortBy(dafny.TypeDescriptor<__T> _td___T, dafny.Function2<__T, __T, Boolean> lessThanOrEq, dafny.DafnySequence<? extends __T> a)
  {
    if ((java.math.BigInteger.valueOf((a).length())).compareTo(java.math.BigInteger.ONE) <= 0) {
      ...
      java.math.BigInteger _92_splitIndex = dafny.DafnyEuclidean.EuclideanDivision(java.math.BigInteger.valueOf((a).length()), java.math.BigInteger.valueOf(2L));
      dafny.DafnySequence<? extends __T> _93_left = (a).take(_92_splitIndex);
      dafny.DafnySequence<? extends __T> _94_right = (a).drop(_92_splitIndex);
      dafny.DafnySequence<? extends __T> _95_leftSorted = __default.<__T>MergeSortBy(_td___T, lessThanOrEq, _93_left);
      dafny.DafnySequence<? extends __T> _96_rightSorted = __default.<__T>MergeSortBy(_td___T, lessThanOrEq, _94_right);
      return __default.<__T>MergeSortedWith(_td___T, _95_leftSorted, _96_rightSorted, lessThanOrEq);
    }
  }
  ...
  {
    dafny.DafnySequence<? extends __T> _97___accumulator = dafny.DafnySequence.<__T> empty(_td___T);
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((left).length())).signum() == 0) {
        return dafny.DafnySequence.<__T>concatenate(_97___accumulator, right);
      } else if ((java.math.BigInteger.valueOf((right).length())).signum() == 0) {
        return dafny.DafnySequence.<__T>concatenate(_97___accumulator, left);
        ...
        _97___accumulator = dafny.DafnySequence.<__T>concatenate(_97___accumulator, dafny.DafnySequence.<__T> of(_td___T, ((__T)(java.lang.Object)((left).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))));
        dafny.DafnySequence<? extends __T> _in20 = (left).drop(java.math.BigInteger.ONE);
        dafny.DafnySequence<? extends __T> _in21 = right;
        dafny.Function2<__T, __T, Boolean> _in22 = lessThanOrEq;
        left = _in20;
        right = _in21;
        lessThanOrEq = _in22;
        continue TAIL_CALL_START;
      } else {
        _97___accumulator = dafny.DafnySequence.<__T>concatenate(_97___accumulator, dafny.DafnySequence.<__T> of(_td___T, ((__T)(java.lang.Object)((right).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))));
        dafny.DafnySequence<? extends __T> _in23 = left;
        dafny.DafnySequence<? extends __T> _in24 = (right).drop(java.math.BigInteger.ONE);
        dafny.Function2<__T, __T, Boolean> _in25 = lessThanOrEq;
        left = _in23;
        right = _in24;
        lessThanOrEq = _in25;
        continue TAIL_CALL_START;
