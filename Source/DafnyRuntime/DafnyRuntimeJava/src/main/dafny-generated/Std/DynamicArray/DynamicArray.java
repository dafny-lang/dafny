...
public class DynamicArray<A> {
  ...
  {
    java.math.BigInteger _130_newCapacity = java.math.BigInteger.ZERO;
    _130_newCapacity = this.capacity;
    while ((reserved).compareTo((_130_newCapacity).subtract(this.size)) > 0) {
      _130_newCapacity = (this).DefaultNewCapacity(_130_newCapacity);
    }
    if ((_130_newCapacity).compareTo(this.capacity) > 0) {
      (this).Realloc(defaultValue, _130_newCapacity);
    }
  }
  public void PopFast()
  {
  ...
  {
    java.lang.Object _131_oldData;
    java.math.BigInteger _132_oldCapacity = java.math.BigInteger.ZERO;
    java.lang.Object _rhs2 = this.data;
    java.math.BigInteger _rhs3 = this.capacity;
    _131_oldData = _rhs2;
    _132_oldCapacity = _rhs3;
    java.util.function.Function<java.math.BigInteger, A> _init3 = ((java.util.function.Function<A, java.util.function.Function<java.math.BigInteger, A>>)(_133_defaultValue) -> ((java.util.function.Function<java.math.BigInteger, A>)(_134___v0_boxed0) -> {
      java.math.BigInteger _134___v0 = ((java.math.BigInteger)(java.lang.Object)(_134___v0_boxed0));
      return _133_defaultValue;
    })).apply(defaultValue);
    ...
    (this).CopyFrom(_131_oldData, _132_oldCapacity);
  }
  ...
  public void CopyFrom(java.lang.Object newData, java.math.BigInteger count)
  {
    for (java.math.BigInteger _guard_loop_0_boxed0 : dafny.Helpers.IntegerRange(java.math.BigInteger.ZERO, count)) {
      ...
      if (true) {
        java.math.BigInteger _135_index = (java.math.BigInteger)_guard_loop_0;
        if ((true) && (((_135_index).signum() != -1) && ((_135_index).compareTo(count) < 0))) {
          java.lang.Object _arr2 = this.data;
          _td_A.setArrayElement(_arr2, dafny.Helpers.toInt(((_135_index)).intValue()), _td_A.getArrayElement((newData), (dafny.Helpers.toInt((_135_index)))));
        }
      }
    }
  }
