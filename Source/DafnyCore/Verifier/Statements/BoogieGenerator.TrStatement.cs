  ...
  public void TrStmt(Statement stmt, BoogieStmtListBuilder builder,
    ...
    switch (stmt)
    {
      ...
      case AssignSuchThatStmt thatStmt:
      {
        ...
        ProcessLhss(havocLHSs, false, true, builder, locals, etran, thatStmt, out var lhsBuilder, out var bLhss, out _, out _, out _);
      ...
      {
        AddComment(builder, returnStmt, "assign-or-return statement (:-)");
        AssignOrReturnStmt s = returnStmt;
      ...
      {
        var s = blockStmt;
        AddComment(builder, blockStmt, "divided block before new;");
        ...
        AddComment(builder, blockStmt, "new;");
        ...
        AddComment(builder, blockStmt, "divided block after new;");
