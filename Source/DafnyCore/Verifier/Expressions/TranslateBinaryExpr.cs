      ...
      switch (binaryExpr.ResolvedOp) {
        ...
        case BinaryExpr.ResolvedOpcode.Add:
          if (0 <= bvWidth) {
            ...
            typ = binaryExpr.Type.IsFloatingPointType ? new FloatType(binaryExpr.Type.FloatPrecision.significandBits, binaryExpr.Type.FloatPrecision.exponentBits) : (isReal ? Boogie.Type.Real : Boogie.Type.Int);
        ...
        case BinaryExpr.ResolvedOpcode.Div:
          if (0 <= bvWidth) {
            ...
            typ = binaryExpr.Type.IsFloatingPointType ? new FloatType(binaryExpr.Type.FloatPrecision.significandBits, binaryExpr.Type.FloatPrecision.exponentBits) : Boogie.Type.Real;
