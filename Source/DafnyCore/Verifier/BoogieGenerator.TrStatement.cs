  ...
  public partial class BoogieGenerator {
    private void TrStmt(Statement stmt, BoogieStmtListBuilder builder, List<Variable> locals, ExpressionTranslator etran) {
      ...
      if (stmt is PredicateStmt predicateStmt) {
        ...
        TranslateVariableDeclaration(builder, locals, etran, varDeclPattern);
      ...
      VarDeclPattern varDeclPattern)
    {
      foreach (var dafnyLocal in varDeclPattern.LocalVars) {
        ...
        builder.Add(new Bpl.HavocCmd(dafnyLocal.Tok, new List<Bpl.IdentifierExpr> { variableReference }));
        var wh = GetWhereClause(dafnyLocal.Tok, variableReference, dafnyLocal.Type, etran, isAllocContext.Var(varDeclPattern.IsGhost, dafnyLocal));
        if (wh != null) {
      ...
      CheckWellformedWithResult(rhs, new WFOptions(null, false, false), boogieTupleReference, pat.Expr.Type, locals, builder, etran, "variable declaration RHS");
