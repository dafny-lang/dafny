...
public partial class BoogieGenerator {
  ...
  void AddWellformednessCheck(RedirectingTypeDecl decl) {
    ...
    if (decl.Witness != null) {
      ...
      CheckWellformedWithResult(decl.Witness, new WFOptions(null, true), locals, witnessCheckBuilder, etran, (returnBuilder, result) => {
        ...
        if (decl is SubsetTypeDecl) {
          ...
          CheckResultToBeInType(decl.Witness.tok, result, decl.Var.Type, locals, returnBuilder, etran);
        }
