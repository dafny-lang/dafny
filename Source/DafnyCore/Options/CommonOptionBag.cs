...
true - A newtype case be based on any non-reference, non-ORDINAL type.".TrimStart()) {
    IsHidden = true
  };
...
1 - A newtype case be based on any non-reference, non-ORDINAL type.".TrimStart(), false);
