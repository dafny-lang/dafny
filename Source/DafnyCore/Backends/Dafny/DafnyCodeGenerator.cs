  ...
  class DafnyCodeGenerator : SinglePassCodeGenerator {
    ...
    protected override IClassWriter DeclareNewtype(NewtypeDecl nt, ConcreteSyntaxTree wr) {
      if (currentBuilder is NewtypeContainer builder) {
        ...
        return new ClassWriter(this, false, builder.Newtype(nt.GetCompileName(Options), new(), GenType(erasedType), (DAST.NewtypeRange)NewtypeRange.create_NoRange(), witnessStmts, witness));
      } else {
        throw new InvalidOperationException();
      }
    }
