...
namespace RAST {
  ...
  public abstract class Expr : _IExpr {
    ...
    {
      if (!((RAST.Expr.create_RawExpr(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";"))).NoExtraSemicolonAfter())) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(475,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!((RAST.Expr.create_RawExpr(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("a"))).NoExtraSemicolonAfter()))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(476,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((RAST.Expr.create_Return(Std.Wrappers.Option<RAST._IExpr>.create_None())).NoExtraSemicolonAfter())) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(477,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((RAST.Expr.create_Continue(Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None())).NoExtraSemicolonAfter())) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(478,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((RAST.Expr.create_Break(Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None())).NoExtraSemicolonAfter())) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(479,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((RAST.Expr.create_AssignVar(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("x"), RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("y")))).NoExtraSemicolonAfter())) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(480,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!((RAST.Expr.create_DeclareVar(RAST.DeclareType.create_MUT(), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("x"), Std.Wrappers.Option<RAST._IType>.create_None(), Std.Wrappers.Option<RAST._IExpr>.create_None())).NoExtraSemicolonAfter())) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(481,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(!((RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("x"))).NoExtraSemicolonAfter()))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(482,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void TestPrintingInfo()
    {
      RAST._IExpr _898_x;
      _898_x = RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("x"));
      RAST._IExpr _899_y;
      _899_y = RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("y"));
      DAST.Format._IBinaryOpFormat _900_bnf;
      _900_bnf = DAST.Format.BinaryOpFormat.create_NoFormat();
      if (!(((RAST.Expr.create_RawExpr(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("x"))).printingInfo).is_UnknownPrecedence)) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(529,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((_898_x).printingInfo, RAST.PrintingInfo.create_Precedence(BigInteger.One)))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(530,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_LiteralInt(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("3"))).printingInfo, RAST.PrintingInfo.create_Precedence(BigInteger.One)))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(531,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_LiteralString(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("abc"), true)).printingInfo, RAST.PrintingInfo.create_Precedence(BigInteger.One)))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(532,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("?"), _898_x, DAST.Format.UnaryOpFormat.create_NoFormat())).printingInfo, RAST.PrintingInfo.create_SuffixPrecedence(new BigInteger(5))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(533,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-"), _898_x, DAST.Format.UnaryOpFormat.create_NoFormat())).printingInfo, RAST.PrintingInfo.create_Precedence(new BigInteger(6))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(534,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("*"), _898_x, DAST.Format.UnaryOpFormat.create_NoFormat())).printingInfo, RAST.PrintingInfo.create_Precedence(new BigInteger(6))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(535,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!"), _898_x, DAST.Format.UnaryOpFormat.create_NoFormat())).printingInfo, RAST.PrintingInfo.create_Precedence(new BigInteger(6))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(536,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"), _898_x, DAST.Format.UnaryOpFormat.create_NoFormat())).printingInfo, RAST.PrintingInfo.create_Precedence(new BigInteger(6))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(537,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&mut"), _898_x, DAST.Format.UnaryOpFormat.create_NoFormat())).printingInfo, RAST.PrintingInfo.create_Precedence(new BigInteger(6))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(538,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!!"), _898_x, DAST.Format.UnaryOpFormat.create_NoFormat())).printingInfo, RAST.PrintingInfo.create_UnknownPrecedence()))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(539,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_Select(_898_x, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("name"))).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(2), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(540,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_MemberSelect(_898_x, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("name"))).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(2), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(541,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_Call(_898_x, Dafny.Sequence<RAST._IType>.FromElements(), Dafny.Sequence<RAST._IExpr>.FromElements())).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(2), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(542,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_TypeAscription(_898_x, RAST.Type.create_I128())).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(10), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(543,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("*"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(20), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(544,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(20), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(545,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("%"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(20), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(546,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("+"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(30), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(547,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(30), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(548,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<<"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(40), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(549,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(">>"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(40), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(550,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(50), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(551,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("^"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(60), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(552,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("|"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(70), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(553,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("=="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(80), RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(554,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(80), RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(555,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(80), RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(556,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(">"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(80), RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(557,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(80), RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(558,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(">="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(80), RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(559,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&&"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(90), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(560,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("||"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(100), RAST.Associativity.create_LeftToRight())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(561,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".."), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(562,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("..="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(563,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(564,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("+="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(565,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(566,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("*="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(567,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(568,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("%="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(569,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(570,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("|="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(571,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("^="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(572,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<<="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(573,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(">>="), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(110), RAST.Associativity.create_RightToLeft())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(574,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("?!?"), _898_x, _899_y, _900_bnf)).printingInfo, RAST.PrintingInfo.create_PrecedenceAssociativity(BigInteger.Zero, RAST.Associativity.create_RequiresParentheses())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(575,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_Break(Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None())).printingInfo, RAST.PrintingInfo.create_UnknownPrecedence()))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(576,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public RAST._IExpr Optimize() {
      RAST._IExpr _source27 = this;
      if (_source27.is_RawExpr) {
        Dafny.ISequence<Dafny.Rune> _901___mcc_h0 = _source27.dtor_content;
        return this;
      } else if (_source27.is_Identifier) {
        Dafny.ISequence<Dafny.Rune> _902___mcc_h2 = _source27.dtor_name;
        return this;
      } else if (_source27.is_Match) {
        RAST._IExpr _903___mcc_h4 = _source27.dtor_matchee;
        Dafny.ISequence<RAST._IMatchCase> _904___mcc_h5 = _source27.dtor_cases;
        return this;
      } else if (_source27.is_StmtExpr) {
        RAST._IExpr _905___mcc_h8 = _source27.dtor_stmt;
        RAST._IExpr _906___mcc_h9 = _source27.dtor_rhs;
        RAST._IExpr _source28 = _905___mcc_h8;
        if (_source28.is_RawExpr) {
          Dafny.ISequence<Dafny.Rune> _907___mcc_h12 = _source28.dtor_content;
          return this;
        } else if (_source28.is_Identifier) {
          Dafny.ISequence<Dafny.Rune> _908___mcc_h14 = _source28.dtor_name;
          return this;
        } else if (_source28.is_Match) {
          RAST._IExpr _909___mcc_h16 = _source28.dtor_matchee;
          Dafny.ISequence<RAST._IMatchCase> _910___mcc_h17 = _source28.dtor_cases;
          return this;
        } else if (_source28.is_StmtExpr) {
          RAST._IExpr _911___mcc_h20 = _source28.dtor_stmt;
          RAST._IExpr _912___mcc_h21 = _source28.dtor_rhs;
          return this;
        } else if (_source28.is_Block) {
          RAST._IExpr _913___mcc_h24 = _source28.dtor_underlying;
          return this;
        } else if (_source28.is_StructBuild) {
          Dafny.ISequence<Dafny.Rune> _914___mcc_h26 = _source28.dtor_name;
          Dafny.ISequence<RAST._IAssignIdentifier> _915___mcc_h27 = _source28.dtor_assignments;
          return this;
        } else if (_source28.is_Tuple) {
          Dafny.ISequence<RAST._IExpr> _916___mcc_h30 = _source28.dtor_arguments;
          return this;
        } else if (_source28.is_UnaryOp) {
          Dafny.ISequence<Dafny.Rune> _917___mcc_h32 = _source28.dtor_op1;
          RAST._IExpr _918___mcc_h33 = _source28.dtor_underlying;
          DAST.Format._IUnaryOpFormat _919___mcc_h34 = _source28.dtor_format;
          return this;
        } else if (_source28.is_BinaryOp) {
          Dafny.ISequence<Dafny.Rune> _920___mcc_h38 = _source28.dtor_op2;
          RAST._IExpr _921___mcc_h39 = _source28.dtor_left;
          RAST._IExpr _922___mcc_h40 = _source28.dtor_right;
          DAST.Format._IBinaryOpFormat _923___mcc_h41 = _source28.dtor_format2;
          return this;
        } else if (_source28.is_TypeAscription) {
          RAST._IExpr _924___mcc_h46 = _source28.dtor_left;
          RAST._IType _925___mcc_h47 = _source28.dtor_tpe;
          return this;
        } else if (_source28.is_LiteralInt) {
          Dafny.ISequence<Dafny.Rune> _926___mcc_h50 = _source28.dtor_value;
          return this;
        } else if (_source28.is_LiteralString) {
          Dafny.ISequence<Dafny.Rune> _927___mcc_h52 = _source28.dtor_value;
          bool _928___mcc_h53 = _source28.dtor_binary;
          return this;
        } else if (_source28.is_ConversionNum) {
          RAST._IType _929___mcc_h56 = _source28.dtor_tpe;
          RAST._IExpr _930___mcc_h57 = _source28.dtor_underlying;
          return this;
        } else if (_source28.is_DeclareVar) {
          RAST._IDeclareType _931___mcc_h60 = _source28.dtor_declareType;
          Dafny.ISequence<Dafny.Rune> _932___mcc_h61 = _source28.dtor_name;
          Std.Wrappers._IOption<RAST._IType> _933___mcc_h62 = _source28.dtor_optType;
          Std.Wrappers._IOption<RAST._IExpr> _934___mcc_h63 = _source28.dtor_optRhs;
          Std.Wrappers._IOption<RAST._IType> _source29 = _933___mcc_h62;
          if (_source29.is_None) {
            return this;
          } else {
            RAST._IType _935___mcc_h68 = _source29.dtor_value;
            Std.Wrappers._IOption<RAST._IExpr> _source30 = _934___mcc_h63;
            if (_source30.is_None) {
              RAST._IExpr _source31 = _906___mcc_h9;
              if (_source31.is_RawExpr) {
                Dafny.ISequence<Dafny.Rune> _936___mcc_h70 = _source31.dtor_content;
                return this;
              } else if (_source31.is_Identifier) {
                Dafny.ISequence<Dafny.Rune> _937___mcc_h72 = _source31.dtor_name;
                return this;
              } else if (_source31.is_Match) {
                RAST._IExpr _938___mcc_h74 = _source31.dtor_matchee;
                Dafny.ISequence<RAST._IMatchCase> _939___mcc_h75 = _source31.dtor_cases;
                return this;
              } else if (_source31.is_StmtExpr) {
                RAST._IExpr _940___mcc_h78 = _source31.dtor_stmt;
                RAST._IExpr _941___mcc_h79 = _source31.dtor_rhs;
                RAST._IExpr _source32 = _940___mcc_h78;
                if (_source32.is_RawExpr) {
                  Dafny.ISequence<Dafny.Rune> _942___mcc_h82 = _source32.dtor_content;
                  return this;
                } else if (_source32.is_Identifier) {
                  Dafny.ISequence<Dafny.Rune> _943___mcc_h84 = _source32.dtor_name;
                  return this;
                } else if (_source32.is_Match) {
                  RAST._IExpr _944___mcc_h86 = _source32.dtor_matchee;
                  Dafny.ISequence<RAST._IMatchCase> _945___mcc_h87 = _source32.dtor_cases;
                  return this;
                } else if (_source32.is_StmtExpr) {
                  RAST._IExpr _946___mcc_h90 = _source32.dtor_stmt;
                  RAST._IExpr _947___mcc_h91 = _source32.dtor_rhs;
                  return this;
                } else if (_source32.is_Block) {
                  RAST._IExpr _948___mcc_h94 = _source32.dtor_underlying;
                  return this;
                } else if (_source32.is_StructBuild) {
                  Dafny.ISequence<Dafny.Rune> _949___mcc_h96 = _source32.dtor_name;
                  Dafny.ISequence<RAST._IAssignIdentifier> _950___mcc_h97 = _source32.dtor_assignments;
                  return this;
                } else if (_source32.is_Tuple) {
                  Dafny.ISequence<RAST._IExpr> _951___mcc_h100 = _source32.dtor_arguments;
                  return this;
                } else if (_source32.is_UnaryOp) {
                  Dafny.ISequence<Dafny.Rune> _952___mcc_h102 = _source32.dtor_op1;
                  RAST._IExpr _953___mcc_h103 = _source32.dtor_underlying;
                  DAST.Format._IUnaryOpFormat _954___mcc_h104 = _source32.dtor_format;
                  return this;
                } else if (_source32.is_BinaryOp) {
                  Dafny.ISequence<Dafny.Rune> _955___mcc_h108 = _source32.dtor_op2;
                  RAST._IExpr _956___mcc_h109 = _source32.dtor_left;
                  RAST._IExpr _957___mcc_h110 = _source32.dtor_right;
                  DAST.Format._IBinaryOpFormat _958___mcc_h111 = _source32.dtor_format2;
                  return this;
                } else if (_source32.is_TypeAscription) {
                  RAST._IExpr _959___mcc_h116 = _source32.dtor_left;
                  RAST._IType _960___mcc_h117 = _source32.dtor_tpe;
                  return this;
                } else if (_source32.is_LiteralInt) {
                  Dafny.ISequence<Dafny.Rune> _961___mcc_h120 = _source32.dtor_value;
                  return this;
                } else if (_source32.is_LiteralString) {
                  Dafny.ISequence<Dafny.Rune> _962___mcc_h122 = _source32.dtor_value;
                  bool _963___mcc_h123 = _source32.dtor_binary;
                  return this;
                } else if (_source32.is_ConversionNum) {
                  RAST._IType _964___mcc_h126 = _source32.dtor_tpe;
                  RAST._IExpr _965___mcc_h127 = _source32.dtor_underlying;
                  return this;
                } else if (_source32.is_DeclareVar) {
                  RAST._IDeclareType _966___mcc_h130 = _source32.dtor_declareType;
                  Dafny.ISequence<Dafny.Rune> _967___mcc_h131 = _source32.dtor_name;
                  Std.Wrappers._IOption<RAST._IType> _968___mcc_h132 = _source32.dtor_optType;
                  Std.Wrappers._IOption<RAST._IExpr> _969___mcc_h133 = _source32.dtor_optRhs;
                  return this;
                } else if (_source32.is_AssignVar) {
                  Dafny.ISequence<Dafny.Rune> _970___mcc_h138 = _source32.dtor_name;
                  RAST._IExpr _971___mcc_h139 = _source32.dtor_rhs;
                  RAST._IExpr _972_last = _941___mcc_h79;
                  RAST._IExpr _973_rhs = _971___mcc_h139;
                  Dafny.ISequence<Dafny.Rune> _974_name2 = _970___mcc_h138;
                  RAST._IType _975_tpe = _935___mcc_h68;
                  Dafny.ISequence<Dafny.Rune> _976_name = _932___mcc_h61;
                  RAST._IDeclareType _977_mod = _931___mcc_h60;
                  if ((_976_name).Equals(_974_name2)) {
                    RAST._IExpr _978_rewriting = RAST.Expr.create_StmtExpr(RAST.Expr.create_DeclareVar(_977_mod, _976_name, Std.Wrappers.Option<RAST._IType>.create_Some(_975_tpe), Std.Wrappers.Option<RAST._IExpr>.create_Some(_973_rhs)), _972_last);
                    return _978_rewriting;
                  } else {
                    return this;
                  }
                } else if (_source32.is_IfExpr) {
                  RAST._IExpr _979___mcc_h142 = _source32.dtor_cond;
                  RAST._IExpr _980___mcc_h143 = _source32.dtor_thn;
                  RAST._IExpr _981___mcc_h144 = _source32.dtor_els;
                  return this;
                } else if (_source32.is_Loop) {
                  Std.Wrappers._IOption<RAST._IExpr> _982___mcc_h148 = _source32.dtor_optCond;
                  RAST._IExpr _983___mcc_h149 = _source32.dtor_underlying;
                  return this;
                } else if (_source32.is_For) {
                  Dafny.ISequence<Dafny.Rune> _984___mcc_h152 = _source32.dtor_name;
                  RAST._IExpr _985___mcc_h153 = _source32.dtor_range;
                  RAST._IExpr _986___mcc_h154 = _source32.dtor_body;
                  return this;
                } else if (_source32.is_Labelled) {
                  Dafny.ISequence<Dafny.Rune> _987___mcc_h158 = _source32.dtor_lbl;
                  RAST._IExpr _988___mcc_h159 = _source32.dtor_underlying;
                  return this;
                } else if (_source32.is_Break) {
                  Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _989___mcc_h162 = _source32.dtor_optLbl;
                  return this;
                } else if (_source32.is_Continue) {
                  Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _990___mcc_h164 = _source32.dtor_optLbl;
                  return this;
                } else if (_source32.is_Return) {
                  Std.Wrappers._IOption<RAST._IExpr> _991___mcc_h166 = _source32.dtor_optExpr;
                  return this;
                } else if (_source32.is_Call) {
                  RAST._IExpr _992___mcc_h168 = _source32.dtor_obj;
                  Dafny.ISequence<RAST._IType> _993___mcc_h169 = _source32.dtor_typeParameters;
                  Dafny.ISequence<RAST._IExpr> _994___mcc_h170 = _source32.dtor_arguments;
                  return this;
                } else if (_source32.is_Select) {
                  RAST._IExpr _995___mcc_h174 = _source32.dtor_obj;
                  Dafny.ISequence<Dafny.Rune> _996___mcc_h175 = _source32.dtor_name;
                  return this;
                } else {
                  RAST._IExpr _997___mcc_h178 = _source32.dtor_obj;
                  Dafny.ISequence<Dafny.Rune> _998___mcc_h179 = _source32.dtor_name;
                  return this;
                }
              } else if (_source31.is_Block) {
                RAST._IExpr _999___mcc_h182 = _source31.dtor_underlying;
                return this;
              } else if (_source31.is_StructBuild) {
                Dafny.ISequence<Dafny.Rune> _1000___mcc_h184 = _source31.dtor_name;
                Dafny.ISequence<RAST._IAssignIdentifier> _1001___mcc_h185 = _source31.dtor_assignments;
                return this;
              } else if (_source31.is_Tuple) {
                Dafny.ISequence<RAST._IExpr> _1002___mcc_h188 = _source31.dtor_arguments;
                return this;
              } else if (_source31.is_UnaryOp) {
                Dafny.ISequence<Dafny.Rune> _1003___mcc_h190 = _source31.dtor_op1;
                RAST._IExpr _1004___mcc_h191 = _source31.dtor_underlying;
                DAST.Format._IUnaryOpFormat _1005___mcc_h192 = _source31.dtor_format;
                return this;
              } else if (_source31.is_BinaryOp) {
                Dafny.ISequence<Dafny.Rune> _1006___mcc_h196 = _source31.dtor_op2;
                RAST._IExpr _1007___mcc_h197 = _source31.dtor_left;
                RAST._IExpr _1008___mcc_h198 = _source31.dtor_right;
                DAST.Format._IBinaryOpFormat _1009___mcc_h199 = _source31.dtor_format2;
                return this;
              } else if (_source31.is_TypeAscription) {
                RAST._IExpr _1010___mcc_h204 = _source31.dtor_left;
                RAST._IType _1011___mcc_h205 = _source31.dtor_tpe;
                return this;
              } else if (_source31.is_LiteralInt) {
                Dafny.ISequence<Dafny.Rune> _1012___mcc_h208 = _source31.dtor_value;
                return this;
              } else if (_source31.is_LiteralString) {
                Dafny.ISequence<Dafny.Rune> _1013___mcc_h210 = _source31.dtor_value;
                bool _1014___mcc_h211 = _source31.dtor_binary;
                return this;
              } else if (_source31.is_ConversionNum) {
                RAST._IType _1015___mcc_h214 = _source31.dtor_tpe;
                RAST._IExpr _1016___mcc_h215 = _source31.dtor_underlying;
                return this;
              } else if (_source31.is_DeclareVar) {
                RAST._IDeclareType _1017___mcc_h218 = _source31.dtor_declareType;
                Dafny.ISequence<Dafny.Rune> _1018___mcc_h219 = _source31.dtor_name;
                Std.Wrappers._IOption<RAST._IType> _1019___mcc_h220 = _source31.dtor_optType;
                Std.Wrappers._IOption<RAST._IExpr> _1020___mcc_h221 = _source31.dtor_optRhs;
                return this;
              } else if (_source31.is_AssignVar) {
                Dafny.ISequence<Dafny.Rune> _1021___mcc_h226 = _source31.dtor_name;
                RAST._IExpr _1022___mcc_h227 = _source31.dtor_rhs;
                return this;
              } else if (_source31.is_IfExpr) {
                RAST._IExpr _1023___mcc_h230 = _source31.dtor_cond;
                RAST._IExpr _1024___mcc_h231 = _source31.dtor_thn;
                RAST._IExpr _1025___mcc_h232 = _source31.dtor_els;
                return this;
              } else if (_source31.is_Loop) {
                Std.Wrappers._IOption<RAST._IExpr> _1026___mcc_h236 = _source31.dtor_optCond;
                RAST._IExpr _1027___mcc_h237 = _source31.dtor_underlying;
                return this;
              } else if (_source31.is_For) {
                Dafny.ISequence<Dafny.Rune> _1028___mcc_h240 = _source31.dtor_name;
                RAST._IExpr _1029___mcc_h241 = _source31.dtor_range;
                RAST._IExpr _1030___mcc_h242 = _source31.dtor_body;
                return this;
              } else if (_source31.is_Labelled) {
                Dafny.ISequence<Dafny.Rune> _1031___mcc_h246 = _source31.dtor_lbl;
                RAST._IExpr _1032___mcc_h247 = _source31.dtor_underlying;
                return this;
              } else if (_source31.is_Break) {
                Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1033___mcc_h250 = _source31.dtor_optLbl;
                return this;
              } else if (_source31.is_Continue) {
                Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1034___mcc_h252 = _source31.dtor_optLbl;
                return this;
              } else if (_source31.is_Return) {
                Std.Wrappers._IOption<RAST._IExpr> _1035___mcc_h254 = _source31.dtor_optExpr;
                return this;
              } else if (_source31.is_Call) {
                RAST._IExpr _1036___mcc_h256 = _source31.dtor_obj;
                Dafny.ISequence<RAST._IType> _1037___mcc_h257 = _source31.dtor_typeParameters;
                Dafny.ISequence<RAST._IExpr> _1038___mcc_h258 = _source31.dtor_arguments;
                return this;
              } else if (_source31.is_Select) {
                RAST._IExpr _1039___mcc_h262 = _source31.dtor_obj;
                Dafny.ISequence<Dafny.Rune> _1040___mcc_h263 = _source31.dtor_name;
                return this;
              } else {
                RAST._IExpr _1041___mcc_h266 = _source31.dtor_obj;
                Dafny.ISequence<Dafny.Rune> _1042___mcc_h267 = _source31.dtor_name;
                return this;
              }
            } else {
              RAST._IExpr _1043___mcc_h270 = _source30.dtor_value;
              return this;
            }
          }
        } else if (_source28.is_AssignVar) {
          Dafny.ISequence<Dafny.Rune> _1044___mcc_h272 = _source28.dtor_name;
          RAST._IExpr _1045___mcc_h273 = _source28.dtor_rhs;
          return this;
        } else if (_source28.is_IfExpr) {
          RAST._IExpr _1046___mcc_h276 = _source28.dtor_cond;
          RAST._IExpr _1047___mcc_h277 = _source28.dtor_thn;
          RAST._IExpr _1048___mcc_h278 = _source28.dtor_els;
          return this;
        } else if (_source28.is_Loop) {
          Std.Wrappers._IOption<RAST._IExpr> _1049___mcc_h282 = _source28.dtor_optCond;
          RAST._IExpr _1050___mcc_h283 = _source28.dtor_underlying;
          return this;
        } else if (_source28.is_For) {
          Dafny.ISequence<Dafny.Rune> _1051___mcc_h286 = _source28.dtor_name;
          RAST._IExpr _1052___mcc_h287 = _source28.dtor_range;
          RAST._IExpr _1053___mcc_h288 = _source28.dtor_body;
          return this;
        } else if (_source28.is_Labelled) {
          Dafny.ISequence<Dafny.Rune> _1054___mcc_h292 = _source28.dtor_lbl;
          RAST._IExpr _1055___mcc_h293 = _source28.dtor_underlying;
          return this;
        } else if (_source28.is_Break) {
          Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1056___mcc_h296 = _source28.dtor_optLbl;
          return this;
        } else if (_source28.is_Continue) {
          Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1057___mcc_h298 = _source28.dtor_optLbl;
          return this;
        } else if (_source28.is_Return) {
          Std.Wrappers._IOption<RAST._IExpr> _1058___mcc_h300 = _source28.dtor_optExpr;
          return this;
        } else if (_source28.is_Call) {
          RAST._IExpr _1059___mcc_h302 = _source28.dtor_obj;
          Dafny.ISequence<RAST._IType> _1060___mcc_h303 = _source28.dtor_typeParameters;
          Dafny.ISequence<RAST._IExpr> _1061___mcc_h304 = _source28.dtor_arguments;
          return this;
        } else if (_source28.is_Select) {
          RAST._IExpr _1062___mcc_h308 = _source28.dtor_obj;
          Dafny.ISequence<Dafny.Rune> _1063___mcc_h309 = _source28.dtor_name;
          return this;
        } else {
          RAST._IExpr _1064___mcc_h312 = _source28.dtor_obj;
          Dafny.ISequence<Dafny.Rune> _1065___mcc_h313 = _source28.dtor_name;
          return this;
        }
      } else if (_source27.is_Block) {
        RAST._IExpr _1066___mcc_h316 = _source27.dtor_underlying;
        return this;
      } else if (_source27.is_StructBuild) {
        Dafny.ISequence<Dafny.Rune> _1067___mcc_h318 = _source27.dtor_name;
        Dafny.ISequence<RAST._IAssignIdentifier> _1068___mcc_h319 = _source27.dtor_assignments;
        return this;
      } else if (_source27.is_Tuple) {
        Dafny.ISequence<RAST._IExpr> _1069___mcc_h322 = _source27.dtor_arguments;
        return this;
      } else if (_source27.is_UnaryOp) {
        Dafny.ISequence<Dafny.Rune> _1070___mcc_h324 = _source27.dtor_op1;
        RAST._IExpr _1071___mcc_h325 = _source27.dtor_underlying;
        DAST.Format._IUnaryOpFormat _1072___mcc_h326 = _source27.dtor_format;
        if (object.Equals(_1070___mcc_h324, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"))) {
          RAST._IExpr _source33 = _1071___mcc_h325;
          if (_source33.is_RawExpr) {
            Dafny.ISequence<Dafny.Rune> _1073___mcc_h330 = _source33.dtor_content;
            return this;
          } else if (_source33.is_Identifier) {
            Dafny.ISequence<Dafny.Rune> _1074___mcc_h332 = _source33.dtor_name;
            return this;
          } else if (_source33.is_Match) {
            RAST._IExpr _1075___mcc_h334 = _source33.dtor_matchee;
            Dafny.ISequence<RAST._IMatchCase> _1076___mcc_h335 = _source33.dtor_cases;
            return this;
          } else if (_source33.is_StmtExpr) {
            RAST._IExpr _1077___mcc_h338 = _source33.dtor_stmt;
            RAST._IExpr _1078___mcc_h339 = _source33.dtor_rhs;
            return this;
          } else if (_source33.is_Block) {
            RAST._IExpr _1079___mcc_h342 = _source33.dtor_underlying;
            return this;
          } else if (_source33.is_StructBuild) {
            Dafny.ISequence<Dafny.Rune> _1080___mcc_h344 = _source33.dtor_name;
            Dafny.ISequence<RAST._IAssignIdentifier> _1081___mcc_h345 = _source33.dtor_assignments;
            return this;
          } else if (_source33.is_Tuple) {
            Dafny.ISequence<RAST._IExpr> _1082___mcc_h348 = _source33.dtor_arguments;
            return this;
          } else if (_source33.is_UnaryOp) {
            Dafny.ISequence<Dafny.Rune> _1083___mcc_h350 = _source33.dtor_op1;
            RAST._IExpr _1084___mcc_h351 = _source33.dtor_underlying;
            DAST.Format._IUnaryOpFormat _1085___mcc_h352 = _source33.dtor_format;
            return this;
          } else if (_source33.is_BinaryOp) {
            Dafny.ISequence<Dafny.Rune> _1086___mcc_h356 = _source33.dtor_op2;
            RAST._IExpr _1087___mcc_h357 = _source33.dtor_left;
            RAST._IExpr _1088___mcc_h358 = _source33.dtor_right;
            DAST.Format._IBinaryOpFormat _1089___mcc_h359 = _source33.dtor_format2;
            return this;
          } else if (_source33.is_TypeAscription) {
            RAST._IExpr _1090___mcc_h364 = _source33.dtor_left;
            RAST._IType _1091___mcc_h365 = _source33.dtor_tpe;
            return this;
          } else if (_source33.is_LiteralInt) {
            Dafny.ISequence<Dafny.Rune> _1092___mcc_h368 = _source33.dtor_value;
            return this;
          } else if (_source33.is_LiteralString) {
            Dafny.ISequence<Dafny.Rune> _1093___mcc_h370 = _source33.dtor_value;
            bool _1094___mcc_h371 = _source33.dtor_binary;
            return this;
          } else if (_source33.is_ConversionNum) {
            RAST._IType _1095___mcc_h374 = _source33.dtor_tpe;
            RAST._IExpr _1096___mcc_h375 = _source33.dtor_underlying;
            return this;
          } else if (_source33.is_DeclareVar) {
            RAST._IDeclareType _1097___mcc_h378 = _source33.dtor_declareType;
            Dafny.ISequence<Dafny.Rune> _1098___mcc_h379 = _source33.dtor_name;
            Std.Wrappers._IOption<RAST._IType> _1099___mcc_h380 = _source33.dtor_optType;
            Std.Wrappers._IOption<RAST._IExpr> _1100___mcc_h381 = _source33.dtor_optRhs;
            return this;
          } else if (_source33.is_AssignVar) {
            Dafny.ISequence<Dafny.Rune> _1101___mcc_h386 = _source33.dtor_name;
            RAST._IExpr _1102___mcc_h387 = _source33.dtor_rhs;
            return this;
          } else if (_source33.is_IfExpr) {
            RAST._IExpr _1103___mcc_h390 = _source33.dtor_cond;
            RAST._IExpr _1104___mcc_h391 = _source33.dtor_thn;
            RAST._IExpr _1105___mcc_h392 = _source33.dtor_els;
            return this;
          } else if (_source33.is_Loop) {
            Std.Wrappers._IOption<RAST._IExpr> _1106___mcc_h396 = _source33.dtor_optCond;
            RAST._IExpr _1107___mcc_h397 = _source33.dtor_underlying;
            return this;
          } else if (_source33.is_For) {
            Dafny.ISequence<Dafny.Rune> _1108___mcc_h400 = _source33.dtor_name;
            RAST._IExpr _1109___mcc_h401 = _source33.dtor_range;
            RAST._IExpr _1110___mcc_h402 = _source33.dtor_body;
            return this;
          } else if (_source33.is_Labelled) {
            Dafny.ISequence<Dafny.Rune> _1111___mcc_h406 = _source33.dtor_lbl;
            RAST._IExpr _1112___mcc_h407 = _source33.dtor_underlying;
            return this;
          } else if (_source33.is_Break) {
            Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1113___mcc_h410 = _source33.dtor_optLbl;
            return this;
          } else if (_source33.is_Continue) {
            Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1114___mcc_h412 = _source33.dtor_optLbl;
            return this;
          } else if (_source33.is_Return) {
            Std.Wrappers._IOption<RAST._IExpr> _1115___mcc_h414 = _source33.dtor_optExpr;
            return this;
          } else if (_source33.is_Call) {
            RAST._IExpr _1116___mcc_h416 = _source33.dtor_obj;
            Dafny.ISequence<RAST._IType> _1117___mcc_h417 = _source33.dtor_typeParameters;
            Dafny.ISequence<RAST._IExpr> _1118___mcc_h418 = _source33.dtor_arguments;
            RAST._IExpr _source34 = _1116___mcc_h416;
            if (_source34.is_RawExpr) {
              Dafny.ISequence<Dafny.Rune> _1119___mcc_h422 = _source34.dtor_content;
              return this;
            } else if (_source34.is_Identifier) {
              Dafny.ISequence<Dafny.Rune> _1120___mcc_h424 = _source34.dtor_name;
              return this;
            } else if (_source34.is_Match) {
              RAST._IExpr _1121___mcc_h426 = _source34.dtor_matchee;
              Dafny.ISequence<RAST._IMatchCase> _1122___mcc_h427 = _source34.dtor_cases;
              return this;
            } else if (_source34.is_StmtExpr) {
              RAST._IExpr _1123___mcc_h430 = _source34.dtor_stmt;
              RAST._IExpr _1124___mcc_h431 = _source34.dtor_rhs;
              return this;
            } else if (_source34.is_Block) {
              RAST._IExpr _1125___mcc_h434 = _source34.dtor_underlying;
              return this;
            } else if (_source34.is_StructBuild) {
              Dafny.ISequence<Dafny.Rune> _1126___mcc_h436 = _source34.dtor_name;
              Dafny.ISequence<RAST._IAssignIdentifier> _1127___mcc_h437 = _source34.dtor_assignments;
              return this;
            } else if (_source34.is_Tuple) {
              Dafny.ISequence<RAST._IExpr> _1128___mcc_h440 = _source34.dtor_arguments;
              return this;
            } else if (_source34.is_UnaryOp) {
              Dafny.ISequence<Dafny.Rune> _1129___mcc_h442 = _source34.dtor_op1;
              RAST._IExpr _1130___mcc_h443 = _source34.dtor_underlying;
              DAST.Format._IUnaryOpFormat _1131___mcc_h444 = _source34.dtor_format;
              return this;
            } else if (_source34.is_BinaryOp) {
              Dafny.ISequence<Dafny.Rune> _1132___mcc_h448 = _source34.dtor_op2;
              RAST._IExpr _1133___mcc_h449 = _source34.dtor_left;
              RAST._IExpr _1134___mcc_h450 = _source34.dtor_right;
              DAST.Format._IBinaryOpFormat _1135___mcc_h451 = _source34.dtor_format2;
              return this;
            } else if (_source34.is_TypeAscription) {
              RAST._IExpr _1136___mcc_h456 = _source34.dtor_left;
              RAST._IType _1137___mcc_h457 = _source34.dtor_tpe;
              return this;
            } else if (_source34.is_LiteralInt) {
              Dafny.ISequence<Dafny.Rune> _1138___mcc_h460 = _source34.dtor_value;
              return this;
            } else if (_source34.is_LiteralString) {
              Dafny.ISequence<Dafny.Rune> _1139___mcc_h462 = _source34.dtor_value;
              bool _1140___mcc_h463 = _source34.dtor_binary;
              return this;
            } else if (_source34.is_ConversionNum) {
              RAST._IType _1141___mcc_h466 = _source34.dtor_tpe;
              RAST._IExpr _1142___mcc_h467 = _source34.dtor_underlying;
              return this;
            } else if (_source34.is_DeclareVar) {
              RAST._IDeclareType _1143___mcc_h470 = _source34.dtor_declareType;
              Dafny.ISequence<Dafny.Rune> _1144___mcc_h471 = _source34.dtor_name;
              Std.Wrappers._IOption<RAST._IType> _1145___mcc_h472 = _source34.dtor_optType;
              Std.Wrappers._IOption<RAST._IExpr> _1146___mcc_h473 = _source34.dtor_optRhs;
              return this;
            } else if (_source34.is_AssignVar) {
              Dafny.ISequence<Dafny.Rune> _1147___mcc_h478 = _source34.dtor_name;
              RAST._IExpr _1148___mcc_h479 = _source34.dtor_rhs;
              return this;
            } else if (_source34.is_IfExpr) {
              RAST._IExpr _1149___mcc_h482 = _source34.dtor_cond;
              RAST._IExpr _1150___mcc_h483 = _source34.dtor_thn;
              RAST._IExpr _1151___mcc_h484 = _source34.dtor_els;
              return this;
            } else if (_source34.is_Loop) {
              Std.Wrappers._IOption<RAST._IExpr> _1152___mcc_h488 = _source34.dtor_optCond;
              RAST._IExpr _1153___mcc_h489 = _source34.dtor_underlying;
              return this;
            } else if (_source34.is_For) {
              Dafny.ISequence<Dafny.Rune> _1154___mcc_h492 = _source34.dtor_name;
              RAST._IExpr _1155___mcc_h493 = _source34.dtor_range;
              RAST._IExpr _1156___mcc_h494 = _source34.dtor_body;
              return this;
            } else if (_source34.is_Labelled) {
              Dafny.ISequence<Dafny.Rune> _1157___mcc_h498 = _source34.dtor_lbl;
              RAST._IExpr _1158___mcc_h499 = _source34.dtor_underlying;
              return this;
            } else if (_source34.is_Break) {
              Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1159___mcc_h502 = _source34.dtor_optLbl;
              return this;
            } else if (_source34.is_Continue) {
              Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1160___mcc_h504 = _source34.dtor_optLbl;
              return this;
            } else if (_source34.is_Return) {
              Std.Wrappers._IOption<RAST._IExpr> _1161___mcc_h506 = _source34.dtor_optExpr;
              return this;
            } else if (_source34.is_Call) {
              RAST._IExpr _1162___mcc_h508 = _source34.dtor_obj;
              Dafny.ISequence<RAST._IType> _1163___mcc_h509 = _source34.dtor_typeParameters;
              Dafny.ISequence<RAST._IExpr> _1164___mcc_h510 = _source34.dtor_arguments;
              return this;
            } else if (_source34.is_Select) {
              RAST._IExpr _1165___mcc_h514 = _source34.dtor_obj;
              Dafny.ISequence<Dafny.Rune> _1166___mcc_h515 = _source34.dtor_name;
              if (object.Equals(_1166___mcc_h515, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("clone"))) {
                DAST.Format._IUnaryOpFormat _1167_format = _1072___mcc_h326;
                Dafny.ISequence<RAST._IExpr> _1168_args = _1118___mcc_h418;
                Dafny.ISequence<RAST._IType> _1169_typeArgs = _1117___mcc_h417;
                RAST._IExpr _1170_underlying = _1165___mcc_h514;
                if (((_1169_typeArgs).Equals(Dafny.Sequence<RAST._IType>.FromElements())) && ((_1168_args).Equals(Dafny.Sequence<RAST._IExpr>.FromElements()))) {
                  return RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"), _1170_underlying, _1167_format);
                } else {
                  return this;
                }
              } else {
              ...
              RAST._IExpr _1171___mcc_h518 = _source34.dtor_obj;
              Dafny.ISequence<Dafny.Rune> _1172___mcc_h519 = _source34.dtor_name;
              return this;
            }
          } else if (_source33.is_Select) {
            RAST._IExpr _1173___mcc_h522 = _source33.dtor_obj;
            Dafny.ISequence<Dafny.Rune> _1174___mcc_h523 = _source33.dtor_name;
            return this;
          } else {
            RAST._IExpr _1175___mcc_h526 = _source33.dtor_obj;
            Dafny.ISequence<Dafny.Rune> _1176___mcc_h527 = _source33.dtor_name;
            return this;
          }
        } else if (object.Equals(_1070___mcc_h324, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!"))) {
          RAST._IExpr _source35 = _1071___mcc_h325;
          if (_source35.is_RawExpr) {
            Dafny.ISequence<Dafny.Rune> _1177___mcc_h530 = _source35.dtor_content;
            return this;
          } else if (_source35.is_Identifier) {
            Dafny.ISequence<Dafny.Rune> _1178___mcc_h532 = _source35.dtor_name;
            return this;
          } else if (_source35.is_Match) {
            RAST._IExpr _1179___mcc_h534 = _source35.dtor_matchee;
            Dafny.ISequence<RAST._IMatchCase> _1180___mcc_h535 = _source35.dtor_cases;
            return this;
          } else if (_source35.is_StmtExpr) {
            RAST._IExpr _1181___mcc_h538 = _source35.dtor_stmt;
            RAST._IExpr _1182___mcc_h539 = _source35.dtor_rhs;
            return this;
          } else if (_source35.is_Block) {
            RAST._IExpr _1183___mcc_h542 = _source35.dtor_underlying;
            return this;
          } else if (_source35.is_StructBuild) {
            Dafny.ISequence<Dafny.Rune> _1184___mcc_h544 = _source35.dtor_name;
            Dafny.ISequence<RAST._IAssignIdentifier> _1185___mcc_h545 = _source35.dtor_assignments;
            return this;
          } else if (_source35.is_Tuple) {
            Dafny.ISequence<RAST._IExpr> _1186___mcc_h548 = _source35.dtor_arguments;
            return this;
          } else if (_source35.is_UnaryOp) {
            Dafny.ISequence<Dafny.Rune> _1187___mcc_h550 = _source35.dtor_op1;
            RAST._IExpr _1188___mcc_h551 = _source35.dtor_underlying;
            DAST.Format._IUnaryOpFormat _1189___mcc_h552 = _source35.dtor_format;
            return this;
          } else if (_source35.is_BinaryOp) {
            Dafny.ISequence<Dafny.Rune> _1190___mcc_h556 = _source35.dtor_op2;
            RAST._IExpr _1191___mcc_h557 = _source35.dtor_left;
            RAST._IExpr _1192___mcc_h558 = _source35.dtor_right;
            DAST.Format._IBinaryOpFormat _1193___mcc_h559 = _source35.dtor_format2;
            if (object.Equals(_1190___mcc_h556, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("=="))) {
              DAST.Format._IUnaryOpFormat _source36 = _1072___mcc_h326;
              if (_source36.is_NoFormat) {
                return this;
              } else {
                DAST.Format._IBinaryOpFormat _1194_format = _1193___mcc_h559;
                RAST._IExpr _1195_right = _1192___mcc_h558;
                RAST._IExpr _1196_left = _1191___mcc_h557;
                return RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!="), _1196_left, _1195_right, DAST.Format.BinaryOpFormat.create_NoFormat());
              }
            } else if (object.Equals(_1190___mcc_h556, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<"))) {
              DAST.Format._IBinaryOpFormat _source37 = _1193___mcc_h559;
              if (_source37.is_NoFormat) {
                DAST.Format._IUnaryOpFormat _source38 = _1072___mcc_h326;
                if (_source38.is_NoFormat) {
                  return this;
                } else {
                  RAST._IExpr _1197_right = _1192___mcc_h558;
                  RAST._IExpr _1198_left = _1191___mcc_h557;
                  return RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(">="), _1198_left, _1197_right, DAST.Format.BinaryOpFormat.create_NoFormat());
                }
                ...
                DAST.Format._IUnaryOpFormat _source39 = _1072___mcc_h326;
                if (_source39.is_NoFormat) {
                  return this;
                } else {
                  RAST._IExpr _1199_right = _1192___mcc_h558;
                  RAST._IExpr _1200_left = _1191___mcc_h557;
                  return RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<="), _1199_right, _1200_left, DAST.Format.BinaryOpFormat.create_NoFormat());
                }
              }
            } else {
              return this;
            ...
            RAST._IExpr _1201___mcc_h564 = _source35.dtor_left;
            RAST._IType _1202___mcc_h565 = _source35.dtor_tpe;
            return this;
          } else if (_source35.is_LiteralInt) {
            Dafny.ISequence<Dafny.Rune> _1203___mcc_h568 = _source35.dtor_value;
            return this;
          } else if (_source35.is_LiteralString) {
            Dafny.ISequence<Dafny.Rune> _1204___mcc_h570 = _source35.dtor_value;
            bool _1205___mcc_h571 = _source35.dtor_binary;
            return this;
          } else if (_source35.is_ConversionNum) {
            RAST._IType _1206___mcc_h574 = _source35.dtor_tpe;
            RAST._IExpr _1207___mcc_h575 = _source35.dtor_underlying;
            return this;
          } else if (_source35.is_DeclareVar) {
            RAST._IDeclareType _1208___mcc_h578 = _source35.dtor_declareType;
            Dafny.ISequence<Dafny.Rune> _1209___mcc_h579 = _source35.dtor_name;
            Std.Wrappers._IOption<RAST._IType> _1210___mcc_h580 = _source35.dtor_optType;
            Std.Wrappers._IOption<RAST._IExpr> _1211___mcc_h581 = _source35.dtor_optRhs;
            return this;
          } else if (_source35.is_AssignVar) {
            Dafny.ISequence<Dafny.Rune> _1212___mcc_h586 = _source35.dtor_name;
            RAST._IExpr _1213___mcc_h587 = _source35.dtor_rhs;
            return this;
          } else if (_source35.is_IfExpr) {
            RAST._IExpr _1214___mcc_h590 = _source35.dtor_cond;
            RAST._IExpr _1215___mcc_h591 = _source35.dtor_thn;
            RAST._IExpr _1216___mcc_h592 = _source35.dtor_els;
            return this;
          } else if (_source35.is_Loop) {
            Std.Wrappers._IOption<RAST._IExpr> _1217___mcc_h596 = _source35.dtor_optCond;
            RAST._IExpr _1218___mcc_h597 = _source35.dtor_underlying;
            return this;
          } else if (_source35.is_For) {
            Dafny.ISequence<Dafny.Rune> _1219___mcc_h600 = _source35.dtor_name;
            RAST._IExpr _1220___mcc_h601 = _source35.dtor_range;
            RAST._IExpr _1221___mcc_h602 = _source35.dtor_body;
            return this;
          } else if (_source35.is_Labelled) {
            Dafny.ISequence<Dafny.Rune> _1222___mcc_h606 = _source35.dtor_lbl;
            RAST._IExpr _1223___mcc_h607 = _source35.dtor_underlying;
            return this;
          } else if (_source35.is_Break) {
            Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1224___mcc_h610 = _source35.dtor_optLbl;
            return this;
          } else if (_source35.is_Continue) {
            Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1225___mcc_h612 = _source35.dtor_optLbl;
            return this;
          } else if (_source35.is_Return) {
            Std.Wrappers._IOption<RAST._IExpr> _1226___mcc_h614 = _source35.dtor_optExpr;
            return this;
          } else if (_source35.is_Call) {
            RAST._IExpr _1227___mcc_h616 = _source35.dtor_obj;
            Dafny.ISequence<RAST._IType> _1228___mcc_h617 = _source35.dtor_typeParameters;
            Dafny.ISequence<RAST._IExpr> _1229___mcc_h618 = _source35.dtor_arguments;
            return this;
          } else if (_source35.is_Select) {
            RAST._IExpr _1230___mcc_h622 = _source35.dtor_obj;
            Dafny.ISequence<Dafny.Rune> _1231___mcc_h623 = _source35.dtor_name;
            return this;
          } else {
            RAST._IExpr _1232___mcc_h626 = _source35.dtor_obj;
            Dafny.ISequence<Dafny.Rune> _1233___mcc_h627 = _source35.dtor_name;
            return this;
          }
        } else {
          return this;
        ...
        Dafny.ISequence<Dafny.Rune> _1234___mcc_h630 = _source27.dtor_op2;
        RAST._IExpr _1235___mcc_h631 = _source27.dtor_left;
        RAST._IExpr _1236___mcc_h632 = _source27.dtor_right;
        DAST.Format._IBinaryOpFormat _1237___mcc_h633 = _source27.dtor_format2;
        return this;
      } else if (_source27.is_TypeAscription) {
        RAST._IExpr _1238___mcc_h638 = _source27.dtor_left;
        RAST._IType _1239___mcc_h639 = _source27.dtor_tpe;
        return this;
      } else if (_source27.is_LiteralInt) {
        Dafny.ISequence<Dafny.Rune> _1240___mcc_h642 = _source27.dtor_value;
        return this;
      } else if (_source27.is_LiteralString) {
        Dafny.ISequence<Dafny.Rune> _1241___mcc_h644 = _source27.dtor_value;
        bool _1242___mcc_h645 = _source27.dtor_binary;
        return this;
      } else if (_source27.is_ConversionNum) {
        RAST._IType _1243___mcc_h648 = _source27.dtor_tpe;
        RAST._IExpr _1244___mcc_h649 = _source27.dtor_underlying;
        RAST._IExpr _1245_expr = _1244___mcc_h649;
        RAST._IType _1246_tpe = _1243___mcc_h648;
        if (((((((((((_1246_tpe).is_U8) || ((_1246_tpe).is_U16)) || ((_1246_tpe).is_U32)) || ((_1246_tpe).is_U64)) || ((_1246_tpe).is_U128)) || ((_1246_tpe).is_I8)) || ((_1246_tpe).is_I16)) || ((_1246_tpe).is_I32)) || ((_1246_tpe).is_I64)) || ((_1246_tpe).is_I128)) {
          RAST._IExpr _source40 = _1245_expr;
          if (_source40.is_RawExpr) {
            Dafny.ISequence<Dafny.Rune> _1247___mcc_h704 = _source40.dtor_content;
            return this;
          } else if (_source40.is_Identifier) {
            Dafny.ISequence<Dafny.Rune> _1248___mcc_h706 = _source40.dtor_name;
            return this;
          } else if (_source40.is_Match) {
            RAST._IExpr _1249___mcc_h708 = _source40.dtor_matchee;
            Dafny.ISequence<RAST._IMatchCase> _1250___mcc_h709 = _source40.dtor_cases;
            return this;
          } else if (_source40.is_StmtExpr) {
            RAST._IExpr _1251___mcc_h712 = _source40.dtor_stmt;
            RAST._IExpr _1252___mcc_h713 = _source40.dtor_rhs;
            return this;
          } else if (_source40.is_Block) {
            RAST._IExpr _1253___mcc_h716 = _source40.dtor_underlying;
            return this;
          } else if (_source40.is_StructBuild) {
            Dafny.ISequence<Dafny.Rune> _1254___mcc_h718 = _source40.dtor_name;
            Dafny.ISequence<RAST._IAssignIdentifier> _1255___mcc_h719 = _source40.dtor_assignments;
            return this;
          } else if (_source40.is_Tuple) {
            Dafny.ISequence<RAST._IExpr> _1256___mcc_h722 = _source40.dtor_arguments;
            return this;
          } else if (_source40.is_UnaryOp) {
            Dafny.ISequence<Dafny.Rune> _1257___mcc_h724 = _source40.dtor_op1;
            RAST._IExpr _1258___mcc_h725 = _source40.dtor_underlying;
            DAST.Format._IUnaryOpFormat _1259___mcc_h726 = _source40.dtor_format;
            return this;
          } else if (_source40.is_BinaryOp) {
            Dafny.ISequence<Dafny.Rune> _1260___mcc_h730 = _source40.dtor_op2;
            RAST._IExpr _1261___mcc_h731 = _source40.dtor_left;
            RAST._IExpr _1262___mcc_h732 = _source40.dtor_right;
            DAST.Format._IBinaryOpFormat _1263___mcc_h733 = _source40.dtor_format2;
            return this;
          } else if (_source40.is_TypeAscription) {
            RAST._IExpr _1264___mcc_h738 = _source40.dtor_left;
            RAST._IType _1265___mcc_h739 = _source40.dtor_tpe;
            return this;
          } else if (_source40.is_LiteralInt) {
            Dafny.ISequence<Dafny.Rune> _1266___mcc_h742 = _source40.dtor_value;
            return this;
          } else if (_source40.is_LiteralString) {
            Dafny.ISequence<Dafny.Rune> _1267___mcc_h744 = _source40.dtor_value;
            bool _1268___mcc_h745 = _source40.dtor_binary;
            return this;
          } else if (_source40.is_ConversionNum) {
            RAST._IType _1269___mcc_h748 = _source40.dtor_tpe;
            RAST._IExpr _1270___mcc_h749 = _source40.dtor_underlying;
            return this;
          } else if (_source40.is_DeclareVar) {
            RAST._IDeclareType _1271___mcc_h752 = _source40.dtor_declareType;
            Dafny.ISequence<Dafny.Rune> _1272___mcc_h753 = _source40.dtor_name;
            Std.Wrappers._IOption<RAST._IType> _1273___mcc_h754 = _source40.dtor_optType;
            Std.Wrappers._IOption<RAST._IExpr> _1274___mcc_h755 = _source40.dtor_optRhs;
            return this;
          } else if (_source40.is_AssignVar) {
            Dafny.ISequence<Dafny.Rune> _1275___mcc_h760 = _source40.dtor_name;
            RAST._IExpr _1276___mcc_h761 = _source40.dtor_rhs;
            return this;
          } else if (_source40.is_IfExpr) {
            RAST._IExpr _1277___mcc_h764 = _source40.dtor_cond;
            RAST._IExpr _1278___mcc_h765 = _source40.dtor_thn;
            RAST._IExpr _1279___mcc_h766 = _source40.dtor_els;
            return this;
          } else if (_source40.is_Loop) {
            Std.Wrappers._IOption<RAST._IExpr> _1280___mcc_h770 = _source40.dtor_optCond;
            RAST._IExpr _1281___mcc_h771 = _source40.dtor_underlying;
            return this;
          } else if (_source40.is_For) {
            Dafny.ISequence<Dafny.Rune> _1282___mcc_h774 = _source40.dtor_name;
            RAST._IExpr _1283___mcc_h775 = _source40.dtor_range;
            RAST._IExpr _1284___mcc_h776 = _source40.dtor_body;
            return this;
          } else if (_source40.is_Labelled) {
            Dafny.ISequence<Dafny.Rune> _1285___mcc_h780 = _source40.dtor_lbl;
            RAST._IExpr _1286___mcc_h781 = _source40.dtor_underlying;
            return this;
          } else if (_source40.is_Break) {
            Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1287___mcc_h784 = _source40.dtor_optLbl;
            return this;
          } else if (_source40.is_Continue) {
            Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1288___mcc_h786 = _source40.dtor_optLbl;
            return this;
          } else if (_source40.is_Return) {
            Std.Wrappers._IOption<RAST._IExpr> _1289___mcc_h788 = _source40.dtor_optExpr;
            return this;
          } else if (_source40.is_Call) {
            RAST._IExpr _1290___mcc_h790 = _source40.dtor_obj;
            Dafny.ISequence<RAST._IType> _1291___mcc_h791 = _source40.dtor_typeParameters;
            Dafny.ISequence<RAST._IExpr> _1292___mcc_h792 = _source40.dtor_arguments;
            RAST._IExpr _source41 = _1290___mcc_h790;
            if (_source41.is_RawExpr) {
              Dafny.ISequence<Dafny.Rune> _1293___mcc_h796 = _source41.dtor_content;
              return this;
            } else if (_source41.is_Identifier) {
              Dafny.ISequence<Dafny.Rune> _1294___mcc_h798 = _source41.dtor_name;
              return this;
            } else if (_source41.is_Match) {
              RAST._IExpr _1295___mcc_h800 = _source41.dtor_matchee;
              Dafny.ISequence<RAST._IMatchCase> _1296___mcc_h801 = _source41.dtor_cases;
              return this;
            } else if (_source41.is_StmtExpr) {
              RAST._IExpr _1297___mcc_h804 = _source41.dtor_stmt;
              RAST._IExpr _1298___mcc_h805 = _source41.dtor_rhs;
              return this;
            } else if (_source41.is_Block) {
              RAST._IExpr _1299___mcc_h808 = _source41.dtor_underlying;
              return this;
            } else if (_source41.is_StructBuild) {
              Dafny.ISequence<Dafny.Rune> _1300___mcc_h810 = _source41.dtor_name;
              Dafny.ISequence<RAST._IAssignIdentifier> _1301___mcc_h811 = _source41.dtor_assignments;
              return this;
            } else if (_source41.is_Tuple) {
              Dafny.ISequence<RAST._IExpr> _1302___mcc_h814 = _source41.dtor_arguments;
              return this;
            } else if (_source41.is_UnaryOp) {
              Dafny.ISequence<Dafny.Rune> _1303___mcc_h816 = _source41.dtor_op1;
              RAST._IExpr _1304___mcc_h817 = _source41.dtor_underlying;
              DAST.Format._IUnaryOpFormat _1305___mcc_h818 = _source41.dtor_format;
              return this;
            } else if (_source41.is_BinaryOp) {
              Dafny.ISequence<Dafny.Rune> _1306___mcc_h822 = _source41.dtor_op2;
              RAST._IExpr _1307___mcc_h823 = _source41.dtor_left;
              RAST._IExpr _1308___mcc_h824 = _source41.dtor_right;
              DAST.Format._IBinaryOpFormat _1309___mcc_h825 = _source41.dtor_format2;
              return this;
            } else if (_source41.is_TypeAscription) {
              RAST._IExpr _1310___mcc_h830 = _source41.dtor_left;
              RAST._IType _1311___mcc_h831 = _source41.dtor_tpe;
              return this;
            } else if (_source41.is_LiteralInt) {
              Dafny.ISequence<Dafny.Rune> _1312___mcc_h834 = _source41.dtor_value;
              return this;
            } else if (_source41.is_LiteralString) {
              Dafny.ISequence<Dafny.Rune> _1313___mcc_h836 = _source41.dtor_value;
              bool _1314___mcc_h837 = _source41.dtor_binary;
              return this;
            } else if (_source41.is_ConversionNum) {
              RAST._IType _1315___mcc_h840 = _source41.dtor_tpe;
              RAST._IExpr _1316___mcc_h841 = _source41.dtor_underlying;
              return this;
            } else if (_source41.is_DeclareVar) {
              RAST._IDeclareType _1317___mcc_h844 = _source41.dtor_declareType;
              Dafny.ISequence<Dafny.Rune> _1318___mcc_h845 = _source41.dtor_name;
              Std.Wrappers._IOption<RAST._IType> _1319___mcc_h846 = _source41.dtor_optType;
              Std.Wrappers._IOption<RAST._IExpr> _1320___mcc_h847 = _source41.dtor_optRhs;
              return this;
            } else if (_source41.is_AssignVar) {
              Dafny.ISequence<Dafny.Rune> _1321___mcc_h852 = _source41.dtor_name;
              RAST._IExpr _1322___mcc_h853 = _source41.dtor_rhs;
              return this;
            } else if (_source41.is_IfExpr) {
              RAST._IExpr _1323___mcc_h856 = _source41.dtor_cond;
              RAST._IExpr _1324___mcc_h857 = _source41.dtor_thn;
              RAST._IExpr _1325___mcc_h858 = _source41.dtor_els;
              return this;
            } else if (_source41.is_Loop) {
              Std.Wrappers._IOption<RAST._IExpr> _1326___mcc_h862 = _source41.dtor_optCond;
              RAST._IExpr _1327___mcc_h863 = _source41.dtor_underlying;
              return this;
            } else if (_source41.is_For) {
              Dafny.ISequence<Dafny.Rune> _1328___mcc_h866 = _source41.dtor_name;
              RAST._IExpr _1329___mcc_h867 = _source41.dtor_range;
              RAST._IExpr _1330___mcc_h868 = _source41.dtor_body;
              return this;
            } else if (_source41.is_Labelled) {
              Dafny.ISequence<Dafny.Rune> _1331___mcc_h872 = _source41.dtor_lbl;
              RAST._IExpr _1332___mcc_h873 = _source41.dtor_underlying;
              return this;
            } else if (_source41.is_Break) {
              Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1333___mcc_h876 = _source41.dtor_optLbl;
              return this;
            } else if (_source41.is_Continue) {
              Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1334___mcc_h878 = _source41.dtor_optLbl;
              return this;
            } else if (_source41.is_Return) {
              Std.Wrappers._IOption<RAST._IExpr> _1335___mcc_h880 = _source41.dtor_optExpr;
              return this;
            } else if (_source41.is_Call) {
              RAST._IExpr _1336___mcc_h882 = _source41.dtor_obj;
              Dafny.ISequence<RAST._IType> _1337___mcc_h883 = _source41.dtor_typeParameters;
              Dafny.ISequence<RAST._IExpr> _1338___mcc_h884 = _source41.dtor_arguments;
              return this;
            } else if (_source41.is_Select) {
              RAST._IExpr _1339___mcc_h888 = _source41.dtor_obj;
              Dafny.ISequence<Dafny.Rune> _1340___mcc_h889 = _source41.dtor_name;
              return this;
            } else {
              RAST._IExpr _1341___mcc_h892 = _source41.dtor_obj;
              Dafny.ISequence<Dafny.Rune> _1342___mcc_h893 = _source41.dtor_name;
              RAST._IExpr _source42 = _1341___mcc_h892;
              if (_source42.is_RawExpr) {
                Dafny.ISequence<Dafny.Rune> _1343___mcc_h896 = _source42.dtor_content;
                return this;
              } else if (_source42.is_Identifier) {
                Dafny.ISequence<Dafny.Rune> _1344___mcc_h898 = _source42.dtor_name;
                return this;
              } else if (_source42.is_Match) {
                RAST._IExpr _1345___mcc_h900 = _source42.dtor_matchee;
                Dafny.ISequence<RAST._IMatchCase> _1346___mcc_h901 = _source42.dtor_cases;
                return this;
              } else if (_source42.is_StmtExpr) {
                RAST._IExpr _1347___mcc_h904 = _source42.dtor_stmt;
                RAST._IExpr _1348___mcc_h905 = _source42.dtor_rhs;
                return this;
              } else if (_source42.is_Block) {
                RAST._IExpr _1349___mcc_h908 = _source42.dtor_underlying;
                return this;
              } else if (_source42.is_StructBuild) {
                Dafny.ISequence<Dafny.Rune> _1350___mcc_h910 = _source42.dtor_name;
                Dafny.ISequence<RAST._IAssignIdentifier> _1351___mcc_h911 = _source42.dtor_assignments;
                return this;
              } else if (_source42.is_Tuple) {
                Dafny.ISequence<RAST._IExpr> _1352___mcc_h914 = _source42.dtor_arguments;
                return this;
              } else if (_source42.is_UnaryOp) {
                Dafny.ISequence<Dafny.Rune> _1353___mcc_h916 = _source42.dtor_op1;
                RAST._IExpr _1354___mcc_h917 = _source42.dtor_underlying;
                DAST.Format._IUnaryOpFormat _1355___mcc_h918 = _source42.dtor_format;
                return this;
              } else if (_source42.is_BinaryOp) {
                Dafny.ISequence<Dafny.Rune> _1356___mcc_h922 = _source42.dtor_op2;
                RAST._IExpr _1357___mcc_h923 = _source42.dtor_left;
                RAST._IExpr _1358___mcc_h924 = _source42.dtor_right;
                DAST.Format._IBinaryOpFormat _1359___mcc_h925 = _source42.dtor_format2;
                return this;
              } else if (_source42.is_TypeAscription) {
                RAST._IExpr _1360___mcc_h930 = _source42.dtor_left;
                RAST._IType _1361___mcc_h931 = _source42.dtor_tpe;
                return this;
              } else if (_source42.is_LiteralInt) {
                Dafny.ISequence<Dafny.Rune> _1362___mcc_h934 = _source42.dtor_value;
                return this;
              } else if (_source42.is_LiteralString) {
                Dafny.ISequence<Dafny.Rune> _1363___mcc_h936 = _source42.dtor_value;
                bool _1364___mcc_h937 = _source42.dtor_binary;
                return this;
              } else if (_source42.is_ConversionNum) {
                RAST._IType _1365___mcc_h940 = _source42.dtor_tpe;
                RAST._IExpr _1366___mcc_h941 = _source42.dtor_underlying;
                return this;
              } else if (_source42.is_DeclareVar) {
                RAST._IDeclareType _1367___mcc_h944 = _source42.dtor_declareType;
                Dafny.ISequence<Dafny.Rune> _1368___mcc_h945 = _source42.dtor_name;
                Std.Wrappers._IOption<RAST._IType> _1369___mcc_h946 = _source42.dtor_optType;
                Std.Wrappers._IOption<RAST._IExpr> _1370___mcc_h947 = _source42.dtor_optRhs;
                return this;
              } else if (_source42.is_AssignVar) {
                Dafny.ISequence<Dafny.Rune> _1371___mcc_h952 = _source42.dtor_name;
                RAST._IExpr _1372___mcc_h953 = _source42.dtor_rhs;
                return this;
              } else if (_source42.is_IfExpr) {
                RAST._IExpr _1373___mcc_h956 = _source42.dtor_cond;
                RAST._IExpr _1374___mcc_h957 = _source42.dtor_thn;
                RAST._IExpr _1375___mcc_h958 = _source42.dtor_els;
                return this;
              } else if (_source42.is_Loop) {
                Std.Wrappers._IOption<RAST._IExpr> _1376___mcc_h962 = _source42.dtor_optCond;
                RAST._IExpr _1377___mcc_h963 = _source42.dtor_underlying;
                return this;
              } else if (_source42.is_For) {
                Dafny.ISequence<Dafny.Rune> _1378___mcc_h966 = _source42.dtor_name;
                RAST._IExpr _1379___mcc_h967 = _source42.dtor_range;
                RAST._IExpr _1380___mcc_h968 = _source42.dtor_body;
                return this;
              } else if (_source42.is_Labelled) {
                Dafny.ISequence<Dafny.Rune> _1381___mcc_h972 = _source42.dtor_lbl;
                RAST._IExpr _1382___mcc_h973 = _source42.dtor_underlying;
                return this;
              } else if (_source42.is_Break) {
                Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1383___mcc_h976 = _source42.dtor_optLbl;
                return this;
              } else if (_source42.is_Continue) {
                Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1384___mcc_h978 = _source42.dtor_optLbl;
                return this;
              } else if (_source42.is_Return) {
                Std.Wrappers._IOption<RAST._IExpr> _1385___mcc_h980 = _source42.dtor_optExpr;
                return this;
              } else if (_source42.is_Call) {
                RAST._IExpr _1386___mcc_h982 = _source42.dtor_obj;
                Dafny.ISequence<RAST._IType> _1387___mcc_h983 = _source42.dtor_typeParameters;
                Dafny.ISequence<RAST._IExpr> _1388___mcc_h984 = _source42.dtor_arguments;
                return this;
              } else if (_source42.is_Select) {
                RAST._IExpr _1389___mcc_h988 = _source42.dtor_obj;
                Dafny.ISequence<Dafny.Rune> _1390___mcc_h989 = _source42.dtor_name;
                return this;
              } else {
                RAST._IExpr _1391___mcc_h992 = _source42.dtor_obj;
                Dafny.ISequence<Dafny.Rune> _1392___mcc_h993 = _source42.dtor_name;
                RAST._IExpr _source43 = _1391___mcc_h992;
                if (_source43.is_RawExpr) {
                  Dafny.ISequence<Dafny.Rune> _1393___mcc_h996 = _source43.dtor_content;
                  return this;
                } else if (_source43.is_Identifier) {
                  Dafny.ISequence<Dafny.Rune> _1394___mcc_h998 = _source43.dtor_name;
                  return this;
                } else if (_source43.is_Match) {
                  RAST._IExpr _1395___mcc_h1000 = _source43.dtor_matchee;
                  Dafny.ISequence<RAST._IMatchCase> _1396___mcc_h1001 = _source43.dtor_cases;
                  return this;
                } else if (_source43.is_StmtExpr) {
                  RAST._IExpr _1397___mcc_h1004 = _source43.dtor_stmt;
                  RAST._IExpr _1398___mcc_h1005 = _source43.dtor_rhs;
                  return this;
                } else if (_source43.is_Block) {
                  RAST._IExpr _1399___mcc_h1008 = _source43.dtor_underlying;
                  return this;
                } else if (_source43.is_StructBuild) {
                  Dafny.ISequence<Dafny.Rune> _1400___mcc_h1010 = _source43.dtor_name;
                  Dafny.ISequence<RAST._IAssignIdentifier> _1401___mcc_h1011 = _source43.dtor_assignments;
                  return this;
                } else if (_source43.is_Tuple) {
                  Dafny.ISequence<RAST._IExpr> _1402___mcc_h1014 = _source43.dtor_arguments;
                  return this;
                } else if (_source43.is_UnaryOp) {
                  Dafny.ISequence<Dafny.Rune> _1403___mcc_h1016 = _source43.dtor_op1;
                  RAST._IExpr _1404___mcc_h1017 = _source43.dtor_underlying;
                  DAST.Format._IUnaryOpFormat _1405___mcc_h1018 = _source43.dtor_format;
                  return this;
                } else if (_source43.is_BinaryOp) {
                  Dafny.ISequence<Dafny.Rune> _1406___mcc_h1022 = _source43.dtor_op2;
                  RAST._IExpr _1407___mcc_h1023 = _source43.dtor_left;
                  RAST._IExpr _1408___mcc_h1024 = _source43.dtor_right;
                  DAST.Format._IBinaryOpFormat _1409___mcc_h1025 = _source43.dtor_format2;
                  return this;
                } else if (_source43.is_TypeAscription) {
                  RAST._IExpr _1410___mcc_h1030 = _source43.dtor_left;
                  RAST._IType _1411___mcc_h1031 = _source43.dtor_tpe;
                  return this;
                } else if (_source43.is_LiteralInt) {
                  Dafny.ISequence<Dafny.Rune> _1412___mcc_h1034 = _source43.dtor_value;
                  return this;
                } else if (_source43.is_LiteralString) {
                  Dafny.ISequence<Dafny.Rune> _1413___mcc_h1036 = _source43.dtor_value;
                  bool _1414___mcc_h1037 = _source43.dtor_binary;
                  return this;
                } else if (_source43.is_ConversionNum) {
                  RAST._IType _1415___mcc_h1040 = _source43.dtor_tpe;
                  RAST._IExpr _1416___mcc_h1041 = _source43.dtor_underlying;
                  return this;
                } else if (_source43.is_DeclareVar) {
                  RAST._IDeclareType _1417___mcc_h1044 = _source43.dtor_declareType;
                  Dafny.ISequence<Dafny.Rune> _1418___mcc_h1045 = _source43.dtor_name;
                  Std.Wrappers._IOption<RAST._IType> _1419___mcc_h1046 = _source43.dtor_optType;
                  Std.Wrappers._IOption<RAST._IExpr> _1420___mcc_h1047 = _source43.dtor_optRhs;
                  return this;
                } else if (_source43.is_AssignVar) {
                  Dafny.ISequence<Dafny.Rune> _1421___mcc_h1052 = _source43.dtor_name;
                  RAST._IExpr _1422___mcc_h1053 = _source43.dtor_rhs;
                  return this;
                } else if (_source43.is_IfExpr) {
                  RAST._IExpr _1423___mcc_h1056 = _source43.dtor_cond;
                  RAST._IExpr _1424___mcc_h1057 = _source43.dtor_thn;
                  RAST._IExpr _1425___mcc_h1058 = _source43.dtor_els;
                  return this;
                } else if (_source43.is_Loop) {
                  Std.Wrappers._IOption<RAST._IExpr> _1426___mcc_h1062 = _source43.dtor_optCond;
                  RAST._IExpr _1427___mcc_h1063 = _source43.dtor_underlying;
                  return this;
                } else if (_source43.is_For) {
                  Dafny.ISequence<Dafny.Rune> _1428___mcc_h1066 = _source43.dtor_name;
                  RAST._IExpr _1429___mcc_h1067 = _source43.dtor_range;
                  RAST._IExpr _1430___mcc_h1068 = _source43.dtor_body;
                  return this;
                } else if (_source43.is_Labelled) {
                  Dafny.ISequence<Dafny.Rune> _1431___mcc_h1072 = _source43.dtor_lbl;
                  RAST._IExpr _1432___mcc_h1073 = _source43.dtor_underlying;
                  return this;
                } else if (_source43.is_Break) {
                  Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1433___mcc_h1076 = _source43.dtor_optLbl;
                  return this;
                } else if (_source43.is_Continue) {
                  Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1434___mcc_h1078 = _source43.dtor_optLbl;
                  return this;
                } else if (_source43.is_Return) {
                  Std.Wrappers._IOption<RAST._IExpr> _1435___mcc_h1080 = _source43.dtor_optExpr;
                  return this;
                } else if (_source43.is_Call) {
                  RAST._IExpr _1436___mcc_h1082 = _source43.dtor_obj;
                  Dafny.ISequence<RAST._IType> _1437___mcc_h1083 = _source43.dtor_typeParameters;
                  Dafny.ISequence<RAST._IExpr> _1438___mcc_h1084 = _source43.dtor_arguments;
                  return this;
                } else if (_source43.is_Select) {
                  RAST._IExpr _1439___mcc_h1088 = _source43.dtor_obj;
                  Dafny.ISequence<Dafny.Rune> _1440___mcc_h1089 = _source43.dtor_name;
                  return this;
                } else {
                  RAST._IExpr _1441___mcc_h1092 = _source43.dtor_obj;
                  Dafny.ISequence<Dafny.Rune> _1442___mcc_h1093 = _source43.dtor_name;
                  RAST._IExpr _source44 = _1441___mcc_h1092;
                  if (_source44.is_RawExpr) {
                    Dafny.ISequence<Dafny.Rune> _1443___mcc_h1096 = _source44.dtor_content;
                    return this;
                  } else if (_source44.is_Identifier) {
                    Dafny.ISequence<Dafny.Rune> _1444___mcc_h1098 = _source44.dtor_name;
                    if (object.Equals(_1444___mcc_h1098, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))) {
                      if (object.Equals(_1442___mcc_h1093, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("dafny_runtime"))) {
                        if (object.Equals(_1392___mcc_h993, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("DafnyInt"))) {
                          if (object.Equals(_1342___mcc_h893, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("from"))) {
                            Dafny.ISequence<RAST._IExpr> _1445_args = _1292___mcc_h792;
                            Dafny.ISequence<RAST._IType> _1446_tpe = _1291___mcc_h791;
                            if (((new BigInteger((_1446_tpe).Count)).Sign == 0) && ((new BigInteger((_1445_args).Count)) == (BigInteger.One))) {
                              RAST._IExpr _source45 = (_1445_args).Select(BigInteger.Zero);
                              if (_source45.is_RawExpr) {
                                Dafny.ISequence<Dafny.Rune> _1447___mcc_h1204 = _source45.dtor_content;
                                return this;
                              } else if (_source45.is_Identifier) {
                                Dafny.ISequence<Dafny.Rune> _1448___mcc_h1206 = _source45.dtor_name;
                                return this;
                              } else if (_source45.is_Match) {
                                RAST._IExpr _1449___mcc_h1208 = _source45.dtor_matchee;
                                Dafny.ISequence<RAST._IMatchCase> _1450___mcc_h1209 = _source45.dtor_cases;
                                return this;
                              } else if (_source45.is_StmtExpr) {
                                RAST._IExpr _1451___mcc_h1212 = _source45.dtor_stmt;
                                RAST._IExpr _1452___mcc_h1213 = _source45.dtor_rhs;
                                return this;
                              } else if (_source45.is_Block) {
                                RAST._IExpr _1453___mcc_h1216 = _source45.dtor_underlying;
                                return this;
                              } else if (_source45.is_StructBuild) {
                                Dafny.ISequence<Dafny.Rune> _1454___mcc_h1218 = _source45.dtor_name;
                                Dafny.ISequence<RAST._IAssignIdentifier> _1455___mcc_h1219 = _source45.dtor_assignments;
                                return this;
                              } else if (_source45.is_Tuple) {
                                Dafny.ISequence<RAST._IExpr> _1456___mcc_h1222 = _source45.dtor_arguments;
                                return this;
                              } else if (_source45.is_UnaryOp) {
                                Dafny.ISequence<Dafny.Rune> _1457___mcc_h1224 = _source45.dtor_op1;
                                RAST._IExpr _1458___mcc_h1225 = _source45.dtor_underlying;
                                DAST.Format._IUnaryOpFormat _1459___mcc_h1226 = _source45.dtor_format;
                                return this;
                              } else if (_source45.is_BinaryOp) {
                                Dafny.ISequence<Dafny.Rune> _1460___mcc_h1230 = _source45.dtor_op2;
                                RAST._IExpr _1461___mcc_h1231 = _source45.dtor_left;
                                RAST._IExpr _1462___mcc_h1232 = _source45.dtor_right;
                                DAST.Format._IBinaryOpFormat _1463___mcc_h1233 = _source45.dtor_format2;
                                return this;
                              } else if (_source45.is_TypeAscription) {
                                RAST._IExpr _1464___mcc_h1238 = _source45.dtor_left;
                                RAST._IType _1465___mcc_h1239 = _source45.dtor_tpe;
                                return this;
                              } else if (_source45.is_LiteralInt) {
                                Dafny.ISequence<Dafny.Rune> _1466___mcc_h1242 = _source45.dtor_value;
                                Dafny.ISequence<Dafny.Rune> _1467_number = _1466___mcc_h1242;
                                ...
                                Dafny.ISequence<Dafny.Rune> _1468___mcc_h1244 = _source45.dtor_value;
                                bool _1469___mcc_h1245 = _source45.dtor_binary;
                                Dafny.ISequence<Dafny.Rune> _1470_number = _1468___mcc_h1244;
                                return RAST.Expr.create_LiteralInt(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/*optimized*/"), _1470_number));
                              } else if (_source45.is_ConversionNum) {
                                RAST._IType _1471___mcc_h1248 = _source45.dtor_tpe;
                                RAST._IExpr _1472___mcc_h1249 = _source45.dtor_underlying;
                                return this;
                              } else if (_source45.is_DeclareVar) {
                                RAST._IDeclareType _1473___mcc_h1252 = _source45.dtor_declareType;
                                Dafny.ISequence<Dafny.Rune> _1474___mcc_h1253 = _source45.dtor_name;
                                Std.Wrappers._IOption<RAST._IType> _1475___mcc_h1254 = _source45.dtor_optType;
                                Std.Wrappers._IOption<RAST._IExpr> _1476___mcc_h1255 = _source45.dtor_optRhs;
                                return this;
                              } else if (_source45.is_AssignVar) {
                                Dafny.ISequence<Dafny.Rune> _1477___mcc_h1260 = _source45.dtor_name;
                                RAST._IExpr _1478___mcc_h1261 = _source45.dtor_rhs;
                                return this;
                              } else if (_source45.is_IfExpr) {
                                RAST._IExpr _1479___mcc_h1264 = _source45.dtor_cond;
                                RAST._IExpr _1480___mcc_h1265 = _source45.dtor_thn;
                                RAST._IExpr _1481___mcc_h1266 = _source45.dtor_els;
                                return this;
                              } else if (_source45.is_Loop) {
                                Std.Wrappers._IOption<RAST._IExpr> _1482___mcc_h1270 = _source45.dtor_optCond;
                                RAST._IExpr _1483___mcc_h1271 = _source45.dtor_underlying;
                                return this;
                              } else if (_source45.is_For) {
                                Dafny.ISequence<Dafny.Rune> _1484___mcc_h1274 = _source45.dtor_name;
                                RAST._IExpr _1485___mcc_h1275 = _source45.dtor_range;
                                RAST._IExpr _1486___mcc_h1276 = _source45.dtor_body;
                                return this;
                              } else if (_source45.is_Labelled) {
                                Dafny.ISequence<Dafny.Rune> _1487___mcc_h1280 = _source45.dtor_lbl;
                                RAST._IExpr _1488___mcc_h1281 = _source45.dtor_underlying;
                                return this;
                              } else if (_source45.is_Break) {
                                Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1489___mcc_h1284 = _source45.dtor_optLbl;
                                return this;
                              } else if (_source45.is_Continue) {
                                Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1490___mcc_h1286 = _source45.dtor_optLbl;
                                return this;
                              } else if (_source45.is_Return) {
                                Std.Wrappers._IOption<RAST._IExpr> _1491___mcc_h1288 = _source45.dtor_optExpr;
                                return this;
                              } else if (_source45.is_Call) {
                                RAST._IExpr _1492___mcc_h1290 = _source45.dtor_obj;
                                Dafny.ISequence<RAST._IType> _1493___mcc_h1291 = _source45.dtor_typeParameters;
                                Dafny.ISequence<RAST._IExpr> _1494___mcc_h1292 = _source45.dtor_arguments;
                                return this;
                              } else if (_source45.is_Select) {
                                RAST._IExpr _1495___mcc_h1296 = _source45.dtor_obj;
                                Dafny.ISequence<Dafny.Rune> _1496___mcc_h1297 = _source45.dtor_name;
                                return this;
                              } else {
                                RAST._IExpr _1497___mcc_h1300 = _source45.dtor_obj;
                                Dafny.ISequence<Dafny.Rune> _1498___mcc_h1301 = _source45.dtor_name;
                                return this;
                              }
                            } else {
                              return this;
                    ...
                    RAST._IExpr _1499___mcc_h1100 = _source44.dtor_matchee;
                    Dafny.ISequence<RAST._IMatchCase> _1500___mcc_h1101 = _source44.dtor_cases;
                    return this;
                  } else if (_source44.is_StmtExpr) {
                    RAST._IExpr _1501___mcc_h1104 = _source44.dtor_stmt;
                    RAST._IExpr _1502___mcc_h1105 = _source44.dtor_rhs;
                    return this;
                  } else if (_source44.is_Block) {
                    RAST._IExpr _1503___mcc_h1108 = _source44.dtor_underlying;
                    return this;
                  } else if (_source44.is_StructBuild) {
                    Dafny.ISequence<Dafny.Rune> _1504___mcc_h1110 = _source44.dtor_name;
                    Dafny.ISequence<RAST._IAssignIdentifier> _1505___mcc_h1111 = _source44.dtor_assignments;
                    return this;
                  } else if (_source44.is_Tuple) {
                    Dafny.ISequence<RAST._IExpr> _1506___mcc_h1114 = _source44.dtor_arguments;
                    return this;
                  } else if (_source44.is_UnaryOp) {
                    Dafny.ISequence<Dafny.Rune> _1507___mcc_h1116 = _source44.dtor_op1;
                    RAST._IExpr _1508___mcc_h1117 = _source44.dtor_underlying;
                    DAST.Format._IUnaryOpFormat _1509___mcc_h1118 = _source44.dtor_format;
                    return this;
                  } else if (_source44.is_BinaryOp) {
                    Dafny.ISequence<Dafny.Rune> _1510___mcc_h1122 = _source44.dtor_op2;
                    RAST._IExpr _1511___mcc_h1123 = _source44.dtor_left;
                    RAST._IExpr _1512___mcc_h1124 = _source44.dtor_right;
                    DAST.Format._IBinaryOpFormat _1513___mcc_h1125 = _source44.dtor_format2;
                    return this;
                  } else if (_source44.is_TypeAscription) {
                    RAST._IExpr _1514___mcc_h1130 = _source44.dtor_left;
                    RAST._IType _1515___mcc_h1131 = _source44.dtor_tpe;
                    return this;
                  } else if (_source44.is_LiteralInt) {
                    Dafny.ISequence<Dafny.Rune> _1516___mcc_h1134 = _source44.dtor_value;
                    return this;
                  } else if (_source44.is_LiteralString) {
                    Dafny.ISequence<Dafny.Rune> _1517___mcc_h1136 = _source44.dtor_value;
                    bool _1518___mcc_h1137 = _source44.dtor_binary;
                    return this;
                  } else if (_source44.is_ConversionNum) {
                    RAST._IType _1519___mcc_h1140 = _source44.dtor_tpe;
                    RAST._IExpr _1520___mcc_h1141 = _source44.dtor_underlying;
                    return this;
                  } else if (_source44.is_DeclareVar) {
                    RAST._IDeclareType _1521___mcc_h1144 = _source44.dtor_declareType;
                    Dafny.ISequence<Dafny.Rune> _1522___mcc_h1145 = _source44.dtor_name;
                    Std.Wrappers._IOption<RAST._IType> _1523___mcc_h1146 = _source44.dtor_optType;
                    Std.Wrappers._IOption<RAST._IExpr> _1524___mcc_h1147 = _source44.dtor_optRhs;
                    return this;
                  } else if (_source44.is_AssignVar) {
                    Dafny.ISequence<Dafny.Rune> _1525___mcc_h1152 = _source44.dtor_name;
                    RAST._IExpr _1526___mcc_h1153 = _source44.dtor_rhs;
                    return this;
                  } else if (_source44.is_IfExpr) {
                    RAST._IExpr _1527___mcc_h1156 = _source44.dtor_cond;
                    RAST._IExpr _1528___mcc_h1157 = _source44.dtor_thn;
                    RAST._IExpr _1529___mcc_h1158 = _source44.dtor_els;
                    return this;
                  } else if (_source44.is_Loop) {
                    Std.Wrappers._IOption<RAST._IExpr> _1530___mcc_h1162 = _source44.dtor_optCond;
                    RAST._IExpr _1531___mcc_h1163 = _source44.dtor_underlying;
                    return this;
                  } else if (_source44.is_For) {
                    Dafny.ISequence<Dafny.Rune> _1532___mcc_h1166 = _source44.dtor_name;
                    RAST._IExpr _1533___mcc_h1167 = _source44.dtor_range;
                    RAST._IExpr _1534___mcc_h1168 = _source44.dtor_body;
                    return this;
                  } else if (_source44.is_Labelled) {
                    Dafny.ISequence<Dafny.Rune> _1535___mcc_h1172 = _source44.dtor_lbl;
                    RAST._IExpr _1536___mcc_h1173 = _source44.dtor_underlying;
                    return this;
                  } else if (_source44.is_Break) {
                    Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1537___mcc_h1176 = _source44.dtor_optLbl;
                    return this;
                  } else if (_source44.is_Continue) {
                    Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1538___mcc_h1178 = _source44.dtor_optLbl;
                    return this;
                  } else if (_source44.is_Return) {
                    Std.Wrappers._IOption<RAST._IExpr> _1539___mcc_h1180 = _source44.dtor_optExpr;
                    return this;
                  } else if (_source44.is_Call) {
                    RAST._IExpr _1540___mcc_h1182 = _source44.dtor_obj;
                    Dafny.ISequence<RAST._IType> _1541___mcc_h1183 = _source44.dtor_typeParameters;
                    Dafny.ISequence<RAST._IExpr> _1542___mcc_h1184 = _source44.dtor_arguments;
                    return this;
                  } else if (_source44.is_Select) {
                    RAST._IExpr _1543___mcc_h1188 = _source44.dtor_obj;
                    Dafny.ISequence<Dafny.Rune> _1544___mcc_h1189 = _source44.dtor_name;
                    return this;
                  } else {
                    RAST._IExpr _1545___mcc_h1192 = _source44.dtor_obj;
                    Dafny.ISequence<Dafny.Rune> _1546___mcc_h1193 = _source44.dtor_name;
                    return this;
                  }
                }
              }
            ...
            RAST._IExpr _1547___mcc_h1196 = _source40.dtor_obj;
            Dafny.ISequence<Dafny.Rune> _1548___mcc_h1197 = _source40.dtor_name;
            return this;
          } else {
            RAST._IExpr _1549___mcc_h1200 = _source40.dtor_obj;
            Dafny.ISequence<Dafny.Rune> _1550___mcc_h1201 = _source40.dtor_name;
            return this;
          }
        } else {
          return this;
        ...
        RAST._IDeclareType _1551___mcc_h652 = _source27.dtor_declareType;
        Dafny.ISequence<Dafny.Rune> _1552___mcc_h653 = _source27.dtor_name;
        Std.Wrappers._IOption<RAST._IType> _1553___mcc_h654 = _source27.dtor_optType;
        Std.Wrappers._IOption<RAST._IExpr> _1554___mcc_h655 = _source27.dtor_optRhs;
        return this;
      } else if (_source27.is_AssignVar) {
        Dafny.ISequence<Dafny.Rune> _1555___mcc_h660 = _source27.dtor_name;
        RAST._IExpr _1556___mcc_h661 = _source27.dtor_rhs;
        return this;
      } else if (_source27.is_IfExpr) {
        RAST._IExpr _1557___mcc_h664 = _source27.dtor_cond;
        RAST._IExpr _1558___mcc_h665 = _source27.dtor_thn;
        RAST._IExpr _1559___mcc_h666 = _source27.dtor_els;
        return this;
      } else if (_source27.is_Loop) {
        Std.Wrappers._IOption<RAST._IExpr> _1560___mcc_h670 = _source27.dtor_optCond;
        RAST._IExpr _1561___mcc_h671 = _source27.dtor_underlying;
        return this;
      } else if (_source27.is_For) {
        Dafny.ISequence<Dafny.Rune> _1562___mcc_h674 = _source27.dtor_name;
        RAST._IExpr _1563___mcc_h675 = _source27.dtor_range;
        RAST._IExpr _1564___mcc_h676 = _source27.dtor_body;
        return this;
      } else if (_source27.is_Labelled) {
        Dafny.ISequence<Dafny.Rune> _1565___mcc_h680 = _source27.dtor_lbl;
        RAST._IExpr _1566___mcc_h681 = _source27.dtor_underlying;
        return this;
      } else if (_source27.is_Break) {
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1567___mcc_h684 = _source27.dtor_optLbl;
        return this;
      } else if (_source27.is_Continue) {
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1568___mcc_h686 = _source27.dtor_optLbl;
        return this;
      } else if (_source27.is_Return) {
        Std.Wrappers._IOption<RAST._IExpr> _1569___mcc_h688 = _source27.dtor_optExpr;
        return this;
      } else if (_source27.is_Call) {
        RAST._IExpr _1570___mcc_h690 = _source27.dtor_obj;
        Dafny.ISequence<RAST._IType> _1571___mcc_h691 = _source27.dtor_typeParameters;
        Dafny.ISequence<RAST._IExpr> _1572___mcc_h692 = _source27.dtor_arguments;
        return this;
      } else if (_source27.is_Select) {
        RAST._IExpr _1573___mcc_h696 = _source27.dtor_obj;
        Dafny.ISequence<Dafny.Rune> _1574___mcc_h697 = _source27.dtor_name;
        return this;
      } else {
        RAST._IExpr _1575___mcc_h700 = _source27.dtor_obj;
        Dafny.ISequence<Dafny.Rune> _1576___mcc_h701 = _source27.dtor_name;
        return this;
      }
    }
    public static void TestNoOptimize(RAST._IExpr e)
    {
      if (!(object.Equals((e).Optimize(), e))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(717,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
    }
    public static void TestOptimize()
    {
      RAST._IExpr _1577_x;
      _1577_x = RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("x"));
      RAST._IExpr _1578_y;
      _1578_y = RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("y"));
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"), RAST.Expr.create_Call(RAST.Expr.create_Select(_1577_x, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("clone")), Dafny.Sequence<RAST._IType>.FromElements(), Dafny.Sequence<RAST._IExpr>.FromElements()), DAST.Format.UnaryOpFormat.create_NoFormat())).Optimize(), RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"), _1577_x, DAST.Format.UnaryOpFormat.create_NoFormat())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(723,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      RAST.Expr.TestNoOptimize(RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"), RAST.Expr.create_Call(RAST.Expr.create_Select(_1577_x, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("clone")), Dafny.Sequence<RAST._IType>.FromElements(), Dafny.Sequence<RAST._IExpr>.FromElements(_1578_y)), DAST.Format.UnaryOpFormat.create_NoFormat()));
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!"), RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("=="), _1577_x, _1578_y, DAST.Format.BinaryOpFormat.create_NoFormat()), DAST.Format.UnaryOpFormat.create_CombineFormat())).Optimize(), RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!="), _1577_x, _1578_y, DAST.Format.BinaryOpFormat.create_NoFormat())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(726,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!"), RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<"), _1577_x, _1578_y, DAST.Format.BinaryOpFormat.create_NoFormat()), DAST.Format.UnaryOpFormat.create_CombineFormat())).Optimize(), RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(">="), _1577_x, _1578_y, DAST.Format.BinaryOpFormat.create_NoFormat())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(728,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_UnaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!"), RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<"), _1577_x, _1578_y, DAST.Format.BinaryOpFormat.create_ReverseFormat()), DAST.Format.UnaryOpFormat.create_CombineFormat())).Optimize(), RAST.Expr.create_BinaryOp(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<="), _1578_y, _1577_x, DAST.Format.BinaryOpFormat.create_NoFormat())))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(730,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_ConversionNum(RAST.Type.create_I128(), RAST.Expr.create_Call(RAST.Expr.create_MemberSelect(RAST.Expr.create_MemberSelect(RAST.Expr.create_MemberSelect(RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("dafny_runtime")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("DafnyInt")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("from")), Dafny.Sequence<RAST._IType>.FromElements(), Dafny.Sequence<RAST._IExpr>.FromElements(RAST.Expr.create_LiteralInt(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("1")))))).Optimize(), RAST.Expr.create_LiteralInt(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/*optimized*/1"))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(732,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      if (!(object.Equals((RAST.Expr.create_ConversionNum(RAST.Type.create_I128(), RAST.Expr.create_Call(RAST.Expr.create_MemberSelect(RAST.Expr.create_MemberSelect(RAST.Expr.create_MemberSelect(RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("dafny_runtime")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("DafnyInt")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("from")), Dafny.Sequence<RAST._IType>.FromElements(), Dafny.Sequence<RAST._IExpr>.FromElements(RAST.Expr.create_LiteralString(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("1"), false))))).Optimize(), RAST.Expr.create_LiteralInt(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/*optimized*/1"))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(736,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      RAST.Expr.TestNoOptimize((RAST.Expr.create_ConversionNum(RAST.Type.create_I128(), RAST.Expr.create_Call(RAST.Expr.create_MemberSelect(RAST.Expr.create_MemberSelect(RAST.Expr.create_MemberSelect(RAST.Expr.create_Identifier(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("dafny_runtime")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("DafnyInt")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("from")), Dafny.Sequence<RAST._IType>.FromElements(), Dafny.Sequence<RAST._IExpr>.FromElements(_1577_x)))).Optimize());
      ...
      RAST.Expr.TestNoOptimize(RAST.Expr.create_ConversionNum(RAST.Type.create_I128(), _1577_x));
      if (!(object.Equals((RAST.Expr.create_StmtExpr(RAST.Expr.create_DeclareVar(RAST.DeclareType.create_MUT(), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("z"), Std.Wrappers.Option<RAST._IType>.create_Some(RAST.Type.create_I128()), Std.Wrappers.Option<RAST._IExpr>.create_None()), RAST.Expr.create_StmtExpr(RAST.Expr.create_AssignVar(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("z"), _1578_y), RAST.Expr.create_RawExpr(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("return"))))).Optimize(), RAST.Expr.create_StmtExpr(RAST.Expr.create_DeclareVar(RAST.DeclareType.create_MUT(), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("z"), Std.Wrappers.Option<RAST._IType>.create_Some(RAST.Type.create_I128()), Std.Wrappers.Option<RAST._IExpr>.create_Some(_1578_y)), RAST.Expr.create_RawExpr(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("return")))))) {
        throw new Dafny.HaltException("Backends/Rust/Dafny-compiler-rust.dfy(747,6): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      RAST.Expr.TestNoOptimize(RAST.Expr.create_StmtExpr(RAST.Expr.create_DeclareVar(RAST.DeclareType.create_MUT(), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("z"), Std.Wrappers.Option<RAST._IType>.create_Some(RAST.Type.create_I128()), Std.Wrappers.Option<RAST._IExpr>.create_None()), RAST.Expr.create_StmtExpr(RAST.Expr.create_AssignVar(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("w"), _1578_y), RAST.Expr.create_RawExpr(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("return")))));
      RAST.Expr.TestNoOptimize(_1577_x);
    }
    ...
    public Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> RightMostIdentifier() {
      ...
      if (_source46.is_RawExpr) {
        Dafny.ISequence<Dafny.Rune> _1579___mcc_h0 = _source46.dtor_content;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Identifier) {
        Dafny.ISequence<Dafny.Rune> _1580___mcc_h2 = _source46.dtor_name;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Match) {
        RAST._IExpr _1581___mcc_h4 = _source46.dtor_matchee;
        Dafny.ISequence<RAST._IMatchCase> _1582___mcc_h5 = _source46.dtor_cases;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_StmtExpr) {
        RAST._IExpr _1583___mcc_h8 = _source46.dtor_stmt;
        RAST._IExpr _1584___mcc_h9 = _source46.dtor_rhs;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Block) {
        RAST._IExpr _1585___mcc_h12 = _source46.dtor_underlying;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_StructBuild) {
        Dafny.ISequence<Dafny.Rune> _1586___mcc_h14 = _source46.dtor_name;
        Dafny.ISequence<RAST._IAssignIdentifier> _1587___mcc_h15 = _source46.dtor_assignments;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Tuple) {
        Dafny.ISequence<RAST._IExpr> _1588___mcc_h18 = _source46.dtor_arguments;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_UnaryOp) {
        Dafny.ISequence<Dafny.Rune> _1589___mcc_h20 = _source46.dtor_op1;
        RAST._IExpr _1590___mcc_h21 = _source46.dtor_underlying;
        DAST.Format._IUnaryOpFormat _1591___mcc_h22 = _source46.dtor_format;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_BinaryOp) {
        Dafny.ISequence<Dafny.Rune> _1592___mcc_h26 = _source46.dtor_op2;
        RAST._IExpr _1593___mcc_h27 = _source46.dtor_left;
        RAST._IExpr _1594___mcc_h28 = _source46.dtor_right;
        DAST.Format._IBinaryOpFormat _1595___mcc_h29 = _source46.dtor_format2;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_TypeAscription) {
        RAST._IExpr _1596___mcc_h34 = _source46.dtor_left;
        RAST._IType _1597___mcc_h35 = _source46.dtor_tpe;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_LiteralInt) {
        Dafny.ISequence<Dafny.Rune> _1598___mcc_h38 = _source46.dtor_value;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_LiteralString) {
        Dafny.ISequence<Dafny.Rune> _1599___mcc_h40 = _source46.dtor_value;
        bool _1600___mcc_h41 = _source46.dtor_binary;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_ConversionNum) {
        RAST._IType _1601___mcc_h44 = _source46.dtor_tpe;
        RAST._IExpr _1602___mcc_h45 = _source46.dtor_underlying;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_DeclareVar) {
        RAST._IDeclareType _1603___mcc_h48 = _source46.dtor_declareType;
        Dafny.ISequence<Dafny.Rune> _1604___mcc_h49 = _source46.dtor_name;
        Std.Wrappers._IOption<RAST._IType> _1605___mcc_h50 = _source46.dtor_optType;
        Std.Wrappers._IOption<RAST._IExpr> _1606___mcc_h51 = _source46.dtor_optRhs;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_AssignVar) {
        Dafny.ISequence<Dafny.Rune> _1607___mcc_h56 = _source46.dtor_name;
        RAST._IExpr _1608___mcc_h57 = _source46.dtor_rhs;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_IfExpr) {
        RAST._IExpr _1609___mcc_h60 = _source46.dtor_cond;
        RAST._IExpr _1610___mcc_h61 = _source46.dtor_thn;
        RAST._IExpr _1611___mcc_h62 = _source46.dtor_els;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Loop) {
        Std.Wrappers._IOption<RAST._IExpr> _1612___mcc_h66 = _source46.dtor_optCond;
        RAST._IExpr _1613___mcc_h67 = _source46.dtor_underlying;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_For) {
        Dafny.ISequence<Dafny.Rune> _1614___mcc_h70 = _source46.dtor_name;
        RAST._IExpr _1615___mcc_h71 = _source46.dtor_range;
        RAST._IExpr _1616___mcc_h72 = _source46.dtor_body;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Labelled) {
        Dafny.ISequence<Dafny.Rune> _1617___mcc_h76 = _source46.dtor_lbl;
        RAST._IExpr _1618___mcc_h77 = _source46.dtor_underlying;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Break) {
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1619___mcc_h80 = _source46.dtor_optLbl;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Continue) {
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1620___mcc_h82 = _source46.dtor_optLbl;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Return) {
        Std.Wrappers._IOption<RAST._IExpr> _1621___mcc_h84 = _source46.dtor_optExpr;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Call) {
        RAST._IExpr _1622___mcc_h86 = _source46.dtor_obj;
        Dafny.ISequence<RAST._IType> _1623___mcc_h87 = _source46.dtor_typeParameters;
        Dafny.ISequence<RAST._IExpr> _1624___mcc_h88 = _source46.dtor_arguments;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else if (_source46.is_Select) {
        RAST._IExpr _1625___mcc_h92 = _source46.dtor_obj;
        Dafny.ISequence<Dafny.Rune> _1626___mcc_h93 = _source46.dtor_name;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_None();
      } else {
        RAST._IExpr _1627___mcc_h96 = _source46.dtor_obj;
        Dafny.ISequence<Dafny.Rune> _1628___mcc_h97 = _source46.dtor_name;
        Dafny.ISequence<Dafny.Rune> _1629_id = _1628___mcc_h97;
        return Std.Wrappers.Option<Dafny.ISequence<Dafny.Rune>>.create_Some(_1629_id);
      }
    }
    public Dafny.ISequence<Dafny.Rune> _ToString(Dafny.ISequence<Dafny.Rune> ind) {
      ...
      if (_source47.is_RawExpr) {
        Dafny.ISequence<Dafny.Rune> _1630___mcc_h0 = _source47.dtor_content;
        RAST._IExpr _1631_r = (this).Optimize();
        return RAST.__default.AddIndent((_1631_r).dtor_content, ind);
      } else if (_source47.is_Identifier) {
        Dafny.ISequence<Dafny.Rune> _1632___mcc_h2 = _source47.dtor_name;
        Dafny.ISequence<Dafny.Rune> _1633_name = _1632___mcc_h2;
        return _1633_name;
      } else if (_source47.is_Match) {
        RAST._IExpr _1634___mcc_h4 = _source47.dtor_matchee;
        Dafny.ISequence<RAST._IMatchCase> _1635___mcc_h5 = _source47.dtor_cases;
        Dafny.ISequence<RAST._IMatchCase> _1636_cases = _1635___mcc_h5;
        RAST._IExpr _1637_matchee = _1634___mcc_h4;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("match "), (_1637_matchee)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {")), RAST.__default.SeqToString<RAST._IMatchCase>(_1636_cases, Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, Func<RAST._IMatchCase, Dafny.ISequence<Dafny.Rune>>>>((_1638_ind) => ((System.Func<RAST._IMatchCase, Dafny.ISequence<Dafny.Rune>>)((_1639_c) => {
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n"), _1638_ind), RAST.__default.IND), (_1639_c)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(_1638_ind, RAST.__default.IND)));
        })))(ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(","))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")), ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
      } else if (_source47.is_StmtExpr) {
        RAST._IExpr _1640___mcc_h8 = _source47.dtor_stmt;
        RAST._IExpr _1641___mcc_h9 = _source47.dtor_rhs;
        RAST._IExpr _1642_rhs = _1641___mcc_h9;
        RAST._IExpr _1643_stmt = _1640___mcc_h8;
        if (((_1643_stmt).is_RawExpr) && (((_1643_stmt).dtor_content).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))) {
          return (_1642_rhs)._ToString(ind);
        } else {
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat((_1643_stmt)._ToString(ind), (((_1643_stmt).NoExtraSemicolonAfter()) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";")))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")), ind), (_1642_rhs)._ToString(ind));
        }
      } else if (_source47.is_Block) {
        RAST._IExpr _1644___mcc_h12 = _source47.dtor_underlying;
        RAST._IExpr _1645_underlying = _1644___mcc_h12;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("{\n"), ind), RAST.__default.IND), (_1645_underlying)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")), ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
      } else if (_source47.is_StructBuild) {
        Dafny.ISequence<Dafny.Rune> _1646___mcc_h14 = _source47.dtor_name;
        Dafny.ISequence<RAST._IAssignIdentifier> _1647___mcc_h15 = _source47.dtor_assignments;
        Dafny.ISequence<RAST._IAssignIdentifier> _1648_assignments = _1647___mcc_h15;
        Dafny.ISequence<Dafny.Rune> _1649_name = _1646___mcc_h14;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_1649_name, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {")), RAST.__default.SeqToString<RAST._IAssignIdentifier>(_1648_assignments, Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, Func<RAST._IAssignIdentifier, Dafny.ISequence<Dafny.Rune>>>>((_1650_ind) => ((System.Func<RAST._IAssignIdentifier, Dafny.ISequence<Dafny.Rune>>)((_1651_assignment) => {
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n"), _1650_ind), RAST.__default.IND), (_1651_assignment)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(_1650_ind, RAST.__default.IND)));
        })))(ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(","))), (((new BigInteger((_1648_assignments).Count)).Sign == 1) ? (Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n"), ind)) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
      } else if (_source47.is_Tuple) {
        Dafny.ISequence<RAST._IExpr> _1652___mcc_h18 = _source47.dtor_arguments;
        Dafny.ISequence<RAST._IExpr> _1653_arguments = _1652___mcc_h18;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), RAST.__default.SeqToString<RAST._IExpr>(_1653_arguments, Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, Func<RAST._IExpr, Dafny.ISequence<Dafny.Rune>>>>((_1654_ind) => ((System.Func<RAST._IExpr, Dafny.ISequence<Dafny.Rune>>)((_1655_arg) => {
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n"), _1654_ind), RAST.__default.IND), (_1655_arg)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(_1654_ind, RAST.__default.IND)));
        })))(ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(","))), (((new BigInteger((_1653_arguments).Count)).Sign == 1) ? (Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n"), ind)) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
      } else if (_source47.is_UnaryOp) {
        Dafny.ISequence<Dafny.Rune> _1656___mcc_h20 = _source47.dtor_op1;
        RAST._IExpr _1657___mcc_h21 = _source47.dtor_underlying;
        DAST.Format._IUnaryOpFormat _1658___mcc_h22 = _source47.dtor_format;
        DAST.Format._IUnaryOpFormat _1659_format = _1658___mcc_h22;
        RAST._IExpr _1660_underlying = _1657___mcc_h21;
        Dafny.ISequence<Dafny.Rune> _1661_op = _1656___mcc_h20;
        _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>> _let_tmp_rhs41 = ((((this).printingInfo).NeedParenthesesFor((_1660_underlying).printingInfo)) ? (_System.Tuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"))) : (_System.Tuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))));
        Dafny.ISequence<Dafny.Rune> _1662_leftP = _let_tmp_rhs41.dtor__0;
        Dafny.ISequence<Dafny.Rune> _1663_rightP = _let_tmp_rhs41.dtor__1;
        Dafny.ISequence<Dafny.Rune> _1664_leftOp = ((((_1661_op).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&mut"))) && (!(_1662_leftP).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")))) ? (Dafny.Sequence<Dafny.Rune>.Concat(_1661_op, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" "))) : ((((_1661_op).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("?"))) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")) : (_1661_op))));
        Dafny.ISequence<Dafny.Rune> _1665_rightOp = (((_1661_op).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("?"))) ? (_1661_op) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")));
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_1664_leftOp, _1662_leftP), (_1660_underlying)._ToString(ind)), _1663_rightP), _1665_rightOp);
      } else if (_source47.is_BinaryOp) {
        Dafny.ISequence<Dafny.Rune> _1666___mcc_h26 = _source47.dtor_op2;
        RAST._IExpr _1667___mcc_h27 = _source47.dtor_left;
        RAST._IExpr _1668___mcc_h28 = _source47.dtor_right;
        DAST.Format._IBinaryOpFormat _1669___mcc_h29 = _source47.dtor_format2;
        DAST.Format._IBinaryOpFormat _1670_format = _1669___mcc_h29;
        RAST._IExpr _1671_right = _1668___mcc_h28;
        RAST._IExpr _1672_left = _1667___mcc_h27;
        Dafny.ISequence<Dafny.Rune> _1673_op2 = _1666___mcc_h26;
        _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>> _let_tmp_rhs42 = (this).LeftParentheses(_1672_left);
        Dafny.ISequence<Dafny.Rune> _1674_leftLeftP = _let_tmp_rhs42.dtor__0;
        Dafny.ISequence<Dafny.Rune> _1675_leftRighP = _let_tmp_rhs42.dtor__1;
        _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>> _let_tmp_rhs43 = (this).RightParentheses(_1671_right);
        Dafny.ISequence<Dafny.Rune> _1676_rightLeftP = _let_tmp_rhs43.dtor__0;
        Dafny.ISequence<Dafny.Rune> _1677_rightRightP = _let_tmp_rhs43.dtor__1;
        Dafny.ISequence<Dafny.Rune> _1678_opRendered = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" "), _1673_op2), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" "));
        Dafny.ISequence<Dafny.Rune> _1679_indLeft = (((_1674_leftLeftP).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("))) ? (Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND)) : (ind));
        Dafny.ISequence<Dafny.Rune> _1680_indRight = (((_1676_rightLeftP).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("))) ? (Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND)) : (ind));
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_1674_leftLeftP, (_1672_left)._ToString(_1679_indLeft)), _1675_leftRighP), _1678_opRendered), _1676_rightLeftP), (_1671_right)._ToString(_1680_indRight)), _1677_rightRightP);
      } else if (_source47.is_TypeAscription) {
        RAST._IExpr _1681___mcc_h34 = _source47.dtor_left;
        RAST._IType _1682___mcc_h35 = _source47.dtor_tpe;
        RAST._IType _1683_tpe = _1682___mcc_h35;
        RAST._IExpr _1684_left = _1681___mcc_h34;
        _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>> _let_tmp_rhs44 = (this).LeftParentheses(_1684_left);
        Dafny.ISequence<Dafny.Rune> _1685_leftLeftP = _let_tmp_rhs44.dtor__0;
        Dafny.ISequence<Dafny.Rune> _1686_leftRightP = _let_tmp_rhs44.dtor__1;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_1685_leftLeftP, (_1684_left)._ToString(RAST.__default.IND)), _1686_leftRightP), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" as ")), (_1683_tpe)._ToString(RAST.__default.IND));
      } else if (_source47.is_LiteralInt) {
        Dafny.ISequence<Dafny.Rune> _1687___mcc_h38 = _source47.dtor_value;
        Dafny.ISequence<Dafny.Rune> _1688_number = _1687___mcc_h38;
        return _1688_number;
      } else if (_source47.is_LiteralString) {
        Dafny.ISequence<Dafny.Rune> _1689___mcc_h40 = _source47.dtor_value;
        bool _1690___mcc_h41 = _source47.dtor_binary;
        bool _1691_binary = _1690___mcc_h41;
        Dafny.ISequence<Dafny.Rune> _1692_characters = _1689___mcc_h40;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(((_1691_binary) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("b")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\"")), _1692_characters), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\""));
      } else if (_source47.is_ConversionNum) {
        RAST._IType _1693___mcc_h44 = _source47.dtor_tpe;
        RAST._IExpr _1694___mcc_h45 = _source47.dtor_underlying;
        RAST._IExpr _1695_expr = _1694___mcc_h45;
        RAST._IType _1696_tpe = _1693___mcc_h44;
        if (((((((((((_1696_tpe).is_U8) || ((_1696_tpe).is_U16)) || ((_1696_tpe).is_U32)) || ((_1696_tpe).is_U64)) || ((_1696_tpe).is_U128)) || ((_1696_tpe).is_I8)) || ((_1696_tpe).is_I16)) || ((_1696_tpe).is_I32)) || ((_1696_tpe).is_I64)) || ((_1696_tpe).is_I128)) {
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("num::ToPrimitive::to_"), (_1696_tpe)._ToString(ind)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), (_1695_expr)._ToString(ind)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(").unwrap()"));
        } else {
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<b>Unsupported: Numeric conversion to "), (_1696_tpe)._ToString(ind)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("</b>"));
        }
      } else if (_source47.is_DeclareVar) {
        RAST._IDeclareType _1697___mcc_h48 = _source47.dtor_declareType;
        Dafny.ISequence<Dafny.Rune> _1698___mcc_h49 = _source47.dtor_name;
        Std.Wrappers._IOption<RAST._IType> _1699___mcc_h50 = _source47.dtor_optType;
        Std.Wrappers._IOption<RAST._IExpr> _1700___mcc_h51 = _source47.dtor_optRhs;
        Std.Wrappers._IOption<RAST._IExpr> _1701_optExpr = _1700___mcc_h51;
        Std.Wrappers._IOption<RAST._IType> _1702_optType = _1699___mcc_h50;
        Dafny.ISequence<Dafny.Rune> _1703_name = _1698___mcc_h49;
        RAST._IDeclareType _1704_declareType = _1697___mcc_h48;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("let "), ((object.Equals(_1704_declareType, RAST.DeclareType.create_MUT())) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("mut ")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))), _1703_name), (((_1702_optType).is_Some) ? (Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(": "), ((_1702_optType).dtor_value)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND)))) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))), (((_1701_optExpr).is_Some) ? (Dafny.Helpers.Let<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>(((_1701_optExpr).dtor_value)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND)), _pat_let6_0 => Dafny.Helpers.Let<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>(_pat_let6_0, _1705_optExprString => (((_1705_optExprString).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))) ? (Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("= /*issue with empty RHS*/"), ((System.Func<RAST._IExpr, Dafny.ISequence<Dafny.Rune>>)((_source48) => {
          if (_source48.is_RawExpr) {
            Dafny.ISequence<Dafny.Rune> _1706___mcc_h100 = _source48.dtor_content;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Empty Raw expr");
          } else if (_source48.is_Identifier) {
            Dafny.ISequence<Dafny.Rune> _1707___mcc_h102 = _source48.dtor_name;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Match) {
            RAST._IExpr _1708___mcc_h104 = _source48.dtor_matchee;
            Dafny.ISequence<RAST._IMatchCase> _1709___mcc_h105 = _source48.dtor_cases;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_StmtExpr) {
            RAST._IExpr _1710___mcc_h108 = _source48.dtor_stmt;
            RAST._IExpr _1711___mcc_h109 = _source48.dtor_rhs;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Block) {
            RAST._IExpr _1712___mcc_h112 = _source48.dtor_underlying;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_StructBuild) {
            Dafny.ISequence<Dafny.Rune> _1713___mcc_h114 = _source48.dtor_name;
            Dafny.ISequence<RAST._IAssignIdentifier> _1714___mcc_h115 = _source48.dtor_assignments;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Tuple) {
            Dafny.ISequence<RAST._IExpr> _1715___mcc_h118 = _source48.dtor_arguments;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_UnaryOp) {
            Dafny.ISequence<Dafny.Rune> _1716___mcc_h120 = _source48.dtor_op1;
            RAST._IExpr _1717___mcc_h121 = _source48.dtor_underlying;
            DAST.Format._IUnaryOpFormat _1718___mcc_h122 = _source48.dtor_format;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_BinaryOp) {
            Dafny.ISequence<Dafny.Rune> _1719___mcc_h126 = _source48.dtor_op2;
            RAST._IExpr _1720___mcc_h127 = _source48.dtor_left;
            RAST._IExpr _1721___mcc_h128 = _source48.dtor_right;
            DAST.Format._IBinaryOpFormat _1722___mcc_h129 = _source48.dtor_format2;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_TypeAscription) {
            RAST._IExpr _1723___mcc_h134 = _source48.dtor_left;
            RAST._IType _1724___mcc_h135 = _source48.dtor_tpe;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_LiteralInt) {
            Dafny.ISequence<Dafny.Rune> _1725___mcc_h138 = _source48.dtor_value;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Empty int literal");
          } else if (_source48.is_LiteralString) {
            Dafny.ISequence<Dafny.Rune> _1726___mcc_h140 = _source48.dtor_value;
            bool _1727___mcc_h141 = _source48.dtor_binary;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Empty string literal");
          } else if (_source48.is_ConversionNum) {
            RAST._IType _1728___mcc_h144 = _source48.dtor_tpe;
            RAST._IExpr _1729___mcc_h145 = _source48.dtor_underlying;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_DeclareVar) {
            RAST._IDeclareType _1730___mcc_h148 = _source48.dtor_declareType;
            Dafny.ISequence<Dafny.Rune> _1731___mcc_h149 = _source48.dtor_name;
            Std.Wrappers._IOption<RAST._IType> _1732___mcc_h150 = _source48.dtor_optType;
            Std.Wrappers._IOption<RAST._IExpr> _1733___mcc_h151 = _source48.dtor_optRhs;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_AssignVar) {
            Dafny.ISequence<Dafny.Rune> _1734___mcc_h156 = _source48.dtor_name;
            RAST._IExpr _1735___mcc_h157 = _source48.dtor_rhs;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_IfExpr) {
            RAST._IExpr _1736___mcc_h160 = _source48.dtor_cond;
            RAST._IExpr _1737___mcc_h161 = _source48.dtor_thn;
            RAST._IExpr _1738___mcc_h162 = _source48.dtor_els;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Loop) {
            Std.Wrappers._IOption<RAST._IExpr> _1739___mcc_h166 = _source48.dtor_optCond;
            RAST._IExpr _1740___mcc_h167 = _source48.dtor_underlying;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_For) {
            Dafny.ISequence<Dafny.Rune> _1741___mcc_h170 = _source48.dtor_name;
            RAST._IExpr _1742___mcc_h171 = _source48.dtor_range;
            RAST._IExpr _1743___mcc_h172 = _source48.dtor_body;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Labelled) {
            Dafny.ISequence<Dafny.Rune> _1744___mcc_h176 = _source48.dtor_lbl;
            RAST._IExpr _1745___mcc_h177 = _source48.dtor_underlying;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Break) {
            Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1746___mcc_h180 = _source48.dtor_optLbl;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Continue) {
            Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1747___mcc_h182 = _source48.dtor_optLbl;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Return) {
            Std.Wrappers._IOption<RAST._IExpr> _1748___mcc_h184 = _source48.dtor_optExpr;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Call) {
            RAST._IExpr _1749___mcc_h186 = _source48.dtor_obj;
            Dafny.ISequence<RAST._IType> _1750___mcc_h187 = _source48.dtor_typeParameters;
            Dafny.ISequence<RAST._IExpr> _1751___mcc_h188 = _source48.dtor_arguments;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else if (_source48.is_Select) {
            RAST._IExpr _1752___mcc_h192 = _source48.dtor_obj;
            Dafny.ISequence<Dafny.Rune> _1753___mcc_h193 = _source48.dtor_name;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          } else {
            RAST._IExpr _1754___mcc_h196 = _source48.dtor_obj;
            Dafny.ISequence<Dafny.Rune> _1755___mcc_h197 = _source48.dtor_name;
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Another case");
          }
        }))((_1701_optExpr).dtor_value))) : (Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" = "), _1705_optExprString)))))) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";"));
      } else if (_source47.is_AssignVar) {
        Dafny.ISequence<Dafny.Rune> _1756___mcc_h56 = _source47.dtor_name;
        RAST._IExpr _1757___mcc_h57 = _source47.dtor_rhs;
        RAST._IExpr _1758_expr = _1757___mcc_h57;
        Dafny.ISequence<Dafny.Rune> _1759_name = _1756___mcc_h56;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_1759_name, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" = ")), (_1758_expr)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";"));
      } else if (_source47.is_IfExpr) {
        RAST._IExpr _1760___mcc_h60 = _source47.dtor_cond;
        RAST._IExpr _1761___mcc_h61 = _source47.dtor_thn;
        RAST._IExpr _1762___mcc_h62 = _source47.dtor_els;
        RAST._IExpr _1763_els = _1762___mcc_h62;
        RAST._IExpr _1764_thn = _1761___mcc_h61;
        RAST._IExpr _1765_cond = _1760___mcc_h60;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("if "), (_1765_cond)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {\n")), ind), RAST.__default.IND), (_1764_thn)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")), ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("} else {\n")), ind), RAST.__default.IND), (_1763_els)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")), ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
      } else if (_source47.is_Loop) {
        Std.Wrappers._IOption<RAST._IExpr> _1766___mcc_h66 = _source47.dtor_optCond;
        RAST._IExpr _1767___mcc_h67 = _source47.dtor_underlying;
        RAST._IExpr _1768_underlying = _1767___mcc_h67;
        Std.Wrappers._IOption<RAST._IExpr> _1769_optCond = _1766___mcc_h66;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(((System.Func<Std.Wrappers._IOption<RAST._IExpr>, Dafny.ISequence<Dafny.Rune>>)((_source49) => {
          if (_source49.is_None) {
            return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("loop");
          } else {
            RAST._IExpr _1770___mcc_h200 = _source49.dtor_value;
            RAST._IExpr _1771_c = _1770___mcc_h200;
            return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("while "), (_1771_c)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(_pat_let_tv4, RAST.__default.IND)));
          }
        }))(_1769_optCond), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {\n")), ind), RAST.__default.IND), (_1768_underlying)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")), ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
      } else if (_source47.is_For) {
        Dafny.ISequence<Dafny.Rune> _1772___mcc_h70 = _source47.dtor_name;
        RAST._IExpr _1773___mcc_h71 = _source47.dtor_range;
        RAST._IExpr _1774___mcc_h72 = _source47.dtor_body;
        RAST._IExpr _1775_body = _1774___mcc_h72;
        RAST._IExpr _1776_range = _1773___mcc_h71;
        Dafny.ISequence<Dafny.Rune> _1777_name = _1772___mcc_h70;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("for "), _1777_name), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" in ")), (_1776_range)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {\n")), ind), RAST.__default.IND), (_1775_body)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")), ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
      } else if (_source47.is_Labelled) {
        Dafny.ISequence<Dafny.Rune> _1778___mcc_h76 = _source47.dtor_lbl;
        RAST._IExpr _1779___mcc_h77 = _source47.dtor_underlying;
        RAST._IExpr _1780_underlying = _1779___mcc_h77;
        Dafny.ISequence<Dafny.Rune> _1781_name = _1778___mcc_h76;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("'"), _1781_name), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(": ")), (_1780_underlying)._ToString(ind));
      } else if (_source47.is_Break) {
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1782___mcc_h80 = _source47.dtor_optLbl;
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1783_optLbl = _1782___mcc_h80;
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _source50 = _1783_optLbl;
        if (_source50.is_None) {
          return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("break;");
        } else {
          Dafny.ISequence<Dafny.Rune> _1784___mcc_h201 = _source50.dtor_value;
          Dafny.ISequence<Dafny.Rune> _1785_lbl = _1784___mcc_h201;
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("break '"), _1785_lbl), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";"));
        }
      } else if (_source47.is_Continue) {
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1786___mcc_h82 = _source47.dtor_optLbl;
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1787_optLbl = _1786___mcc_h82;
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _source51 = _1787_optLbl;
        if (_source51.is_None) {
          return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("continue;");
        } else {
          Dafny.ISequence<Dafny.Rune> _1788___mcc_h202 = _source51.dtor_value;
          Dafny.ISequence<Dafny.Rune> _1789_lbl = _1788___mcc_h202;
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("continue '"), _1789_lbl), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";"));
        }
      } else if (_source47.is_Return) {
        Std.Wrappers._IOption<RAST._IExpr> _1790___mcc_h84 = _source47.dtor_optExpr;
        Std.Wrappers._IOption<RAST._IExpr> _1791_optExpr = _1790___mcc_h84;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("return"), (((_1791_optExpr).is_Some) ? (Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" "), ((_1791_optExpr).dtor_value)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(ind, RAST.__default.IND)))) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";"));
      } else if (_source47.is_Call) {
        RAST._IExpr _1792___mcc_h86 = _source47.dtor_obj;
        Dafny.ISequence<RAST._IType> _1793___mcc_h87 = _source47.dtor_typeParameters;
        Dafny.ISequence<RAST._IExpr> _1794___mcc_h88 = _source47.dtor_arguments;
        Dafny.ISequence<RAST._IExpr> _1795_args = _1794___mcc_h88;
        Dafny.ISequence<RAST._IType> _1796_tpes = _1793___mcc_h87;
        RAST._IExpr _1797_expr = _1792___mcc_h86;
        _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>> _let_tmp_rhs45 = (this).LeftParentheses(_1797_expr);
        Dafny.ISequence<Dafny.Rune> _1798_leftP = _let_tmp_rhs45.dtor__0;
        Dafny.ISequence<Dafny.Rune> _1799_rightP = _let_tmp_rhs45.dtor__1;
        _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>> _let_tmp_rhs46 = ((System.Func<Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>>, _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>>)((_source52) => {
          if (_source52.is_None) {
            return _System.Tuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          } else {
            Dafny.ISequence<Dafny.Rune> _1800___mcc_h203 = _source52.dtor_value;
            if (object.Equals(_1800___mcc_h203, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("seq!"))) {
              return _System.Tuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("["), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("]"));
            } else if (object.Equals(_1800___mcc_h203, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("map!"))) {
              return _System.Tuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("["), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("]"));
            } else if (object.Equals(_1800___mcc_h203, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("set!"))) {
              return _System.Tuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("{"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
            } else if (object.Equals(_1800___mcc_h203, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("multiset!"))) {
              return _System.Tuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("{"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
            } else {
              return _System.Tuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>>.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            }
          }
        }))((_1797_expr).RightMostIdentifier());
        Dafny.ISequence<Dafny.Rune> _1801_leftCallP = _let_tmp_rhs46.dtor__0;
        Dafny.ISequence<Dafny.Rune> _1802_rightCallP = _let_tmp_rhs46.dtor__1;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_1798_leftP, (_1797_expr)._ToString(ind)), _1799_rightP), (((new BigInteger((_1796_tpes).Count)).Sign == 0) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")) : (Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::<"), RAST.__default.SeqToString<RAST._IType>(_1796_tpes, Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, Func<RAST._IType, Dafny.ISequence<Dafny.Rune>>>>((_1803_ind) => ((System.Func<RAST._IType, Dafny.ISequence<Dafny.Rune>>)((_1804_tpe) => {
          return (_1804_tpe)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(_1803_ind, RAST.__default.IND));
        })))(ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(">"))))), _1801_leftCallP), RAST.__default.SeqToString<RAST._IExpr>(_1795_args, Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, Func<RAST._IExpr, Dafny.ISequence<Dafny.Rune>>>>((_1805_ind) => ((System.Func<RAST._IExpr, Dafny.ISequence<Dafny.Rune>>)((_1806_arg) => {
          return (_1806_arg)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(_1805_ind, RAST.__default.IND));
        })))(ind), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "))), _1802_rightCallP);
      } else if (_source47.is_Select) {
        RAST._IExpr _1807___mcc_h92 = _source47.dtor_obj;
        Dafny.ISequence<Dafny.Rune> _1808___mcc_h93 = _source47.dtor_name;
        Dafny.ISequence<Dafny.Rune> _1809_name = _1808___mcc_h93;
        RAST._IExpr _1810_expression = _1807___mcc_h92;
        _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>> _let_tmp_rhs47 = (this).LeftParentheses(_1810_expression);
        Dafny.ISequence<Dafny.Rune> _1811_leftP = _let_tmp_rhs47.dtor__0;
        Dafny.ISequence<Dafny.Rune> _1812_rightP = _let_tmp_rhs47.dtor__1;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_1811_leftP, (_1810_expression)._ToString(ind)), _1812_rightP), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".")), _1809_name);
      } else {
        RAST._IExpr _1813___mcc_h96 = _source47.dtor_obj;
        Dafny.ISequence<Dafny.Rune> _1814___mcc_h97 = _source47.dtor_name;
        Dafny.ISequence<Dafny.Rune> _1815_name = _1814___mcc_h97;
        RAST._IExpr _1816_expression = _1813___mcc_h96;
        _System._ITuple2<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.Rune>> _let_tmp_rhs48 = (this).LeftParentheses(_1816_expression);
        Dafny.ISequence<Dafny.Rune> _1817_leftP = _let_tmp_rhs48.dtor__0;
        Dafny.ISequence<Dafny.Rune> _1818_rightP = _let_tmp_rhs48.dtor__1;
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_1817_leftP, (_1816_expression)._ToString(ind)), _1818_rightP), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::")), _1815_name);
      }
    }
    ...
    {
      RAST.Expr.TestOptimize();
      RAST.Expr.TestPrintingInfo();
      RAST.Expr.TestNoExtraSemicolonAfter();
    }
    public RAST._IPrintingInfo printingInfo { get {
      RAST._IExpr _source53 = this;
      if (_source53.is_RawExpr) {
        Dafny.ISequence<Dafny.Rune> _1819___mcc_h0 = _source53.dtor_content;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Identifier) {
        Dafny.ISequence<Dafny.Rune> _1820___mcc_h2 = _source53.dtor_name;
        return RAST.PrintingInfo.create_Precedence(BigInteger.One);
      } else if (_source53.is_Match) {
        RAST._IExpr _1821___mcc_h4 = _source53.dtor_matchee;
        Dafny.ISequence<RAST._IMatchCase> _1822___mcc_h5 = _source53.dtor_cases;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_StmtExpr) {
        RAST._IExpr _1823___mcc_h8 = _source53.dtor_stmt;
        RAST._IExpr _1824___mcc_h9 = _source53.dtor_rhs;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Block) {
        RAST._IExpr _1825___mcc_h12 = _source53.dtor_underlying;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_StructBuild) {
        Dafny.ISequence<Dafny.Rune> _1826___mcc_h14 = _source53.dtor_name;
        Dafny.ISequence<RAST._IAssignIdentifier> _1827___mcc_h15 = _source53.dtor_assignments;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Tuple) {
        Dafny.ISequence<RAST._IExpr> _1828___mcc_h18 = _source53.dtor_arguments;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_UnaryOp) {
        Dafny.ISequence<Dafny.Rune> _1829___mcc_h20 = _source53.dtor_op1;
        RAST._IExpr _1830___mcc_h21 = _source53.dtor_underlying;
        DAST.Format._IUnaryOpFormat _1831___mcc_h22 = _source53.dtor_format;
        DAST.Format._IUnaryOpFormat _1832_format = _1831___mcc_h22;
        RAST._IExpr _1833_underlying = _1830___mcc_h21;
        Dafny.ISequence<Dafny.Rune> _1834_op = _1829___mcc_h20;
        if (object.Equals(_1834_op, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("?"))) {
          return RAST.PrintingInfo.create_SuffixPrecedence(new BigInteger(5));
        } else if (object.Equals(_1834_op, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-"))) {
          ...
          return RAST.PrintingInfo.create_Precedence(new BigInteger(6));
        } else if (object.Equals(_1834_op, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&mut"))) {
          return RAST.PrintingInfo.create_Precedence(new BigInteger(6));
        } else {
          return RAST.PrintingInfo.create_UnknownPrecedence();
        }
      } else if (_source53.is_BinaryOp) {
        Dafny.ISequence<Dafny.Rune> _1835___mcc_h26 = _source53.dtor_op2;
        RAST._IExpr _1836___mcc_h27 = _source53.dtor_left;
        RAST._IExpr _1837___mcc_h28 = _source53.dtor_right;
        DAST.Format._IBinaryOpFormat _1838___mcc_h29 = _source53.dtor_format2;
        DAST.Format._IBinaryOpFormat _1839_format = _1838___mcc_h29;
        RAST._IExpr _1840_right = _1837___mcc_h28;
        RAST._IExpr _1841_left = _1836___mcc_h27;
        Dafny.ISequence<Dafny.Rune> _1842_op2 = _1835___mcc_h26;
        if (object.Equals(_1842_op2, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("*"))) {
          return RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(20), RAST.Associativity.create_LeftToRight());
        } else if (object.Equals(_1842_op2, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/"))) {
          return RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(20), RAST.Associativity.create_LeftToRight());
        } else if (object.Equals(_1842_op2, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("%"))) {
          return RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(20), RAST.Associativity.create_LeftToRight());
        } else if (object.Equals(_1842_op2, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("+"))) {
        ...
        RAST._IExpr _1843___mcc_h34 = _source53.dtor_left;
        RAST._IType _1844___mcc_h35 = _source53.dtor_tpe;
        RAST._IType _1845_tpe = _1844___mcc_h35;
        RAST._IExpr _1846_left = _1843___mcc_h34;
        ...
        Dafny.ISequence<Dafny.Rune> _1847___mcc_h38 = _source53.dtor_value;
        return RAST.PrintingInfo.create_Precedence(BigInteger.One);
      } else if (_source53.is_LiteralString) {
        Dafny.ISequence<Dafny.Rune> _1848___mcc_h40 = _source53.dtor_value;
        bool _1849___mcc_h41 = _source53.dtor_binary;
        return RAST.PrintingInfo.create_Precedence(BigInteger.One);
      } else if (_source53.is_ConversionNum) {
        RAST._IType _1850___mcc_h44 = _source53.dtor_tpe;
        RAST._IExpr _1851___mcc_h45 = _source53.dtor_underlying;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_DeclareVar) {
        RAST._IDeclareType _1852___mcc_h48 = _source53.dtor_declareType;
        Dafny.ISequence<Dafny.Rune> _1853___mcc_h49 = _source53.dtor_name;
        Std.Wrappers._IOption<RAST._IType> _1854___mcc_h50 = _source53.dtor_optType;
        Std.Wrappers._IOption<RAST._IExpr> _1855___mcc_h51 = _source53.dtor_optRhs;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_AssignVar) {
        Dafny.ISequence<Dafny.Rune> _1856___mcc_h56 = _source53.dtor_name;
        RAST._IExpr _1857___mcc_h57 = _source53.dtor_rhs;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_IfExpr) {
        RAST._IExpr _1858___mcc_h60 = _source53.dtor_cond;
        RAST._IExpr _1859___mcc_h61 = _source53.dtor_thn;
        RAST._IExpr _1860___mcc_h62 = _source53.dtor_els;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Loop) {
        Std.Wrappers._IOption<RAST._IExpr> _1861___mcc_h66 = _source53.dtor_optCond;
        RAST._IExpr _1862___mcc_h67 = _source53.dtor_underlying;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_For) {
        Dafny.ISequence<Dafny.Rune> _1863___mcc_h70 = _source53.dtor_name;
        RAST._IExpr _1864___mcc_h71 = _source53.dtor_range;
        RAST._IExpr _1865___mcc_h72 = _source53.dtor_body;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Labelled) {
        Dafny.ISequence<Dafny.Rune> _1866___mcc_h76 = _source53.dtor_lbl;
        RAST._IExpr _1867___mcc_h77 = _source53.dtor_underlying;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Break) {
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1868___mcc_h80 = _source53.dtor_optLbl;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Continue) {
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.Rune>> _1869___mcc_h82 = _source53.dtor_optLbl;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Return) {
        Std.Wrappers._IOption<RAST._IExpr> _1870___mcc_h84 = _source53.dtor_optExpr;
        return RAST.PrintingInfo.create_UnknownPrecedence();
      } else if (_source53.is_Call) {
        RAST._IExpr _1871___mcc_h86 = _source53.dtor_obj;
        Dafny.ISequence<RAST._IType> _1872___mcc_h87 = _source53.dtor_typeParameters;
        Dafny.ISequence<RAST._IExpr> _1873___mcc_h88 = _source53.dtor_arguments;
        ...
        RAST._IExpr _1874___mcc_h92 = _source53.dtor_obj;
        Dafny.ISequence<Dafny.Rune> _1875___mcc_h93 = _source53.dtor_name;
        Dafny.ISequence<Dafny.Rune> _1876_name = _1875___mcc_h93;
        RAST._IExpr _1877_underlying = _1874___mcc_h92;
        return RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(2), RAST.Associativity.create_LeftToRight());
      } else {
        RAST._IExpr _1878___mcc_h96 = _source53.dtor_obj;
        Dafny.ISequence<Dafny.Rune> _1879___mcc_h97 = _source53.dtor_name;
        Dafny.ISequence<Dafny.Rune> _1880_name = _1879___mcc_h97;
        RAST._IExpr _1881_underlying = _1878___mcc_h96;
        return RAST.PrintingInfo.create_PrecedenceAssociativity(new BigInteger(2), RAST.Associativity.create_LeftToRight());
      }
    } }
  }
  ...
  public class Fn : _IFn {
    ...
    public Dafny.ISequence<Dafny.Rune> _ToString(Dafny.ISequence<Dafny.Rune> ind) {
      ...
      return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("fn "), (this).dtor_name), RAST.TypeParam.ToStringMultiple((this).dtor_typeParams, ind)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), RAST.__default.SeqToString<RAST._IFormal>((this).dtor_formals, Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, Func<RAST._IFormal, Dafny.ISequence<Dafny.Rune>>>>((_1882_ind) => ((System.Func<RAST._IFormal, Dafny.ISequence<Dafny.Rune>>)((_1883_formal) => {
        return (_1883_formal)._ToString(_1882_ind);
        ...
        if (_source54.is_None) {
          ...
          RAST._IType _1884___mcc_h0 = _source54.dtor_value;
          RAST._IType _1885_t = _1884___mcc_h0;
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" -> "), (_1885_t)._ToString(_pat_let_tv5));
        }
        ...
        if (_source55.is_None) {
          ...
          RAST._IExpr _1886___mcc_h2 = _source55.dtor_value;
          RAST._IExpr _1887_body = _1886___mcc_h2;
          return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {\n"), _pat_let_tv6), RAST.__default.IND), (_1887_body)._ToString(Dafny.Sequence<Dafny.Rune>.Concat(_pat_let_tv7, RAST.__default.IND))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")), _pat_let_tv8), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
        }
      }))((this).dtor_body));
    }
  }
