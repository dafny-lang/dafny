        ...
        DAST._IDatatypeType _3993_datatypeType = _3984___mcc_h9;
        {
          ...
          for (BigInteger _3998_i = BigInteger.Zero; _3998_i < _hi34; _3998_i++) {
            ...
            if (_3990_isCo) {
              ...
              Dafny.ISequence<Dafny.Rune> _4006_wasAssigned;
              _4006_wasAssigned = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::LazyFieldWrapper(::dafny_runtime::Lazy::new(::std::boxed::Box::new({\n"), _4004_allReadCloned), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("move || (")), (_4001_recursiveGen)._ToString(DCOMP.__default.IND)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")})))"));
              _3997_assignments = Dafny.Sequence<RAST._IAssignIdentifier>.Concat(_3997_assignments, Dafny.Sequence<RAST._IAssignIdentifier>.FromElements(RAST.AssignIdentifier.create(_3999_name, RAST.Expr.create_RawExpr(_4006_wasAssigned))));
            } else {
