      ...
      if (_source171.is_Literal) {
          ...
          for (BigInteger _3923_i = BigInteger.Zero; _3923_i < _hi34; _3923_i++) {
            ...
            if (_3915_isCo) {
              ...
              while (!(_3928_recIdents).Equals(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements())) {
                ...
                throw new System.Exception("assign-such-that search produced no value (line 3134)");
              ...
              Dafny.ISequence<Dafny.Rune> _3931_assigned;
              _3931_assigned = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::LazyFieldWrapper(::dafny_runtime::Lazy::new(::std::boxed::Box::new({\n"), _3929_allReadCloned), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("move || (")), (_3926_recursiveGen)._ToString(DCOMP.__default.IND)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")})))"));
              _3922_assignments = Dafny.Sequence<RAST._IAssignIdentifier>.Concat(_3922_assignments, Dafny.Sequence<RAST._IAssignIdentifier>.FromElements(RAST.AssignIdentifier.create(_3924_name, RAST.Expr.create_RawExpr(_3931_assigned))));
            } else {
        ...
        Dafny.ISequence<DAST._IFormal> _4947_paramsDafny = _4942___mcc_h258;
        {
          ...
          while (!(_4955_recIdents).Equals(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements())) {
            ...
            throw new System.Exception("assign-such-that search produced no value (line 3592)");
