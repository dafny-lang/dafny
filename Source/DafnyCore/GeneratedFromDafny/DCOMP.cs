...
namespace DCOMP {
  ...
  return (_12_s);
                ...
                _14_x = RAST.ModDecl.create_ImplDecl(RAST.Impl.create_ImplFor(rTypeParamsDecls, _10_fullTraitPath, RAST.Type.create_TypeApp(_0_genSelfPath, rTypeParams), _9_body));
