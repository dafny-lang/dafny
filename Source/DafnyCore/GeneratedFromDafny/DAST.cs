...
namespace DAST {
  ...
  public class Name : _IName {
    public readonly Dafny.ISequence<Dafny.Rune> _i_dafny__name;
    public Name(Dafny.ISequence<Dafny.Rune> dafny__name) {
      this._i_dafny__name = dafny__name;
    }
    ...
    public override bool Equals(object other) {
      ...
      return oth != null && object.Equals(this._i_dafny__name, oth._i_dafny__name);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_dafny__name));
      return (int) hash;
    }
    public override string ToString() {
      string s = "DAST.Name.Name";
      s += "(";
      s += this._i_dafny__name.ToVerbatimString(true);
      s += ")";
      return s;
    }
  ...
  public class Module : _IModule {
    ...
    public readonly Std.Wrappers._IOption<Dafny.ISequence<DAST._IModuleItem>> _i_body;
    public Module(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._IAttribute> attributes, Std.Wrappers._IOption<Dafny.ISequence<DAST._IModuleItem>> body) {
      this._i_name = name;
    ...
    public _IModule DowncastClone() {
      ...
      return new Module(_i_name, _i_attributes, _i_body);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Module;
      return oth != null && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_attributes, oth._i_attributes) && object.Equals(this._i_body, oth._i_body);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
    ...
    private static readonly DAST._IModule theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<DAST._IAttribute>.Empty, Std.Wrappers.Option<Dafny.ISequence<DAST._IModuleItem>>.Default());
    ...
    public static _IModule create(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._IAttribute> attributes, Std.Wrappers._IOption<Dafny.ISequence<DAST._IModuleItem>> body) {
      return new Module(name, attributes, body);
    }
    public static _IModule create_Module(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._IAttribute> attributes, Std.Wrappers._IOption<Dafny.ISequence<DAST._IModuleItem>> body) {
      return create(name, attributes, body);
    }
  ...
  public abstract class Type : _IType {
    ...
    public DAST._IResolvedType dtor_resolved {
      get {
        var d = this;
        return ((Type_UserDefined)d)._i_resolved;
      }
    }
  ...
  public class Type_UserDefined : Type {
    ...
    public override _IType DowncastClone() {
      ...
      return new Type_UserDefined(_i_resolved);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Type_UserDefined;
      return oth != null && object.Equals(this._i_resolved, oth._i_resolved);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
  ...
  public class TypeArgDecl : _ITypeArgDecl {
    public readonly Dafny.ISequence<Dafny.Rune> _i_name;
    public readonly Dafny.ISequence<DAST._ITypeArgBound> _i_bounds;
    public TypeArgDecl(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._ITypeArgBound> bounds) {
      this._i_name = name;
      this._i_bounds = bounds;
    }
    public _ITypeArgDecl DowncastClone() {
      if (this is _ITypeArgDecl dt) { return dt; }
      return new TypeArgDecl(_i_name, _i_bounds);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.TypeArgDecl;
      return oth != null && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_bounds, oth._i_bounds);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_name));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_bounds));
      return (int) hash;
    }
    public override string ToString() {
      ...
      s += Dafny.Helpers.ToString(this._i_name);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_bounds);
      s += ")";
      return s;
    }
  ...
  public abstract class TypeArgBound : _ITypeArgBound {
    ...
    public static System.Collections.Generic.IEnumerable<_ITypeArgBound> AllSingletonConstructors {
      get {
        yield return TypeArgBound.create_SupportsEquality();
        yield return TypeArgBound.create_SupportsDefault();
      }
    }
  ...
  public class Attribute : _IAttribute {
    public readonly Dafny.ISequence<Dafny.Rune> _i_name;
    public readonly Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _i_args;
    ...
    public _IAttribute DowncastClone() {
      ...
      return new Attribute(_i_name, _i_args);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Attribute;
      return oth != null && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_args, oth._i_args);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
  ...
  public class NewtypeType : _INewtypeType {
    ...
    public _INewtypeType DowncastClone() {
      ...
      return new NewtypeType(_i_baseType, _i_range, _i_erase);
    }
    public override bool Equals(object other) {
  ...
  public abstract class ResolvedTypeBase : _IResolvedTypeBase {
    ...
    public DAST._IType dtor_baseType {
      get {
        var d = this;
        return ((ResolvedTypeBase_Newtype)d)._i_baseType;
      }
    }
    public DAST._INewtypeRange dtor_range {
      get {
        var d = this;
        return ((ResolvedTypeBase_Newtype)d)._i_range;
      }
    }
    public bool dtor_erase {
      get {
        var d = this;
        return ((ResolvedTypeBase_Newtype)d)._i_erase;
      }
    }
  ...
  public class ResolvedTypeBase_Newtype : ResolvedTypeBase {
    ...
    public override _IResolvedTypeBase DowncastClone() {
      if (this is _IResolvedTypeBase dt) { return dt; }
      return new ResolvedTypeBase_Newtype(_i_baseType, _i_range, _i_erase);
    }
    public override bool Equals(object other) {
  ...
  public class ResolvedType : _IResolvedType {
    ...
    public readonly DAST._IResolvedTypeBase _i_kind;
    public readonly Dafny.ISequence<DAST._IAttribute> _i_attributes;
    public readonly Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _i_properMethods;
    public readonly Dafny.ISequence<DAST._IType> _i_extendedTypes;
    public ResolvedType(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> path, Dafny.ISequence<DAST._IType> typeArgs, DAST._IResolvedTypeBase kind, Dafny.ISequence<DAST._IAttribute> attributes, Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> properMethods, Dafny.ISequence<DAST._IType> extendedTypes) {
      ...
      this._i_kind = kind;
      this._i_attributes = attributes;
      this._i_properMethods = properMethods;
      this._i_extendedTypes = extendedTypes;
    }
    public _IResolvedType DowncastClone() {
      if (this is _IResolvedType dt) { return dt; }
      return new ResolvedType(_i_path, _i_typeArgs, _i_kind, _i_attributes, _i_properMethods, _i_extendedTypes);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.ResolvedType;
      return oth != null && object.Equals(this._i_path, oth._i_path) && object.Equals(this._i_typeArgs, oth._i_typeArgs) && object.Equals(this._i_kind, oth._i_kind) && object.Equals(this._i_attributes, oth._i_attributes) && object.Equals(this._i_properMethods, oth._i_properMethods) && object.Equals(this._i_extendedTypes, oth._i_extendedTypes);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      ...
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_kind));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_attributes));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_properMethods));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_extendedTypes));
      return (int) hash;
    }
    public override string ToString() {
      ...
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_kind);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_attributes);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_properMethods);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_extendedTypes);
      s += ")";
      return s;
    }
    ...
    public Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> dtor_properMethods {
      get {
        return this._i_properMethods;
      }
    }
    public Dafny.ISequence<DAST._IType> dtor_extendedTypes {
      get {
        return this._i_extendedTypes;
      }
    }
  }
  ...
  public class Ident : _IIdent {
    ...
    public override string ToString() {
      ...
      s += "(";
      s += Dafny.Helpers.ToString(this._i_id);
      s += ")";
      return s;
    }
    private static readonly Dafny.ISequence<Dafny.Rune> theDefault = Dafny.Sequence<Dafny.Rune>.Empty;
  ...
  public class Class : _IClass {
    ...
    public readonly Dafny.ISequence<DAST._IAttribute> _i_attributes;
    public Class(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<Dafny.Rune> enclosingModule, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IType> superClasses, Dafny.ISequence<DAST._IField> fields, Dafny.ISequence<DAST._IMethod> body, Dafny.ISequence<DAST._IAttribute> attributes) {
      this._i_name = name;
    ...
    public _IClass DowncastClone() {
      ...
      return new Class(_i_name, _i_enclosingModule, _i_typeParams, _i_superClasses, _i_fields, _i_body, _i_attributes);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Class;
      return oth != null && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_enclosingModule, oth._i_enclosingModule) && object.Equals(this._i_typeParams, oth._i_typeParams) && object.Equals(this._i_superClasses, oth._i_superClasses) && object.Equals(this._i_fields, oth._i_fields) && object.Equals(this._i_body, oth._i_body) && object.Equals(this._i_attributes, oth._i_attributes);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
    ...
    private static readonly DAST._IClass theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<DAST._ITypeArgDecl>.Empty, Dafny.Sequence<DAST._IType>.Empty, Dafny.Sequence<DAST._IField>.Empty, Dafny.Sequence<DAST._IMethod>.Empty, Dafny.Sequence<DAST._IAttribute>.Empty);
    ...
    public static _IClass create(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<Dafny.Rune> enclosingModule, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IType> superClasses, Dafny.ISequence<DAST._IField> fields, Dafny.ISequence<DAST._IMethod> body, Dafny.ISequence<DAST._IAttribute> attributes) {
      return new Class(name, enclosingModule, typeParams, superClasses, fields, body, attributes);
    }
    public static _IClass create_Class(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<Dafny.Rune> enclosingModule, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IType> superClasses, Dafny.ISequence<DAST._IField> fields, Dafny.ISequence<DAST._IMethod> body, Dafny.ISequence<DAST._IAttribute> attributes) {
  ...
  public class Trait : _ITrait {
    public readonly Dafny.ISequence<Dafny.Rune> _i_name;
    public readonly Dafny.ISequence<DAST._ITypeArgDecl> _i_typeParams;
    public readonly Dafny.ISequence<DAST._IType> _i_parents;
    public readonly Dafny.ISequence<DAST._IMethod> _i_body;
    public readonly Dafny.ISequence<DAST._IAttribute> _i_attributes;
    public Trait(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IType> parents, Dafny.ISequence<DAST._IMethod> body, Dafny.ISequence<DAST._IAttribute> attributes) {
      this._i_name = name;
      this._i_typeParams = typeParams;
      this._i_parents = parents;
      this._i_body = body;
      this._i_attributes = attributes;
    }
    public _ITrait DowncastClone() {
      if (this is _ITrait dt) { return dt; }
      return new Trait(_i_name, _i_typeParams, _i_parents, _i_body, _i_attributes);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Trait;
      return oth != null && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_typeParams, oth._i_typeParams) && object.Equals(this._i_parents, oth._i_parents) && object.Equals(this._i_body, oth._i_body) && object.Equals(this._i_attributes, oth._i_attributes);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_name));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_typeParams));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_parents));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_body));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_attributes));
      return (int) hash;
    }
    public override string ToString() {
      ...
      s += Dafny.Helpers.ToString(this._i_typeParams);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_parents);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_body);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_attributes);
    ...
    private static readonly DAST._ITrait theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<DAST._ITypeArgDecl>.Empty, Dafny.Sequence<DAST._IType>.Empty, Dafny.Sequence<DAST._IMethod>.Empty, Dafny.Sequence<DAST._IAttribute>.Empty);
    ...
    public static _ITrait create(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IType> parents, Dafny.ISequence<DAST._IMethod> body, Dafny.ISequence<DAST._IAttribute> attributes) {
      return new Trait(name, typeParams, parents, body, attributes);
    }
    public static _ITrait create_Trait(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IType> parents, Dafny.ISequence<DAST._IMethod> body, Dafny.ISequence<DAST._IAttribute> attributes) {
      return create(name, typeParams, parents, body, attributes);
    }
  ...
  public class Datatype : _IDatatype {
    ...
    public readonly Dafny.ISequence<DAST._IAttribute> _i_attributes;
    public Datatype(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<Dafny.Rune> enclosingModule, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IDatatypeCtor> ctors, Dafny.ISequence<DAST._IMethod> body, bool isCo, Dafny.ISequence<DAST._IAttribute> attributes) {
      this._i_name = name;
      this._i_enclosingModule = enclosingModule;
      this._i_typeParams = typeParams;
      this._i_ctors = ctors;
    ...
    public _IDatatype DowncastClone() {
      ...
      return new Datatype(_i_name, _i_enclosingModule, _i_typeParams, _i_ctors, _i_body, _i_isCo, _i_attributes);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Datatype;
      return oth != null && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_enclosingModule, oth._i_enclosingModule) && object.Equals(this._i_typeParams, oth._i_typeParams) && object.Equals(this._i_ctors, oth._i_ctors) && object.Equals(this._i_body, oth._i_body) && this._i_isCo == oth._i_isCo && object.Equals(this._i_attributes, oth._i_attributes);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
    ...
    private static readonly DAST._IDatatype theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<DAST._ITypeArgDecl>.Empty, Dafny.Sequence<DAST._IDatatypeCtor>.Empty, Dafny.Sequence<DAST._IMethod>.Empty, false, Dafny.Sequence<DAST._IAttribute>.Empty);
    ...
    public static _IDatatype create(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<Dafny.Rune> enclosingModule, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IDatatypeCtor> ctors, Dafny.ISequence<DAST._IMethod> body, bool isCo, Dafny.ISequence<DAST._IAttribute> attributes) {
      return new Datatype(name, enclosingModule, typeParams, ctors, body, isCo, attributes);
    }
    public static _IDatatype create_Datatype(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<Dafny.Rune> enclosingModule, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IDatatypeCtor> ctors, Dafny.ISequence<DAST._IMethod> body, bool isCo, Dafny.ISequence<DAST._IAttribute> attributes) {
  ...
  public class Newtype : _INewtype {
    ...
    public readonly DAST._INewtypeRange _i_range;
    public readonly Std.Wrappers._IOption<DAST._INewtypeConstraint> _i_constraint;
    ...
    public readonly Dafny.ISequence<DAST._IAttribute> _i_attributes;
    public Newtype(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, DAST._IType @base, DAST._INewtypeRange range, Std.Wrappers._IOption<DAST._INewtypeConstraint> constraint, Dafny.ISequence<DAST._IStatement> witnessStmts, Std.Wrappers._IOption<DAST._IExpression> witnessExpr, Dafny.ISequence<DAST._IAttribute> attributes) {
      this._i_name = name;
      this._i_typeParams = typeParams;
      this._i_base = @base;
      this._i_range = range;
      this._i_constraint = constraint;
    ...
    public _INewtype DowncastClone() {
      ...
      return new Newtype(_i_name, _i_typeParams, _i_base, _i_range, _i_constraint, _i_witnessStmts, _i_witnessExpr, _i_attributes);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Newtype;
      return oth != null && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_typeParams, oth._i_typeParams) && object.Equals(this._i_base, oth._i_base) && object.Equals(this._i_range, oth._i_range) && object.Equals(this._i_constraint, oth._i_constraint) && object.Equals(this._i_witnessStmts, oth._i_witnessStmts) && object.Equals(this._i_witnessExpr, oth._i_witnessExpr) && object.Equals(this._i_attributes, oth._i_attributes);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      ...
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_range));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_constraint));
    ...
    public override string ToString() {
      ...
      s += Dafny.Helpers.ToString(this._i_range);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_constraint);
      s += ", ";
    ...
    private static readonly DAST._INewtype theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, Dafny.Sequence<DAST._ITypeArgDecl>.Empty, DAST.Type.Default(), DAST.NewtypeRange.Default(), Std.Wrappers.Option<DAST._INewtypeConstraint>.Default(), Dafny.Sequence<DAST._IStatement>.Empty, Std.Wrappers.Option<DAST._IExpression>.Default(), Dafny.Sequence<DAST._IAttribute>.Empty);
    ...
    public static _INewtype create(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, DAST._IType @base, DAST._INewtypeRange range, Std.Wrappers._IOption<DAST._INewtypeConstraint> constraint, Dafny.ISequence<DAST._IStatement> witnessStmts, Std.Wrappers._IOption<DAST._IExpression> witnessExpr, Dafny.ISequence<DAST._IAttribute> attributes) {
      return new Newtype(name, typeParams, @base, range, constraint, witnessStmts, witnessExpr, attributes);
    }
    public static _INewtype create_Newtype(Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, DAST._IType @base, DAST._INewtypeRange range, Std.Wrappers._IOption<DAST._INewtypeConstraint> constraint, Dafny.ISequence<DAST._IStatement> witnessStmts, Std.Wrappers._IOption<DAST._IExpression> witnessExpr, Dafny.ISequence<DAST._IAttribute> attributes) {
      return create(name, typeParams, @base, range, constraint, witnessStmts, witnessExpr, attributes);
    }
  ...
  public class NewtypeConstraint : _INewtypeConstraint {
    public readonly DAST._IFormal _i_variable;
    public readonly Dafny.ISequence<DAST._IStatement> _i_constraintStmts;
    public NewtypeConstraint(DAST._IFormal variable, Dafny.ISequence<DAST._IStatement> constraintStmts) {
      this._i_variable = variable;
      this._i_constraintStmts = constraintStmts;
    }
    public _INewtypeConstraint DowncastClone() {
      if (this is _INewtypeConstraint dt) { return dt; }
      return new NewtypeConstraint(_i_variable, _i_constraintStmts);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.NewtypeConstraint;
      return oth != null && object.Equals(this._i_variable, oth._i_variable) && object.Equals(this._i_constraintStmts, oth._i_constraintStmts);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_variable));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_constraintStmts));
      return (int) hash;
    }
    public override string ToString() {
      string s = "DAST.NewtypeConstraint.NewtypeConstraint";
      s += "(";
      s += Dafny.Helpers.ToString(this._i_variable);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_constraintStmts);
      s += ")";
      return s;
    }
  ...
  public class Formal : _IFormal {
    ...
    public _IFormal DowncastClone() {
      ...
      return new Formal(_i_name, _i_typ, _i_attributes);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Formal;
      return oth != null && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_typ, oth._i_typ) && object.Equals(this._i_attributes, oth._i_attributes);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
  ...
  public class Method : _IMethod {
    ...
    public readonly bool _i_outVarsAreUninitFieldsToAssign;
    public readonly bool _i_wasFunction;
    ...
    public Method(bool isStatic, bool hasBody, bool outVarsAreUninitFieldsToAssign, bool wasFunction, Std.Wrappers._IOption<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>> overridingPath, Dafny.ISequence<Dafny.Rune> name, Dafny.ISequence<DAST._ITypeArgDecl> typeParams, Dafny.ISequence<DAST._IFormal> @params, Dafny.ISequence<DAST._IStatement> body, Dafny.ISequence<DAST._IType> outTypes, Std.Wrappers._IOption<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>> outVars) {
      ...
      this._i_outVarsAreUninitFieldsToAssign = outVarsAreUninitFieldsToAssign;
      this._i_wasFunction = wasFunction;
    ...
    public _IMethod DowncastClone() {
      ...
      return new Method(_i_isStatic, _i_hasBody, _i_outVarsAreUninitFieldsToAssign, _i_wasFunction, _i_overridingPath, _i_name, _i_typeParams, _i_params, _i_body, _i_outTypes, _i_outVars);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Method;
      return oth != null && this._i_isStatic == oth._i_isStatic && this._i_hasBody == oth._i_hasBody && this._i_outVarsAreUninitFieldsToAssign == oth._i_outVarsAreUninitFieldsToAssign && this._i_wasFunction == oth._i_wasFunction && object.Equals(this._i_overridingPath, oth._i_overridingPath) && object.Equals(this._i_name, oth._i_name) && object.Equals(this._i_typeParams, oth._i_typeParams) && object.Equals(this._i_params, oth._i_params) && object.Equals(this._i_body, oth._i_body) && object.Equals(this._i_outTypes, oth._i_outTypes) && object.Equals(this._i_outVars, oth._i_outVars);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      ...
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_outVarsAreUninitFieldsToAssign));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_wasFunction));
    ...
    public override string ToString() {
      ...
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_outVarsAreUninitFieldsToAssign);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_wasFunction);
      s += ", ";
    ...
    public bool dtor_outVarsAreUninitFieldsToAssign {
      get {
        return this._i_outVarsAreUninitFieldsToAssign;
      }
    }
    public bool dtor_wasFunction {
      get {
        return this._i_wasFunction;
      }
    }
  ...
  public class CallSignature : _ICallSignature {
    public readonly Dafny.ISequence<DAST._IFormal> _i_parameters;
    public CallSignature(Dafny.ISequence<DAST._IFormal> parameters) {
      this._i_parameters = parameters;
    }
    ...
    public override bool Equals(object other) {
      ...
      return oth != null && object.Equals(this._i_parameters, oth._i_parameters);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_parameters));
      return (int) hash;
    }
    public override string ToString() {
      string s = "DAST.CallSignature.CallSignature";
      s += "(";
      s += Dafny.Helpers.ToString(this._i_parameters);
      s += ")";
      return s;
    }
  ...
  public abstract class CallName : _ICallName {
    ...
    public Dafny.ISequence<Dafny.Rune> dtor_name {
      get {
        var d = this;
        return ((CallName_CallName)d)._i_name;
      }
    }
    ...
    public Dafny.ISequence<DAST._IFormal> dtor_signature {
      get {
        var d = this;
        return ((CallName_CallName)d)._i_signature;
      }
    }
  ...
  public abstract class Statement : _IStatement {
    ...
    public Dafny.ISequence<DAST._IFormal> dtor_fields {
      get {
        var d = this;
        return ((Statement_ConstructorNewSeparator)d)._i_fields;
      }
    }
  ...
  public class Statement_Foreach : Statement {
    ...
    public override string ToString() {
      ...
      s += "(";
      s += Dafny.Helpers.ToString(this._i_boundName);
      s += ", ";
  ...
  public class Statement_ConstructorNewSeparator : Statement {
    public readonly Dafny.ISequence<DAST._IFormal> _i_fields;
    public Statement_ConstructorNewSeparator(Dafny.ISequence<DAST._IFormal> fields) : base() {
      this._i_fields = fields;
    }
    public override _IStatement DowncastClone() {
      if (this is _IStatement dt) { return dt; }
      return new Statement_ConstructorNewSeparator(_i_fields);
    }
    public override bool Equals(object other) {
  ...
  public abstract class AssignLhs : _IAssignLhs {
    ...
    public Dafny.ISequence<Dafny.Rune> dtor_ident {
      get {
        var d = this;
        return ((AssignLhs_Ident)d)._i_ident;
      }
    }
    public DAST._IExpression dtor_expr {
      get {
  ...
  public class AssignLhs_Ident : AssignLhs {
    public readonly Dafny.ISequence<Dafny.Rune> _i_ident;
    public AssignLhs_Ident(Dafny.ISequence<Dafny.Rune> ident) : base() {
      this._i_ident = ident;
    }
    public override _IAssignLhs DowncastClone() {
      if (this is _IAssignLhs dt) { return dt; }
      return new AssignLhs_Ident(_i_ident);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.AssignLhs_Ident;
      return oth != null && object.Equals(this._i_ident, oth._i_ident);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_ident));
      return (int) hash;
    }
    public override string ToString() {
      string s = "DAST.AssignLhs.Ident";
      s += "(";
      s += Dafny.Helpers.ToString(this._i_ident);
      s += ")";
      return s;
    }
  }
  public class AssignLhs_Select : AssignLhs {
    ...
    public override string ToString() {
      ...
      s += Dafny.Helpers.ToString(this._i_expr);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_field);
      s += ")";
      return s;
    }
  }
  ...
  public class BinOp_Eq : BinOp {
    ...
    public override _IBinOp DowncastClone() {
      ...
      return new BinOp_Eq(_i_referential);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.BinOp_Eq;
      return oth != null && this._i_referential == oth._i_referential;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
  ...
  public abstract class Expression : _IExpression {
    ...
    public Dafny.ISequence<DAST._IType> dtor_typeArgs {
      get {
        var d = this;
        if (d is Expression_Companion) { return ((Expression_Companion)d)._i_typeArgs; }
    ...
    public Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> dtor_path {
      get {
        var d = this;
        return ((Expression_New)d)._i_path;
      }
    }
    public Dafny.ISequence<DAST._IExpression> dtor_args {
      get {
    ...
    public Dafny.ISequence<DAST._IExpression> dtor_dims {
      get {
        var d = this;
        return ((Expression_NewUninitArray)d)._i_dims;
      }
    }
    public DAST._IType dtor_typ {
      get {
        var d = this;
        if (d is Expression_NewUninitArray) { return ((Expression_NewUninitArray)d)._i_typ; }
        if (d is Expression_FinalizeNewArray) { return ((Expression_FinalizeNewArray)d)._i_typ; }
    ...
    public DAST._IExpression dtor_value {
      get {
        var d = this;
        if (d is Expression_ArrayIndexToInt) { return ((Expression_ArrayIndexToInt)d)._i_value; }
        if (d is Expression_FinalizeNewArray) { return ((Expression_FinalizeNewArray)d)._i_value; }
    ...
    public DAST._IResolvedType dtor_datatypeType {
      get {
        var d = this;
        return ((Expression_DatatypeValue)d)._i_datatypeType;
      }
    }
    ...
    public DAST._IType dtor_elemType {
      get {
        var d = this;
        if (d is Expression_SetBuilder) { return ((Expression_SetBuilder)d)._i_elemType; }
        return ((Expression_Quantifier)d)._i_elemType;
      }
    }
    ...
    public DAST._IType dtor_exprType {
      get {
        var d = this;
        return ((Expression_ArrayLen)d)._i_exprType;
      }
    }
    ...
    public bool dtor_native {
      get {
        var d = this;
        return ((Expression_ArrayLen)d)._i_native;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_field {
      get {
    ...
    public DAST._IType dtor_fieldType {
      get {
        var d = this;
        if (d is Expression_Select) { return ((Expression_Select)d)._i_fieldType; }
        return ((Expression_TupleSelect)d)._i_fieldType;
      }
    }
    public bool dtor_isStatic {
      get {
    ...
    public DAST._IExpression dtor_of {
      get {
        ...
        if (d is Expression_MapBoundedPool) { return ((Expression_MapBoundedPool)d)._i_of; }
    ...
    public bool dtor_up {
      get {
        var d = this;
        if (d is Expression_IntRange) { return ((Expression_IntRange)d)._i_up; }
        return ((Expression_UnboundedIntRange)d)._i_up;
      }
    }
    public DAST._IExpression dtor_start {
      get {
        var d = this;
        return ((Expression_UnboundedIntRange)d)._i_start;
      }
    }
    public DAST._IExpression dtor_collection {
      get {
        var d = this;
        return ((Expression_Quantifier)d)._i_collection;
      }
    }
    public bool dtor_is__forall {
      get {
        var d = this;
        return ((Expression_Quantifier)d)._i_is__forall;
      }
    }
    public DAST._IExpression dtor_lambda {
      get {
        var d = this;
        return ((Expression_Quantifier)d)._i_lambda;
      }
    }
  ...
  public class Expression_Companion : Expression {
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_Companion(_i_a0, _i_typeArgs);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_Companion;
      return oth != null && object.Equals(this._i_a0, oth._i_a0) && object.Equals(this._i_typeArgs, oth._i_typeArgs);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 2;
  ...
  public class Expression_NewUninitArray : Expression {
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_NewUninitArray(_i_dims, _i_typ);
    }
    public override bool Equals(object other) {
  ...
  public class Expression_ArrayIndexToInt : Expression {
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_ArrayIndexToInt(_i_value);
    }
    public override bool Equals(object other) {
  ...
  public class Expression_FinalizeNewArray : Expression {
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_FinalizeNewArray(_i_value, _i_typ);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_FinalizeNewArray;
      return oth != null && object.Equals(this._i_value, oth._i_value) && object.Equals(this._i_typ, oth._i_typ);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 7;
  ...
  public class Expression_DatatypeValue : Expression {
    public readonly DAST._IResolvedType _i_datatypeType;
    public readonly Dafny.ISequence<DAST._IType> _i_typeArgs;
    ...
    public Expression_DatatypeValue(DAST._IResolvedType datatypeType, Dafny.ISequence<DAST._IType> typeArgs, Dafny.ISequence<Dafny.Rune> variant, bool isCo, Dafny.ISequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, DAST._IExpression>> contents) : base() {
      this._i_datatypeType = datatypeType;
      this._i_typeArgs = typeArgs;
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_DatatypeValue(_i_datatypeType, _i_typeArgs, _i_variant, _i_isCo, _i_contents);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_DatatypeValue;
      return oth != null && object.Equals(this._i_datatypeType, oth._i_datatypeType) && object.Equals(this._i_typeArgs, oth._i_typeArgs) && object.Equals(this._i_variant, oth._i_variant) && this._i_isCo == oth._i_isCo && object.Equals(this._i_contents, oth._i_contents);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 8;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_datatypeType));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_typeArgs));
    ...
    public override string ToString() {
      ...
      s += "(";
      s += Dafny.Helpers.ToString(this._i_datatypeType);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_typeArgs);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_variant);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_isCo);
      s += ", ";
  ...
  public class Expression_ArrayLen : Expression {
    public readonly DAST._IExpression _i_expr;
    public readonly DAST._IType _i_exprType;
    public readonly BigInteger _i_dim;
    public readonly bool _i_native;
    public Expression_ArrayLen(DAST._IExpression expr, DAST._IType exprType, BigInteger dim, bool native) : base() {
      this._i_expr = expr;
      this._i_exprType = exprType;
      this._i_dim = dim;
      this._i_native = native;
    }
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_ArrayLen(_i_expr, _i_exprType, _i_dim, _i_native);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_ArrayLen;
      return oth != null && object.Equals(this._i_expr, oth._i_expr) && object.Equals(this._i_exprType, oth._i_exprType) && this._i_dim == oth._i_dim && this._i_native == oth._i_native;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 24;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_expr));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_exprType));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_dim));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_native));
      return (int) hash;
    }
    public override string ToString() {
      ...
      s += Dafny.Helpers.ToString(this._i_expr);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_exprType);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_dim);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_native);
      s += ")";
      return s;
    }
  }
  ...
  public class Expression_Select : Expression {
    ...
    public readonly DAST._IType _i_fieldType;
    public Expression_Select(DAST._IExpression expr, Dafny.ISequence<Dafny.Rune> field, bool isConstant, bool onDatatype, DAST._IType fieldType) : base() {
      ...
      this._i_fieldType = fieldType;
    }
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_Select(_i_expr, _i_field, _i_isConstant, _i_onDatatype, _i_fieldType);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_Select;
      return oth != null && object.Equals(this._i_expr, oth._i_expr) && object.Equals(this._i_field, oth._i_field) && this._i_isConstant == oth._i_isConstant && this._i_onDatatype == oth._i_onDatatype && object.Equals(this._i_fieldType, oth._i_fieldType);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 27;
      ...
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_fieldType));
      return (int) hash;
    }
    public override string ToString() {
      ...
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_fieldType);
      s += ")";
      return s;
    }
  }
  ...
  public class Expression_TupleSelect : Expression {
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_TupleSelect(_i_expr, _i_index, _i_fieldType);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_TupleSelect;
      return oth != null && object.Equals(this._i_expr, oth._i_expr) && this._i_index == oth._i_index && object.Equals(this._i_fieldType, oth._i_fieldType);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 31;
  ...
  public class Expression_MapBoundedPool : Expression {
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_MapBoundedPool(_i_of);
    }
    public override bool Equals(object other) {
  ...
  public class Expression_IntRange : Expression {
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_IntRange(_i_lo, _i_hi, _i_up);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_IntRange;
      return oth != null && object.Equals(this._i_lo, oth._i_lo) && object.Equals(this._i_hi, oth._i_hi) && this._i_up == oth._i_up;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 43;
      ...
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_up));
      return (int) hash;
    }
    public override string ToString() {
      ...
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_up);
      s += ")";
      return s;
    }
  }
  public class Expression_UnboundedIntRange : Expression {
    public readonly DAST._IExpression _i_start;
    public readonly bool _i_up;
    ...
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_UnboundedIntRange(_i_start, _i_up);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_UnboundedIntRange;
      return oth != null && object.Equals(this._i_start, oth._i_start) && this._i_up == oth._i_up;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 44;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_start));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_up));
      return (int) hash;
    }
    public override string ToString() {
      ...
      s += "(";
      s += Dafny.Helpers.ToString(this._i_start);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_up);
      s += ")";
      return s;
  ...
  public class Expression_Quantifier : Expression {
    public readonly DAST._IType _i_elemType;
    public readonly DAST._IExpression _i_collection;
    public readonly bool _i_is__forall;
    public readonly DAST._IExpression _i_lambda;
    public Expression_Quantifier(DAST._IType elemType, DAST._IExpression collection, bool is__forall, DAST._IExpression lambda) : base() {
      this._i_elemType = elemType;
      this._i_collection = collection;
      this._i_is__forall = is__forall;
      this._i_lambda = lambda;
    }
    public override _IExpression DowncastClone() {
      if (this is _IExpression dt) { return dt; }
      return new Expression_Quantifier(_i_elemType, _i_collection, _i_is__forall, _i_lambda);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Expression_Quantifier;
      return oth != null && object.Equals(this._i_elemType, oth._i_elemType) && object.Equals(this._i_collection, oth._i_collection) && this._i_is__forall == oth._i_is__forall && object.Equals(this._i_lambda, oth._i_lambda);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 45;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_elemType));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_collection));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_is__forall));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i_lambda));
      return (int) hash;
    }
    public override string ToString() {
      ...
      s += Dafny.Helpers.ToString(this._i_elemType);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_collection);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_is__forall);
      s += ", ";
      s += Dafny.Helpers.ToString(this._i_lambda);
      s += ")";
      return s;
    }
  }
