...
namespace DafnyCompilerRustUtils {
  ...
  public partial class __default {
    ...
    {
    TAIL_CALL_START: ;
      Dafny.ISequence<Dafny.Rune> _1274_s = (n);
      if ((new BigInteger((_1274_s).Count)).Sign == 0) {
      ...
      } else if (((_1274_s).Select(BigInteger.Zero)) != (new Dafny.Rune('.'))) {
        if ((new BigInteger((acc).Count)).Sign == 0) {
          Dafny.ISequence<Dafny.Rune> _in125 = (_1274_s).Drop(BigInteger.One);
          Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _in126 = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements((_1274_s).Subsequence(BigInteger.Zero, BigInteger.One));
          n = _in125;
          acc = _in126;
          goto TAIL_CALL_START;
        } else {
          Dafny.ISequence<Dafny.Rune> _in127 = (_1274_s).Drop(BigInteger.One);
          Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _in128 = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat((acc).Subsequence(BigInteger.Zero, (new BigInteger((acc).Count)) - (BigInteger.One)), Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.Concat((((acc).Select((new BigInteger((acc).Count)) - (BigInteger.One)))), Dafny.Sequence<Dafny.Rune>.FromElements((_1274_s).Select(BigInteger.Zero)))));
          n = _in127;
          acc = _in128;
          goto TAIL_CALL_START;
        }
      } else if ((new BigInteger((acc).Count)).Sign == 0) {
        Dafny.ISequence<Dafny.Rune> _in129 = (_1274_s).Drop(BigInteger.One);
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _in130 = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements();
        n = _in129;
        acc = _in130;
        goto TAIL_CALL_START;
      } else {
        Dafny.ISequence<Dafny.Rune> _in131 = (_1274_s).Drop(BigInteger.One);
  ...
  public partial class ExternMod {
    ...
    public static bool _Is(RAST._IMod __source) {
      RAST._IMod _1276_x = __source;
      return (_1276_x).is_ExternMod;
    }
  }
  ...
  foreach (Dafny.ISequence<Dafny.Rune> _compr_8 in (Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(((_1279_m1).dtor_values).Keys, ((_1280_m2).dtor_values).Keys)).Elements) {
    Dafny.ISequence<Dafny.Rune> _1281_k = (Dafny.ISequence<Dafny.Rune>)_compr_8;
    if ((Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(((_1279_m1).dtor_values).Keys, ((_1280_m2).dtor_values).Keys)).Contains(_1281_k)) {
      _coll7.Add(new Dafny.Pair<Dafny.ISequence<Dafny.Rune>,DafnyCompilerRustUtils._IGatheringModule>(_1281_k, ((((_1279_m1).dtor_values).Contains(_1281_k)) ? (((((_1280_m2).dtor_values).Contains(_1281_k)) ? ((Dafny.Map<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Select((_1279_m1).dtor_values,_1281_k)).Merge(Dafny.Map<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Select((_1280_m2).dtor_values,_1281_k))) : (Dafny.Map<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Select((_1279_m1).dtor_values,_1281_k)))) : (Dafny.Map<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Select((_1280_m2).dtor_values,_1281_k)))));
    }
  }
  return Dafny.Map<Dafny.ISequence<Dafny.Rune>,DafnyCompilerRustUtils._IGatheringModule>.FromCollection(_coll7);
    ...
    public DafnyCompilerRustUtils._IGatheringModule Merge(DafnyCompilerRustUtils._IGatheringModule m2) {
      if (!((this).is_GatheringModule)) {
        ...
        return DafnyCompilerRustUtils.GatheringModule.create_GatheringModule(RAST.Mod.create_Mod(((this).dtor_existingMod).dtor_name, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(((this).dtor_existingMod).dtor_attributes, ((m2).dtor_existingMod).dtor_attributes), Dafny.Sequence<RAST._IModDecl>.Concat(((this).dtor_existingMod).dtor_body, ((m2).dtor_existingMod).dtor_body)), DafnyCompilerRustUtils.GatheringModule.MergeSeqMap((this).dtor_submodules, (m2).dtor_submodules));
      }
    }
    public static DafnyCompilerRustUtils._ISeqMap<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule> Wrap(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> containingPath, RAST._IMod rawDecl)
    {
      if ((new BigInteger((containingPath).Count)).Sign == 0) {
        Dafny.ISequence<Dafny.Rune> _1282_name = (rawDecl).dtor_name;
        if ((rawDecl).is_Mod) {
          return DafnyCompilerRustUtils.SeqMap<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Single(_1282_name, DafnyCompilerRustUtils.GatheringModule.create_GatheringModule(rawDecl, DafnyCompilerRustUtils.SeqMap<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Empty()));
        } else {
          return DafnyCompilerRustUtils.SeqMap<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Single(_1282_name, DafnyCompilerRustUtils.GatheringModule.create_ExternMod(rawDecl));
        }
      } else {
        Dafny.ISequence<Dafny.Rune> _1283_enclosingModule = (containingPath).Select(BigInteger.Zero);
        return DafnyCompilerRustUtils.SeqMap<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Single(_1283_enclosingModule, DafnyCompilerRustUtils.GatheringModule.create_GatheringModule(RAST.Mod.create_Mod(_1283_enclosingModule, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(), Dafny.Sequence<RAST._IModDecl>.FromElements()), DafnyCompilerRustUtils.GatheringModule.Wrap((containingPath).Drop(BigInteger.One), rawDecl)));
      }
    }
    public RAST._IMod ToRust() {
      if ((this).is_ExternMod) {
        ...
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _1284_keysWithContent = Std.Collections.Seq.__default.Filter<Dafny.ISequence<Dafny.Rune>>(((System.Func<Dafny.ISequence<Dafny.Rune>, bool>)((_1285_key) => {
          return (((this).dtor_submodules).dtor_values).Contains(_1285_key);
        })), ((this).dtor_submodules).dtor_keys);
        RAST._IMod _1286_dt__update__tmp_h0 = (this).dtor_existingMod;
        Dafny.ISequence<RAST._IModDecl> _1287_dt__update_hbody_h0 = Dafny.Sequence<RAST._IModDecl>.Concat(((this).dtor_existingMod).dtor_body, ((System.Func<Dafny.ISequence<RAST._IModDecl>>) (() => {
          BigInteger dim13 = new BigInteger((_1284_keysWithContent).Count);
          var arr13 = new RAST._IModDecl[Dafny.Helpers.ToIntChecked(dim13, "array size exceeds memory limit")];
          for (int i13 = 0; i13 < dim13; i13++) {
            var _1288_i = (BigInteger) i13;
            arr13[(int)(_1288_i)] = Dafny.Helpers.Let<Dafny.ISequence<Dafny.Rune>, RAST._IModDecl>((_1284_keysWithContent).Select(_1288_i), _pat_let18_0 => Dafny.Helpers.Let<Dafny.ISequence<Dafny.Rune>, RAST._IModDecl>(_pat_let18_0, _1289_moduleName => Dafny.Helpers.Let<RAST._IMod, RAST._IModDecl>((Dafny.Map<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Select(((this).dtor_submodules).dtor_values,_1289_moduleName)).ToRust(), _pat_let19_0 => Dafny.Helpers.Let<RAST._IMod, RAST._IModDecl>(_pat_let19_0, _1290_submodule => RAST.ModDecl.create_ModDecl(_1290_submodule)))));
          }
          return Dafny.Sequence<RAST._IModDecl>.FromArray(arr13);
        }))());
        return RAST.Mod.create_Mod((_1286_dt__update__tmp_h0).dtor_name, (_1286_dt__update__tmp_h0).dtor_attributes, _1287_dt__update_hbody_h0);
      }
    }
  }
