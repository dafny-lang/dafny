      ...
      if ((this).is_ExternMod) {
        ...
        Dafny.ISequence<RAST._IModDecl> _3_dt__update_hbody_h0 = Dafny.Sequence<RAST._IModDecl>.Concat(((this).dtor_existingMod).dtor_body, ((System.Func<Dafny.ISequence<RAST._IModDecl>>) (() => {
          ...
          for (int i14 = 0; i14 < dim14; i14++) {
            ...
            arr14[(int)(_4_i)] = Dafny.Helpers.Let<Dafny.ISequence<Dafny.Rune>, RAST._IModDecl>((_0_keysWithContent).Select(_4_i), _pat_let69_0 => Dafny.Helpers.Let<Dafny.ISequence<Dafny.Rune>, RAST._IModDecl>(_pat_let69_0, _5_moduleName => Dafny.Helpers.Let<RAST._IMod, RAST._IModDecl>((Dafny.Map<Dafny.ISequence<Dafny.Rune>, DafnyCompilerRustUtils._IGatheringModule>.Select(((this).dtor_submodules).dtor_values,_5_moduleName)).ToRust(), _pat_let70_0 => Dafny.Helpers.Let<RAST._IMod, RAST._IModDecl>(_pat_let70_0, _6_submodule => RAST.ModDecl.create_ModDecl(_6_submodule)))));
          }
