            ...
            foreach (var member in c.Members) {
              ...
              if (m != null && Attributes.Contains(m.Attributes, "main")) {
                if (mainMethod == null) {
                  ...
                  ReportError(ErrorId.c_more_than_one_main_method, program.Reporter, m.tok, "More than one method is marked {{:main}}. First declaration appeared at {0}.", null,
            ...
            foreach (var member in c.Members) {
              ...
              if (m != null && m.Name == DefaultNameMain) {
                if (mainMethod == null) {
                  ...
                  // more than one main in the program
                  ReportError(ErrorId.c_more_than_one_Main_method, program.Reporter, m.tok, "More than one method is declared as '{0}'. First declaration appeared at {1}.", null,
