  ...
  public abstract class SinglePassCompiler : Plugins.Compiler {
    ...
    protected internal void TrStmt(Statement stmt, ConcreteSyntaxTree wr, ConcreteSyntaxTree wStmts = null) {
      ...
      if (stmt is PrintStmt) {
            ...
            if (!resolved[i].IsGhost) {
              ...
              if (rhs is HavocRhs) {
                if (DafnyOptions.O.ForbidNondeterminism) {
                  Error(rhs.Tok, "nondeterministic assignment forbidden by enforce-determinism option", wr);
                }
              } else {
                lhss.Add(lhs);
        ...
        var s = (AssignSuchThatStmt)stmt;
        if (DafnyOptions.O.ForbidNondeterminism) {
          Error(s.Tok, "assign-such-that statement forbidden by enforce-determinism option", wr);
        }
        if (s.AssumeToken != null) {
        ...
        if (s.Guard == null) {
          if (DafnyOptions.O.ForbidNondeterminism) {
            Error(s.Tok, "nondeterministic if statement forbidden by enforce-determinism option", wr);
          }
          ...
          if (s.IsBindingGuard && DafnyOptions.O.ForbidNondeterminism) {
            Error(s.Tok, "binding if statement forbidden by enforce-determinism option", wr);
          }
          ConcreteSyntaxTree guardWriter;
        ...
        if (DafnyOptions.O.ForbidNondeterminism && 2 <= s.Alternatives.Count) {
          Error(s.Tok, "case-based if statement forbidden by enforce-determinism option", wr);
        }
        ...
        if (DafnyOptions.O.ForbidNondeterminism) {
          Error(loopStmt.Tok, "case-based loop forbidden by enforce-determinism option", wr);
        }
        ...
        if (s0.Rhs is HavocRhs) {
          if (DafnyOptions.O.ForbidNondeterminism) {
            Error(s0.Rhs.Tok, "nondeterministic assignment forbidden by enforce-determinism option", wr);
          }
        ...
        if (s.Body != null) {
          ...
          Error(s.Tok, "modify statement without a body forbidden by enforce-determinism option", wr);
        }
