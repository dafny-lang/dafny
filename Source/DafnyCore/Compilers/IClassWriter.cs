...
public interface IClassWriter {
  ConcreteSyntaxTree/*?*/ CreateMethod(Method m, List<SinglePassCompiler.TypeArgumentInstantiation> typeArgs, bool createBody, bool forBodyInheritance, bool lookasideBody);
