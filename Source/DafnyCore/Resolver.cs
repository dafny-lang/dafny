...
namespace Microsoft.Dafny {
  public partial class Resolver {
    ...
    private class ClonerKeepLocalVariablesIfTypeNotSet : ClonerKeepParensExpressions {
    ...
    private static RBranchExpr CloneRBranchExpr(RBranchExpr branch) {
      Cloner cloner = new ClonerKeepParensExpressions();
    ...
    private IEnumerable<NestedMatchCaseExpr> FlattenNestedMatchCaseExpr(NestedMatchCaseExpr c) {
      var cloner = new ClonerKeepParensExpressions();
