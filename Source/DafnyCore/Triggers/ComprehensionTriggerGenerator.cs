      ...
      if (partWriters.Count > 1) {
        ...
        foreach (var group in groups) {
          ...
          if (q.Comprehension is ForallExpr forallExpr) {
            IOrigin tok = forallExpr.tok is NestedToken nestedToken ? nestedToken.Outer : forallExpr.tok;
            ...
            IOrigin tok = existsExpr.tok is NestedToken nestedToken ? nestedToken.Outer : existsExpr.tok;
