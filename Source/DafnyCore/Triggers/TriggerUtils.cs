      ...
      do {
        ...
        if (expr is BinaryExpr bin) {
          if (bin.Op == BinaryExpr.Opcode.NotIn) {
            expr = new BinaryExpr(bin.tok, BinaryExpr.Opcode.In, bin.E0, bin.E1, null) {
            ...
            if (newOpcode != bin.ResolvedOp) {
              ...
              // "a <= b && !(a == b)".
              expr = new BinaryExpr(bin.tok, BinaryExpr.ResolvedOp2SyntacticOp(newOpcode), bin.E0, bin.E1, null) {
