          ...
          if (cur is SkeletonStatement) {
            ...
            if (S == null) {
              ...
              if (oldAssume == null) {
                ...
                body.Add(new AssertStmt(new RangeToken(new BoogieGenerator.ForceCheckOrigin(skel.RangeToken.StartToken), skel.RangeToken.EndToken),
            ...
            if (doMerge) {
              ...
              i++; j++;
              if (addedAssert != null) {
                var tok = new BoogieGenerator.ForceCheckOrigin(addedAssert.RangeToken.StartToken);
