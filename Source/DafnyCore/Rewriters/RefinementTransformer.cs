...
namespace Microsoft.Dafny {
  public class RefinementOrigin : OriginWrapper {
    ...
    public static bool IsInherited(IOrigin tok, ModuleDefinition m) {
      if (tok is AutoGeneratedOrigin agt) {
        tok = agt.WrappedOrigin;
      }
      while (tok is NestedOrigin) {
        var n = (NestedOrigin)tok;
        // check Outer
        var r = n.Outer as RefinementOrigin;
        ...
        tok = n.Inner;
        if (tok is AutoGeneratedOrigin nestedAtg) {
          tok = nestedAtg.WrappedOrigin;
        }
      }

      var rtok = tok as RefinementOrigin;
