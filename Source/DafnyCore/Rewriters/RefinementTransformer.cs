...
namespace Microsoft.Dafny {
  public class RefinementToken : TokenWrapper {
    ...
    public RefinementToken(IOrigin tok, ModuleDefinition m)
      : base(tok) {
    ...
    public override IOrigin WithVal(string newVal) {
      return new RefinementToken(WrappedOrigin.WithVal(newVal), InheritingModule);
    }
          ...
          if (cur is SkeletonStatement) {
            ...
            if (S == null) {
              ...
              if (oldAssume == null) {
                ...
                body.Add(new AssertStmt(new BoogieGenerator.ForceCheckToken(skel.Origin),
            ...
            if (doMerge) {
              ...
              i++; j++;
              if (addedAssert != null) {
                body.Add(new AssertStmt(new BoogieGenerator.ForceCheckToken(addedAssert.Origin), addedAssert, null, null));
              }
            } else {
              MergeAddStatement(cur, body);
              i++;
