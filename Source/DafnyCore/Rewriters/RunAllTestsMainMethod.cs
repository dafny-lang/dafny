...
public class RunAllTestsMainMethod : IRewriter {
  ...
  internal override void PreResolve(Program program) {
    ...
    var mainMethod = new Method(SourceOrigin.NoToken.MakeAutoGenerated(), new Name(SyntheticTestMainName), noVerifyAttribute, false, false, new List<TypeParameter>(), new List<Formal>(), new List<AttributedExpression>(), new List<AttributedExpression>(), new Specification<FrameExpression>(), new Specification<Expression>(new List<Expression>(), null), new List<Formal>(), new Specification<FrameExpression>(new List<FrameExpression>(), null), null, null);
