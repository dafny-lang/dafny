...
namespace Microsoft.Dafny {
  ...
  public partial class Resolver {
    ...
    public void ResolveProgram(Program prog) {
      ...
      prog.ModuleSigs = sortedDecls.OfType<LiteralModuleDecl>().ToDictionary(l => l.ModuleDef, l => (ModuleSignature)null);
      ...
      systemNameInfo = prog.BuiltIns.SystemModule.RegisterTopLevelDecls(this, false);
    ...
    {
      foreach (var withIndex in Enumerable.Zip(sortedDecls, Enumerable.Range(0, int.MaxValue)))
      {
        var moduleDecl = withIndex.Item1;
        moduleDecl.Height = withIndex.Item2;
        if (moduleDecl is LiteralModuleDecl literalModuleDecl)
        {
          literalModuleDecl.ModuleDef.Height = moduleDecl.Height;
        }
      }
    }
