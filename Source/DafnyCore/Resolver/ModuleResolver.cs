...
namespace Microsoft.Dafny {
  ...
  public partial class ModuleResolver : INewOrOldResolver {
    ...
    public void RegisterByMethod(Function f, TopLevelDeclWithMembers cl) {
      ...
      var method = new Method(f.RangeToken.MakeAutoGenerated(),
        new Name(f.Name), //new Name(new AutoGeneratedToken(f.NameNode.Tok)), TODO scary to change this 
        f.HasStaticKeyword, false, f.TypeArgs,
