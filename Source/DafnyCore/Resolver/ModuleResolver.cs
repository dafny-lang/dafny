...
namespace Microsoft.Dafny {
  ...
  public partial class ModuleResolver : INewOrOldResolver {
    ...
    public void RegisterByMethod(Function f, TopLevelDeclWithMembers cl) {
      ...
      var method = new Method(f.Origin.MakeAutoGenerated(), new Name(new AutoGeneratedOrigin(f.NameNode.Origin)), f.Attributes, f.HasStaticKeyword, false, f.TypeArgs, f.Ins, f.Req, new List<AttributedExpression>() { post }, reads, f.Decreases, new List<Formal>() { resultVar }, new Specification<FrameExpression>(new List<FrameExpression>(), null), f.ByMethodBody, null, true);
