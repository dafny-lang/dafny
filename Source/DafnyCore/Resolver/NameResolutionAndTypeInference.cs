  ...
  public partial class Resolver {
      ...
      if (expr is ParensExpression) {
        ...
        if (currentClass is ClassDecl cd && cd.IsDefaultClass) {
          ...
          if (currentClass == null) {
            ...
            expr.Type = GetThisType(expr.RangeToken, currentClass);  // do this regardless of scope.AllowInstance, for better error reporting
          }
        }
        ...
        if (member == null) {
          ...
          e.Type = SelectAppropriateArrowType(fn.RangeToken,
        ...
        ConstrainSubtypeRelation(ResolvedArrayType(e.Array.RangeToken, e.Indices.Count, elementType, resolutionContext, true), e.Array.Type, e.Array,
        ...
        var ty = PartiallyResolveTypeForMemberSelection(expr.RangeToken, e.Root.Type);
        if (!ty.IsDatatype) {
          reporter.Error(MessageSource.Resolver, expr, "datatype update expression requires a root expression of a datatype (got {0})", ty);
        } else {
          var (ghostLet, compiledLet) = ResolveDatatypeUpdate(expr.RangeToken, e.Root, ty.AsDatatype, e.Updates, resolutionContext,
        ...
        var arrowType = new ArrowType(e.RangeToken, builtIns.ArrowTypeDecls[1], new List<Type>() { builtIns.Nat() }, elementType);
        ...
        switch (e.Op) {
          ...
          case BinaryExpr.Opcode.Le: {
              if (e.Op == BinaryExpr.Opcode.Lt && (PartiallyResolveTypeForMemberSelection(e.E0.RangeToken, e.E0.Type).IsIndDatatype || e.E0.Type.IsTypeParameter || PartiallyResolveTypeForMemberSelection(e.E1.RangeToken, e.E1.Type).IsIndDatatype)) {
          ...
          case BinaryExpr.Opcode.Ge: {
              if (e.Op == BinaryExpr.Opcode.Gt && (PartiallyResolveTypeForMemberSelection(e.E0.RangeToken, e.E0.Type).IsIndDatatype || PartiallyResolveTypeForMemberSelection(e.E1.RangeToken, e.E1.Type).IsIndDatatype || e.E1.Type.IsTypeParameter)) {
          ...
          case BinaryExpr.Opcode.Sub: {
              ...
              // operand to be a set.
              var eType = PartiallyResolveTypeForMemberSelection(expr.RangeToken, expr.Type).AsMapType;
              if (eType != null) {
                // allow "map - set == map"
        ...
        scope.PopMarker();
        expr.Type = SelectAppropriateArrowType(e.RangeToken, e.BoundVars.ConvertAll(v => v.Type), e.Body.Type, e.Reads.Count != 0, e.Range != null);
    ...
    void CheckIsLvalue(Expression lhs, ResolutionContext resolutionContext) {
      ...
      if (lhs is IdentifierExpr) {
        ...
        ConstrainSubtypeRelation(ResolvedArrayType(ll.Seq.RangeToken, 1, new InferredTypeProxy(), resolutionContext, true), ll.Seq.Type, ll.Seq,
    ...
    void ResolveCallStmt(CallStmt s, ResolutionContext resolutionContext, Type receiverType) {
      ...
      if (tryToResolve) {
        ...
        // resolve arguments
        ResolveActualParameters(s.Bindings, callee.Ins, s.RangeToken, callee, resolutionContext, typeMap,
    ...
    /// </summary>
    void ResolveActualParameters(ActualBindings bindings, List<Formal> formals, RangeToken callTok, object context, ResolutionContext resolutionContext,
      ...
      foreach (var formal in formals) {
        ...
        if (b != null) {
          ...
          AddAssignableConstraint(
            callTok.StartToken, formal.Type.Subst(typeMap), b.Actual.Type,
      ...
      if (lhs != null && lhs.Type is Resolver_IdentifierExpr.ResolverType_Module) {
        ...
        if (sig.TopLevels.TryGetValue(expr.SuffixName, out decl)) {
          ...
          if (decl is AmbiguousTopLevelDecl) {
            ...
            r = CreateResolver_IdentifierExpr(expr.RangeToken, expr.SuffixName, expr.OptTypeArguments, decl);
          }
#if ASYNC_TASK_TYPES
        ...
        var ty = new UserDefinedType(ri.RangeToken, ri.Decl.Name, ri.Decl, ri.TypeArgs);
    ...
    Resolver_IdentifierExpr CreateResolver_IdentifierExpr(RangeToken tok, string name, List<Type> optTypeArguments, TopLevelDecl decl) {
      Contract.Requires(tok != null);
      ...
      if (!moduleInfo.IsAbstract) {
        if (decl is ModuleDecl md && md.Signature.IsAbstract) {
          reporter.Error(MessageSource.Resolver, tok.StartToken, "a compiled module is not allowed to use an abstract module ({0})", decl.Name);
        }
      }
    ...
    private void ResolveUpdateStmt(UpdateStmt update, ResolutionContext resolutionContext, int errorCountBeforeCheckingLhs) {
      ...
      if (firstEffectfulRhs == null) {
        ...
        if (update.Rhss.Count != 1) {
          ...
          CallStmt a = new CallStmt(update.RangeToken, resolvedLhss, methodCallInfo.Callee, methodCallInfo.ActualParameters, methodCallInfo.Tok);
      ...
      if (stmt is PredicateStmt) {
        ...
        if (expectStmt != null) {
          if (expectStmt.Message == null) {
            expectStmt.Message = new StringLiteralExpr(s.RangeToken, "expectation violation", false);
          }
          ...
          if (cmc == null) {
            ...
            foreach (Formal f in cmc.Outs) {
              ...
              if (stmt is ReturnStmt) {
                var ident = new ImplicitIdentifierExpr(f.RangeToken, f.Name);
                ...
                var yieldIdent = new MemberSelectExpr(f.RangeToken, new ImplicitThisExpr(f.RangeToken), f.Name);
        ...
        if (prevErrorCount == reporter.Count(ErrorLevel.Error) && s.Lines.Count > 0) {
          ...
          s.Result = CalcStmt.DefaultOp.StepExpr(Expression.CreateIntLiteral(s.RangeToken, 0), Expression.CreateIntLiteral(s.RangeToken, 0));
        }
    ...
    Type ResolveTypeRhs(TypeRhs rr, Statement stmt, ResolutionContext resolutionContext) {
      ...
      if (rr.Type == null) {
        if (rr.ArrayDimensions != null) {
          ...
          rr.Type = ResolvedArrayType(stmt.RangeToken, rr.ArrayDimensions.Count, rr.EType, resolutionContext, false);
          if (rr.ElementInit != null) {
            ...
            var arrowType = new ArrowType(rr.ElementInit.RangeToken, builtIns.ArrowTypeDecls[rr.ArrayDimensions.Count], args, rr.EType);
    ...
    MemberDecl ResolveMember(IToken tok, Type receiverType, string memberName, out NonProxyType tentativeReceiverType) {
      ...
      receiverType = PartiallyResolveTypeForMemberSelection(tok.ToRange(), receiverType, memberName);
    ...
    /// </summary>
    public Type PartiallyResolveTypeForMemberSelection(RangeToken tok, Type t, string memberName = null, int strength = 0) {
      Contract.Requires(tok != null);
      Contract.Requires(t != null);
      Contract.Ensures(Contract.Result<Type>() != null);
      ...
      if (JoinOfAllSubtypes(proxy, ref joinType, new HashSet<TypeProxy>()) && joinType != null) {
        ...
        if (joinType.IsDatatype) {
          ...
          ConstrainSubtypeRelation(t, joinType, tok.StartToken, "Member selection requires a supertype of {0} (got something more like {1})", t, joinType);
          return joinType;
        } else if (headIsRoot) {
          ...
          if (generalArrowType != null) {
            ...
            ConstrainSubtypeRelation(generalArrowType, t, tok.StartToken, "Function application requires a subtype of {0} (got something more like {1})", generalArrowType, t);
              ...
              if (cl != null) {
                ...
                if (plausibleMembers.Count == 1) {
                  ...
                  if (mbr.EnclosingClass == cl) {
                    ...
                    ConstrainSubtypeRelation(joinRoot, t, tok.StartToken, "Member selection requires a subtype of {0} (got something more like {1})", joinRoot, t);
                    return joinType;
                  } else {
                    ...
                    ConstrainSubtypeRelation(pickItFromHere, t, tok.StartToken, "Member selection requires a subtype of {0} (got something more like {1})", pickItFromHere, t);
    ...
    /// </summary>
    (Expression, Expression) ResolveDatatypeUpdate(RangeToken tok, Expression root, DatatypeDecl dt, List<Tuple<IToken, string, Expression>> memberUpdates,
          ...
          if (!classMembers[dt].TryGetValue(destructor_str, out member)) {
            ...
            if (intersection.Count == 0) {
              ...
              if (destructor.IsGhost) {
                ...
                var xVar = new BoundVar(tok.MakeAutoGenerated(), xName, destructor.Type.Subst(subst));
                var x = new IdentifierExpr(tok.MakeAutoGenerated(), xVar);
    ...
    /// </summary>
    private Expression DesugarDatatypeUpdate(RangeToken tok, Expression root, DatatypeDecl dt, List<DatatypeCtor> candidateResultCtors,
      ...
      var dVar = new BoundVar(tok.MakeAutoGenerated(), dName, root.Type);
      var d = new IdentifierExpr(tok.MakeAutoGenerated(), dVar);
    ...
    Expression ResolveNameSegment(NameSegment expr, bool isLastNameSegment, List<ActualBinding> args, ResolutionContext resolutionContext, bool allowMethodCall, bool complain, out ModuleDecl shadowedModule) {
      ...
      if (v != null) {
        ...
        r = new IdentifierExpr(expr.RangeToken, v);
        ...
        Expression receiver;
        if (member.IsStatic) {
          receiver = new StaticReceiverExpr(expr.RangeToken, UserDefinedType.FromTopLevelDecl(expr.RangeToken, currentClass, currentClass.TypeArgs), (TopLevelDeclWithMembers)member.EnclosingClass, true);
        } else {
          if (!scope.AllowInstance) {
            if (complain) {
        ...
        if (decl is AmbiguousTopLevelDecl) {
          ...
          r = CreateResolver_IdentifierExpr(expr.RangeToken, name, expr.OptTypeArguments, decl);
        }
    ...
    void ResolveNameSegment_Type(NameSegment expr, ResolutionContext resolutionContext, ResolveTypeOption option, List<TypeParameter> defaultTypeArguments) {
      ...
      if (tp != null) {
        // ----- 0. type parameter
        if (expr.OptTypeArguments == null) {
          r = new Resolver_IdentifierExpr(expr.RangeToken, tp);
        } else {
        ...
        if (decl is AmbiguousTopLevelDecl) {
          ...
          // resolution to any such suffix. For now, we create a temporary expression that will never be seen by the compiler
          // or verifier, just to have a placeholder where we can recorded what we have found.
          r = CreateResolver_IdentifierExpr(expr.RangeToken, expr.Name, expr.OptTypeArguments, decl);
        }
    ...
    Expression ResolveDotSuffix(ExprDotName expr, bool isLastNameSegment, List<ActualBinding> args, ResolutionContext resolutionContext, bool allowMethodCall) {
      ...
      if (lhs != null && lhs.Type is Resolver_IdentifierExpr.ResolverType_Module) {
        ...
        // expand any synonyms
        var ty = new UserDefinedType(expr.RangeToken, ri.Decl.Name, ri.Decl, ri.TypeArgs).NormalizeExpand();
        if (ty.IsDatatype) {
          // ----- LHS is a datatype
    ...
    Expression ResolveExprDotCall(RangeToken tok, Name name, Expression receiver, Type receiverTypeBound/*?*/,
      ...
      if (member is Field) {
        ...
        subst = BuildTypeArgumentSubstitute(subst, receiverTypeBound ?? receiver.Type);
        rr.Type = SelectAppropriateArrowType(fn.RangeToken,
          fn.Formals.ConvertAll(f => f.Type.Subst(subst)),
          fn.ResultType.Subst(subst),
          fn.Reads.Count != 0, fn.Req.Count != 0);
      } else {
    ...
    MethodCallInformation ResolveApplySuffix(ApplySuffix e, ResolutionContext resolutionContext, bool allowMethodCall) {
      ...
      if (r == null) {
        var improvedType = PartiallyResolveTypeForMemberSelection(e.Lhs.RangeToken, e.Lhs.Type, "_#apply");
        ...
        if (fnType == null) {
          ...
          if (callee != null) {
            ...
            ResolveActualParameters(rr.Bindings, callee.Formals, e.RangeToken, callee, resolutionContext, typeMap, callee.IsStatic ? null : mse.Obj);
            ...
            if (callee != null) {
              ...
              for (var i = 0; i < fnType.Args.Count; i++) {
                ...
                var formal = new ImplicitFormal(e.RangeToken, "_#p" + i, argType, true, false);
                formals.Add(formal);
              }
            }
            ResolveActualParameters(e.Bindings, formals, e.RangeToken, fnType, resolutionContext, new Dictionary<TypeParameter, Type>(), null);
            r = new ApplyExpr(e.Lhs.RangeToken, e.Lhs, e.Args, e.CloseParen);
    ...
    private bool ResolveDatatypeValue(ResolutionContext resolutionContext, DatatypeValue dtv, DatatypeDecl dt, Type ty, bool complain = true) {
      ...
      dtv.Type = new UserDefinedType(dtv.RangeToken, dt.Name, dt, gt);
      ...
      if (complain && ctor != null) {
        ResolveActualParameters(dtv.Bindings, ctor.Formals, dtv.RangeToken, ctor, resolutionContext, subst, null);
      } else {
    ...
    public void ResolveFunctionCallExpr(FunctionCallExpr e, ResolutionContext resolutionContext) {
      ...
      if (member == null) {
        ...
        ResolveActualParameters(e.Bindings, function.Formals, e.RangeToken, function, resolutionContext, subst, function.IsStatic ? null : e.Receiver);
    ...
    void ResolveReceiver(Expression expr, ResolutionContext resolutionContext) {
      ...
      if (expr is ThisExpr && !expr.WasResolved()) {
        ...
        expr.Type = GetThisType(expr.RangeToken, currentClass);
      } else {
        ResolveExpression(expr, resolutionContext);
      }
    }
