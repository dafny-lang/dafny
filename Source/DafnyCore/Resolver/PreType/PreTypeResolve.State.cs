...
namespace Microsoft.Dafny {
  public partial class PreTypeResolver {
    ...
    class SubtypeConstraint : PreTypeStateWithErrorMessage {
      ...
      /// </summary>
      void ConstrainTypeArguments(List<TypeParameter> parameters, List<PreType> superArguments, List<PreType> subArguments, IToken tok, PreTypeResolver preTypeResolver) {
      ...
      /// </summary>
      List<PreType> CreateProxiesForTypesAccordingToVariance(IToken tok, List<TypeParameter> parameters, List<PreType> arguments, bool proxiesAreSupertypes, PreTypeResolver preTypeResolver) {
      ...
      /// </summary>
      public static List<PreType> /*?*/ AdaptTypeArgumentsForParent(TopLevelDecl super, TopLevelDecl sub, List<PreType> subArguments, PreTypeResolver preTypeResolver) {
