...
public class Attributes : NodeWithOrigin, ICanFormat {
  ...
  /// <summary>
  /// Marks attributes generated by the resolver or a rewriter (e.g. auto-generated
  /// <c>{:trigger}</c> attributes). The refinement cloner uses this to drop such
  /// attributes when <c>!CloneResolvedFields</c>, since their args may contain
  /// post-resolution expression shapes that the refined module's re-resolution
  /// cannot handle. User-written attributes always leave this <c>false</c>.
  /// </summary>
  public bool IsResolverGenerated { get; set; }
