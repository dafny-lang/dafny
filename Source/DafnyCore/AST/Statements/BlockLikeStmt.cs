...
/// </summary>
public abstract class BlockLikeStmt : LabelledStatement, ICanFormat {
  ...
  [SyntaxConstructor]
  protected BlockLikeStmt(IOrigin origin, List<Name> labels, Attributes? attributes) : base(origin, labels, attributes) {
  }
