...
public class ParseErrors {
  ...
  public enum ErrorId {
    ...
    none,
    p_at_attributes_before_keywords,
  ...
  static ParseErrors() {
    Add(ErrorId.p_at_attributes_before_keywords,
      @"
@-Attributes, or at-attributes, must be placed before any keyword like static, const or method.
".TrimStart(), Remove(true, "Remove this at-attribute"));
