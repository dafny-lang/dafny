...
public class IteratorDecl : ClassDecl, IMethodCodeContext, ICanVerify {
  ...
  public void CreateIteratorMethodSpecs(ModuleResolver resolver) {
    ...
    // requires !_begun ==> Requires
    foreach (var r in Requires) {
      req.Add(new AttributedExpression(new BinaryExpr(tok, BinaryExpr.Opcode.Imp,
        new UnaryOpExpr(tok, UnaryOpExpr.Opcode.Not, new ExprDotName(tok, new ThisExpr(tok), "_begun", null))
      , r.E)));
    }
