...
public class Token : IOrigin {
  ...
  public IOrigin StartToken => this;
  public IOrigin EndToken => this;
...
public static class TokenExtensions {
  ...
  public static RangeToken MakeAutoGenerated(this IOrigin origin) {
    return new RangeToken(new AutoGeneratedOrigin(origin.StartToken), origin.EndToken);
  }

  public static RangeToken MakeRefined(this IOrigin origin, ModuleDefinition module) {
    return new RangeToken(new RefinementOrigin(origin.StartToken, module), origin.EndToken);
  }

  public static bool Contains(IOrigin container, IOrigin otherToken) {
