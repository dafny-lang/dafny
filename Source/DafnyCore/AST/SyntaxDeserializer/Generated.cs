...
namespace Microsoft.Dafny
{
    partial class SyntaxDeserializer
    {
        ...
        public HideRevealStmt ReadHideRevealStmt()
        {
            var parameter0 = ReadAbstract<IOrigin>();
            var parameter3 = ReadAttributesOption();
            var parameter1 = ReadListOption<Expression>(() => ReadAbstract<Expression>());
            var parameter2 = ReadHideRevealCmdModes();
            return new HideRevealStmt(parameter0, parameter1, parameter2, parameter3);
        }

        public HideRevealStmt ReadHideRevealStmtOption()
        {
            if (ReadIsNull())
            {
                return default;
            ...
            return ReadHideRevealStmt();
        }

        private HideRevealCmd.Modes ReadHideRevealCmdModes()
        {
            int ordinal = ReadInt32();
            return (HideRevealCmd.Modes)ordinal;
        }
        ...
        private object ReadObject(System.Type actualType)
        {
            ...
            if (actualType == typeof(HideRevealStmt))
            {
                return ReadHideRevealStmt();
            }
