...
public class ChainingExpression : ConcreteSyntaxExpression, ICloneable<ChainingExpression>, ICanFormat {
  ...
  public readonly List<Token> OperatorLocs;
  ...
  public ChainingExpression(Cloner cloner, ChainingExpression original) : base(cloner, original) {
    ...
    OperatorLocs = original.OperatorLocs.ToList();
  ...
  public ChainingExpression(IOrigin tok, List<Expression> operands, List<BinaryExpr.Opcode> operators, List<Token> operatorLocs, List<Expression/*?*/> prefixLimits)
    : base(tok) {
  ...
  private static Expression ComputeDesugaring(List<Expression> operands, List<BinaryExpr.Opcode> operators, List<Token> operatorLocs, List<Expression> prefixLimits) {
