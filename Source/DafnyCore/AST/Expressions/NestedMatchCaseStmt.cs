...
public class NestedMatchCaseStmt : NestedMatchCase, IAttributeBearingDeclaration {
  ...
  public NestedMatchCaseStmt(RangeToken rangeToken, ExtendedPattern pat, List<Statement> body) : base(rangeToken, pat) {
    RangeToken = rangeToken;
    Contract.Requires(body != null);
    this.Body = body;
    this.Attributes = null;
  }
  public NestedMatchCaseStmt(RangeToken tok, ExtendedPattern pat, List<Statement> body, Attributes attrs) : base(tok, pat) {
    Contract.Requires(body != null);
    this.Body = body;
  ...
  public void Resolve(
    ...
    foreach (var boundVar in boundVars) {
      ...
      var casePattern = new CasePattern<LocalVariable>(localVariable.RangeToken, localVariable);
