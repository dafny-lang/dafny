...
public class PrefixLemma : Method {
  ...
  public PrefixLemma(IOrigin origin, Name name, bool hasStaticKeyword,
    ...
    : base(origin, name, attributes, hasStaticKeyword, true, typeArgs, ins, req, ens, reads, decreases, outs, mod, body, null) {
