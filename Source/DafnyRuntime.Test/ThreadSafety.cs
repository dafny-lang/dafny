 ...
 namespace DafnyRuntime.Test {
   ...
   public class ThreadSafety {
     ...
     public void RunCoyoteTest() {
       ...
       List<string> filenames = new List<string>(engine.TryEmitReports(Directory.GetCurrentDirectory(), "ConcatSequence"));
     ...
     public void ReplayCoyoteTest() {
       var tracePath = "/Users/fmadge/Documents/dafny/Source/DafnyRuntime.Test/bin/Debug/net6.0/ConcatSequence_0.schedule";
